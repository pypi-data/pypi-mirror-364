...
def start_server(server_name: str, client: str):
...
Examples:
  ...
  uvx your-mcp-server-package start --server-name "My Server" --client "claude-desktop"

  # Direct python execution
  python proxy_server.py start --server-name "My Server" --client "claude-desktop"
  python proxy_server.py start -s "Custom Server" -c "genstudio"
        """
    )
    ...
    if args.command == 'start':
        start_server(args.server_name, args.client)
    else:
        parser.print_help()
