...
Resources:
  MetSigPyTorchAutoEncoder:
    ...
    Properties:
      ...
      Name: jetmet-metsig-torchscript-autoencoder
      MetricKey: output_1
  ...
  MetSigTensorflowAutoEncoder:
    ...
    Properties:
      Description: Spot anomalies in the MetSig distribution
      Name: jetmet-metsig-tensorflow-autoencoder
      MetricKey: output_1
      BuiltinThreshold: false
      AnomalyThreshold: 0.1
      InputSignature:
  ...
  MetSigOnnxAutoEncoder:
    ...
    Properties:
      Description: Spot anomalies in the MetSig distribution
      Name: jetmet-metsig-onnx-autoencoder
      MetricKey: output_1
      BuiltinThreshold: false
      AnomalyThreshold: 0.1
      InputSignature:
  ...
  MetSigXGBoostRegressor:
    ...
    Properties:
      Description: Spot anomalies in the MetSig distribution
      Name: jetmet-metsig-xgboost-autoencoder
      MetricKey: avg_mse
      BuiltinThreshold: false
      AnomalyThreshold: 0.1
      InputSignature:
  ...
  MetSigLightGBMRegressor:
    ...
    Properties:
      Description: Spot anomalies in the MetSig distribution
      Name: jetmet-metsig-lightgbm-autoencoder
      MetricKey: avg_mse
      BuiltinThreshold: false
      AnomalyThreshold: 0.1
      InputSignature:
  ...
  MetSigNMFRegressor:
    ...
    Properties:
      Description: Spot anomalies in the MetSig distribution
      Name: jetmet-metsig-nmf-autoencoder
      MetricKey: avg_mse
      BuiltinThreshold: false
      AnomalyThreshold: 0.1
      InputSignature:
