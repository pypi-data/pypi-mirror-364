...
class BaseProperties(BaseModel):
    Description: str
    Name: Annotated[
        str, StringConstraints(max_length=41)
    ]  # The final service name has to be limited to 63 characters, it will be a composed string: {workspace:18}-{Name:41}-{version:4}
