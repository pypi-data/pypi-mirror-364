...
class MakefileChunker(BaseChunker):
    ...
    def _get_tree_sitter_language(self) -> Any:
        ...
        # tree-sitter-makefile package not available on PyPI
        # Migrated from tree-sitter-languages but no individual package exists
        raise ImportError(
            "tree-sitter-makefile package is not available on PyPI. "
            "Makefile chunking is currently disabled after tree-sitter-languages migration."
        )
