...
class ConversationService:
    ...
    def __init__(self) -> None:
        ...
        self.config = get_settings()  # Para límites configurables
    ...
    async def create_session(self, initial_message: str) -> str:
        ...
        try:
            ...
            if last_session:
                ...
                related_sessions = [last_session["session_id"]]
            ...
            if initial_message:
                try:
                    ...
                    for session in keyword_related:
                        if session["session_id"] not in related_sessions:
                            related_sessions.append(session["session_id"])
                except DatabaseError as e:
    ...
    async def _search_by_keywords(
        ...
        try:
            ...
            for row in result.data:
                ...
                results.append(
                    {
                        "session_id": row["id"],  # La query SQL alias session_id as id
        ...
        try:
            ...
            for raw_result in raw_results:
                ...
                typed_result = ConversationSearchResult(
                    conversation_id=raw_result["session_id"],
                    session_id=raw_result["session_id"],  # Mismo ID por compatibilidad
