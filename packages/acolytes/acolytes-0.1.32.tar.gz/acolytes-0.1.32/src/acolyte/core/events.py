...
class ProgressEvent(Event):
    ...
    def __init__(
        ...
        # Metadata for additional context (batch info, etc.)
...
class WebSocketManager:
    ...
    async def send_event(self, event: Event):
        ...
        try:
            websocket = self._websocket  # Capture for type safety in lambda
            await retry_async(
                lambda: websocket.send_json(json.loads(payload)),
