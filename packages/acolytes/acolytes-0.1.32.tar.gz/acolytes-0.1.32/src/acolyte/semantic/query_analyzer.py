...
class QueryAnalyzer:
    ...
    def _is_simple_question(self, query: str, lang: str) -> bool:
        ...
        # NEW: Check for code-related questions first
        # If it's about code, it's NOT simple (should use RAG)
        code_keywords = [
            "archivo",
            "file",
            "código",
        ...
        # If query contains code-related keywords, it's NOT simple
        for keyword in code_keywords:
            if keyword in query_lower:
                logger.info("Detected code-related question, not simple", keyword=keyword)
                return False
