...
class SwiftChunker(
    ...
    def _get_tree_sitter_language(self) -> Any:
        ...
        logger.info("[TRACE] swift._get_tree_sitter_language called")
        return None

    def _get_import_node_types(self) -> List[str]:
        """Not used for pattern-based chunking."""
        logger.info("[TRACE] swift._get_import_node_types called")
        return []

    def _is_comment_node(self, node) -> bool:
        """Not used for pattern-based chunking."""
        logger.info("[TRACE] swift._is_comment_node called")
        return False
