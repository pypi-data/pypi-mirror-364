...
class PerlChunker(BaseChunker):
    ...
    def _get_tree_sitter_language(self) -> Any:
        ...
        # tree-sitter-perl package not available on PyPI
        # Migrated from tree-sitter-languages but no individual package exists
        raise ImportError(
            "tree-sitter-perl package is not available on PyPI. "
            "Perl chunking is currently disabled after tree-sitter-languages migration."
        )
