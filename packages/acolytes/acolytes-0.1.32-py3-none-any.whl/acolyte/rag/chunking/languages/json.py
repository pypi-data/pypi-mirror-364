...
class JSONChunker(ConfigChunkerBase):
    ...
    def _create_main_config_chunk(
        ...
        try:
            ...
            logger.info("[TRACE] json parse error in main config chunk")
            return None
    ...
    def _get_pair_key(self, pair_node):
        ...
        for child in pair_node.children:
            if child.type == 'string':
                return child
        logger.info("[TRACE] json no string key found in pair")
        return None
    ...
    def _extract_json_metadata(self, content: str, config_type: Optional[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info("[TRACE] json decode error in metadata extraction")
    ...
    def _count_arrays(self, data: Any) -> int:
        ...
        if isinstance(data, dict):
            ...
            logger.info("[TRACE] json counting nested arrays")
