...
class CssChunker(BaseChunker):
    ...
    def _get_tree_sitter_language(self) -> Any:
        ...
        logger.info("[TRACE] css._get_tree_sitter_language called")
    ...
    def _create_chunk_from_node(
        ...
        if node.type == 'rule_set':
            ...
            if chunk_type == ChunkType.UNKNOWN:
                logger.info("[TRACE] css unknown at_rule type")
    ...
    def _extract_css_metadata(self, node: Any, lines: List[str]) -> Dict[str, Any]:
        ...
        if node.type == 'rule_set':
            ...
            if properties:
                ...
                logger.info("[TRACE] css no patterns detected")
        ...
        for node in import_nodes:
            ...
            if '@import' in text:
                ...
                if import_match:
                    ...
                    logger.info("[TRACE] css @import pattern not matched")
