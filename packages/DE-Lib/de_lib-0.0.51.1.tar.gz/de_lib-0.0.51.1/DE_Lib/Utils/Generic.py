...
class GENERIC:
    ...
    @staticmethod
    def gerar_setter(attr):
        msg, result = None, None
        try:
            result = lambda self, value: setattr(self, f"_{attr}", value)
        except Exception as error:
            msg = error
            result = msg
        finally:
    ...
    @staticmethod
    def gerar_getter(attr):
        msg, result = None, None
        try:
            result = lambda self: getattr(self, f"_{attr}")
        except Exception as error:
            msg = error
            result = msg
        finally:
