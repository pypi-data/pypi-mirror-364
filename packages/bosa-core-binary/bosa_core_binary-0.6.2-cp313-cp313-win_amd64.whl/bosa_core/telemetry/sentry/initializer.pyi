...
class SentryConfig:
    ...
    def __init__(self, dsn: str | None = None, environment: str | None = None, release: str | None = None, profiles_sample_rate: float | None = None, send_default_pii: bool | None = None, traces_sampler: Incomplete | None = None, open_telemetry_config: OpenTelemetryConfig | None = None, **kwargs: Any) -> None:
