...
class SpringBootAnalyzer(BaseAnalyzer):
    ...
    def _extract_parameters(self, content: str, match: re.Match, endpoint: ApiEndpoint):
        ...
        # Look for @RequestBody with various validation patterns - Enhanced to avoid capturing modifiers
        request_body_patterns = [
            # @RequestBody final Type name - properly capture Type after final
            ...
            # @RequestBody Type name (no validation) - ensure Type starts with capital letter
