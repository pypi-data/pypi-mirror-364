...
@_ods_cext.register_operation(_Dialect)
class CutOp(_ods_ir.OpView):
  OPERATION_NAME = "aig.cut"
...
def cut(results_, inputs, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(CutOp(results_=results_, inputs=inputs, loc=loc, ip=ip))

@_ods_cext.register_operation(_Dialect)
class OutputOp(_ods_ir.OpView):
  OPERATION_NAME = "aig.output"
