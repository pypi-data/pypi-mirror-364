...
Run the server locally with: `kg-mem`
...
Example: ONTOLOGY=github kg-mem
...
Example: ONTOLOGY=/path/to/my_ontology.py kg-mem
...
def main():
  """Entry point for the kg-mem console script."""
  mcp.run()
