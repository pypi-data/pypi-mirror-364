...
if __name__ == "__main__":
    ...
    results_0 = market_earning_0.fit_stream(prophet_arena_challenge.stream_problems(increment=50, order="sequential"))
    results_05 = market_earning_05.fit_stream(prophet_arena_challenge.stream_problems(increment=50, order="sequential"))
    results_1 = market_earning_1.fit_stream(prophet_arena_challenge.stream_problems(increment=50, order="sequential"))
