...
from awslabs.kinesis_mcp_server.server import main
...
class TestMain:
    ...
    @patch('awslabs.kinesis_mcp_server.server.mcp.run')
    @patch('sys.argv', ['awslabs.kinesis-mcp-server'])
    ...
    def test_module_execution(self):
        ...
        import inspect
        from awslabs.kinesis_mcp_server import server
