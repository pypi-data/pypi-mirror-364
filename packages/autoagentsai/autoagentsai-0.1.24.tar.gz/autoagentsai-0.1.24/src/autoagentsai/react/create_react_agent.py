...
# 导入ToolManager和相关工具类
from ..tools.ToolManager import ToolManager, ToolWrapper, tool
    ...
    async def invoke(self, prompt: str) -> str:
        ...
        try:
            ...
            if not selected_tools:
                # 没有合适的工具，直接用ChatClient回答
                print("📝 没有需要的工具，直接回答问题")
                try:
                    full_response = await self.chat_client.invoke_async(prompt)
