...
class TabBasedTokenCompletionSession:
    ...
    def __init__(self, get_token_completions, token_boundary_delimiters=frozenset([' ', '\t'])):
        ...
        Args:
            ...
            token_boundary_delimiters: An iterable of single-character delimiters that define token boundaries (default: space and tab). All delimiters must be single ASCII characters.
