...
from .logging_config import LogConfig, LogLevel
...
class Experiment:
    ...
    def log_global_config(self, name: str, value: dict[str, typ.Any]):
        ...
        This is the preferred method for logging configuration objects at the experiment level.
        Use this for experiment-wide settings, metadata, or complex configuration objects.
    ...
    def log_problem(
        ...
        .. deprecated::
            Use log_global_problem() instead for clearer experiment-level data handling.
        ...
        warnings.warn(
            "log_problem() is deprecated. Use log_global_problem() instead for clearer "
            "experiment-level data handling.",
            DeprecationWarning,
            stacklevel=2,
        )
        return self.log_global_problem(problem_name, problem)
    ...
    def log_instance(
        ...
        .. deprecated::
            Use log_global_instance() instead for clearer experiment-level data handling.
        ...
        warnings.warn(
            "log_instance() is deprecated. Use log_global_instance() instead for clearer "
            "experiment-level data handling.",
            DeprecationWarning,
            stacklevel=2,
        )
        return self.log_global_instance(instance_name, instance)
    ...
    def log_parameter(
        ...
        .. deprecated::
            Use log_global_parameter() instead for clearer experiment-level data handling.
            For run-specific parameters, use Run.log_parameter() method.
        ...
        warnings.warn(
            "log_parameter() on Experiment is deprecated. Use log_global_parameter() instead "
            "for experiment-level data, or Run.log_parameter() for run-specific data.",
            DeprecationWarning,
            stacklevel=2,
        )
        return self.log_global_parameter(name, value)
    ...
    def log_object(self, name: str, value: dict[str, typ.Any]):
        ...
        .. deprecated::
            Use log_global_config() instead for clearer experiment-level data handling.
        ...
        warnings.warn(
            "log_object() on Experiment is deprecated. Use log_global_config() instead "
            "for experiment-level data, or Run.log_object() for run-specific data.",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def log_solver(
        ...
        *,
        ...
        logs solver parameters and results. This is maintained for backward compatibility
        ...
        def wrapper(*args, **kwargs):
            ...
            # Note: Solutions and samplesets should be logged at run level,
            # but for backward compatibility, we'll log them at experiment level
            if isinstance(
                ...
                if isinstance(result, (jm.SampleSet, jm.experimental.SampleSet)):
                    result_ommx = convert_sampleset_jijmodeling_to_ommx(result)
                else:
                    result_ommx = result
                self.dataspace.add_exp_data(
                    solver_name + "_result",
