...
def test_sampleset_for_openjij(tmp_path):
    ...
    # Note: samplesets should typically be logged at run level, not experiment level
    # But for backward compatibility testing, we'll test experiment-level logging
    # experiment.log_sampleset("tsp", sampleset)  # Remove this - samplesets should be run-level

    # assert experiment.dataspace.experiment_datastore.samplesets["tsp"] == sampleset  # Remove this
    ...
    # assert loaded_exp.dataspace.experiment_datastore.samplesets["tsp"] == sampleset  # Remove this
