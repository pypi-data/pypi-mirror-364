...
def get_package_versions(
    key_packages: typ.Optional[list[str]] = None,
) -> dict[str, str]:
    """Get versions of key packages used in the experiment.

    Args:
        key_packages: List of package names to check. If None, uses default list.
        ...
        try:
            if package == "minto":
                ...
                try:
                    ...
                    version = getattr(minto, "__version__", "unknown")
                except ImportError:
            ...
            package_versions[package] = "error"
...
def collect_environment_info(
    ...
    if include_packages:
        ...
        package_versions = get_package_versions(default_packages)
