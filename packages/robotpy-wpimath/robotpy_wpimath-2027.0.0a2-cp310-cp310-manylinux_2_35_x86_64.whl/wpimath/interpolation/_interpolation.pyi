...
class TimeInterpolatableFloatBuffer:
    ...
    """
    @typing.overload
    def __init__(self, historySize: wpimath.units.seconds, func: typing.Callable[[typing.SupportsFloat, typing.SupportsFloat, typing.SupportsFloat], float]) -> None:
        """
...
class TimeInterpolatablePose2dBuffer:
    ...
    """
    @typing.overload
    def __init__(self, historySize: wpimath.units.seconds, func: typing.Callable[[wpimath.geometry._geometry.Pose2d, wpimath.geometry._geometry.Pose2d, typing.SupportsFloat], wpimath.geometry._geometry.Pose2d]) -> None:
        """
        Create a new TimeInterpolatableBuffer.
...
class TimeInterpolatablePose3dBuffer:
    ...
    """
    @typing.overload
    def __init__(self, historySize: wpimath.units.seconds, func: typing.Callable[[wpimath.geometry._geometry.Pose3d, wpimath.geometry._geometry.Pose3d, typing.SupportsFloat], wpimath.geometry._geometry.Pose3d]) -> None:
        """
        Create a new TimeInterpolatableBuffer.
...
class TimeInterpolatableRotation2dBuffer:
    ...
    """
    @typing.overload
    def __init__(self, historySize: wpimath.units.seconds, func: typing.Callable[[wpimath.geometry._geometry.Rotation2d, wpimath.geometry._geometry.Rotation2d, typing.SupportsFloat], wpimath.geometry._geometry.Rotation2d]) -> None:
        """
        Create a new TimeInterpolatableBuffer.
...
class TimeInterpolatableRotation3dBuffer:
    ...
    """
    @typing.overload
    def __init__(self, historySize: wpimath.units.seconds, func: typing.Callable[[wpimath.geometry._geometry.Rotation3d, wpimath.geometry._geometry.Rotation3d, typing.SupportsFloat], wpimath.geometry._geometry.Rotation3d]) -> None:
        """
        Create a new TimeInterpolatableBuffer.
...
class TimeInterpolatableTranslation2dBuffer:
    ...
    """
    @typing.overload
    def __init__(self, historySize: wpimath.units.seconds, func: typing.Callable[[wpimath.geometry._geometry.Translation2d, wpimath.geometry._geometry.Translation2d, typing.SupportsFloat], wpimath.geometry._geometry.Translation2d]) -> None:
        """
        Create a new TimeInterpolatableBuffer.
...
class TimeInterpolatableTranslation3dBuffer:
    ...
    """
    @typing.overload
    def __init__(self, historySize: wpimath.units.seconds, func: typing.Callable[[wpimath.geometry._geometry.Translation3d, wpimath.geometry._geometry.Translation3d, typing.SupportsFloat], wpimath.geometry._geometry.Translation3d]) -> None:
        """
        Create a new TimeInterpolatableBuffer.
