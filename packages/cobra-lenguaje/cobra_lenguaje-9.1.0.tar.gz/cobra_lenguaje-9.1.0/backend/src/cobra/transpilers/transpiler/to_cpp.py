...
from backend.src.cobra.transpilers.transpiler.cpp_nodes.asignacion import visit_asignacion as _visit_asignacion
from backend.src.cobra.transpilers.transpiler.cpp_nodes.condicional import visit_condicional as _visit_condicional
from backend.src.cobra.transpilers.transpiler.cpp_nodes.bucle_mientras import visit_bucle_mientras as _visit_bucle_mientras
from backend.src.cobra.transpilers.transpiler.cpp_nodes.funcion import visit_funcion as _visit_funcion
from backend.src.cobra.transpilers.transpiler.cpp_nodes.llamada_funcion import visit_llamada_funcion as _visit_llamada_funcion
from backend.src.cobra.transpilers.transpiler.cpp_nodes.holobit import visit_holobit as _visit_holobit
from backend.src.cobra.transpilers.transpiler.cpp_nodes.clase import visit_clase as _visit_clase
from backend.src.cobra.transpilers.transpiler.cpp_nodes.metodo import visit_metodo as _visit_metodo
from backend.src.cobra.transpilers.transpiler.cpp_nodes.yield_ import visit_yield as _visit_yield
from backend.src.cobra.transpilers.transpiler.cpp_nodes.romper import visit_romper as _visit_romper
from backend.src.cobra.transpilers.transpiler.cpp_nodes.continuar import visit_continuar as _visit_continuar
from backend.src.cobra.transpilers.transpiler.cpp_nodes.pasar import visit_pasar as _visit_pasar
from backend.src.cobra.transpilers.transpiler.cpp_nodes.switch import visit_switch as _visit_switch
