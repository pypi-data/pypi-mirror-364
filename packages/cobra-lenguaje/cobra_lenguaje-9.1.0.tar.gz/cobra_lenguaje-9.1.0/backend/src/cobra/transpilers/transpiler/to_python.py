...
from backend.src.cobra.transpilers.transpiler.python_nodes.asignacion import visit_asignacion as _visit_asignacion
from backend.src.cobra.transpilers.transpiler.python_nodes.condicional import visit_condicional as _visit_condicional
from backend.src.cobra.transpilers.transpiler.python_nodes.bucle_mientras import visit_bucle_mientras as _visit_bucle_mientras
from backend.src.cobra.transpilers.transpiler.python_nodes.for_ import visit_for as _visit_for
from backend.src.cobra.transpilers.transpiler.python_nodes.funcion import visit_funcion as _visit_funcion
from backend.src.cobra.transpilers.transpiler.python_nodes.llamada_funcion import (
    visit_llamada_funcion as _visit_llamada_funcion,
)
from backend.src.cobra.transpilers.transpiler.python_nodes.llamada_metodo import visit_llamada_metodo as _visit_llamada_metodo
from backend.src.cobra.transpilers.transpiler.python_nodes.imprimir import visit_imprimir as _visit_imprimir
from backend.src.cobra.transpilers.transpiler.python_nodes.retorno import visit_retorno as _visit_retorno
from backend.src.cobra.transpilers.transpiler.python_nodes.holobit import visit_holobit as _visit_holobit
from backend.src.cobra.transpilers.transpiler.python_nodes.lista import visit_lista as _visit_lista
from backend.src.cobra.transpilers.transpiler.python_nodes.diccionario import visit_diccionario as _visit_diccionario
from backend.src.cobra.transpilers.transpiler.python_nodes.clase import visit_clase as _visit_clase
from backend.src.cobra.transpilers.transpiler.python_nodes.metodo import visit_metodo as _visit_metodo
from backend.src.cobra.transpilers.transpiler.python_nodes.try_catch import visit_try_catch as _visit_try_catch
from backend.src.cobra.transpilers.transpiler.python_nodes.throw import visit_throw as _visit_throw
from backend.src.cobra.transpilers.transpiler.python_nodes.importar import visit_import as _visit_import
from backend.src.cobra.transpilers.transpiler.python_nodes.usar import visit_usar as _visit_usar
from backend.src.cobra.transpilers.transpiler.python_nodes.hilo import visit_hilo as _visit_hilo
from backend.src.cobra.transpilers.transpiler.python_nodes.instancia import visit_instancia as _visit_instancia
from backend.src.cobra.transpilers.transpiler.python_nodes.atributo import visit_atributo as _visit_atributo
from backend.src.cobra.transpilers.transpiler.python_nodes.operacion_binaria import (
    visit_operacion_binaria as _visit_operacion_binaria,
)
from backend.src.cobra.transpilers.transpiler.python_nodes.operacion_unaria import (
    visit_operacion_unaria as _visit_operacion_unaria,
)
from backend.src.cobra.transpilers.transpiler.python_nodes.valor import visit_valor as _visit_valor
from backend.src.cobra.transpilers.transpiler.python_nodes.identificador import visit_identificador as _visit_identificador
from backend.src.cobra.transpilers.transpiler.python_nodes.para import visit_para as _visit_para
from backend.src.cobra.transpilers.transpiler.python_nodes.decorador import visit_decorador as _visit_decorador
from backend.src.cobra.transpilers.transpiler.python_nodes.yield_ import visit_yield as _visit_yield
from backend.src.cobra.transpilers.transpiler.python_nodes.esperar import visit_esperar as _visit_esperar
from backend.src.cobra.transpilers.transpiler.python_nodes.romper import visit_romper as _visit_romper
from backend.src.cobra.transpilers.transpiler.python_nodes.continuar import visit_continuar as _visit_continuar
from backend.src.cobra.transpilers.transpiler.python_nodes.pasar import visit_pasar as _visit_pasar
from backend.src.cobra.transpilers.transpiler.python_nodes.switch import visit_switch as _visit_switch
