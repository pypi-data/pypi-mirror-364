...
from backend.src.core.optimizations import (
    optimize_constants,
    remove_dead_code,
    inline_functions,
    eliminate_common_subexpressions,
)
from backend.src.core.type_utils import (
    verificar_sumables,
    verificar_numeros,
...
from backend.src.cobra.semantico import AnalizadorSemantico
from backend.src.core.qualia_bridge import register_execution
from backend.src.core.cobra_config import (
    limite_nodos,
    limite_memoria_mb,
    limite_cpu_segundos,
)
from backend.src.core.resource_limits import (
