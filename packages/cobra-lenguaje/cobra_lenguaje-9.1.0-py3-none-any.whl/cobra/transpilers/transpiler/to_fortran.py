...
from backend.src.cobra.transpilers.transpiler.fortran_nodes.asignacion import visit_asignacion as _visit_asignacion
from backend.src.cobra.transpilers.transpiler.fortran_nodes.funcion import visit_funcion as _visit_funcion
from backend.src.cobra.transpilers.transpiler.fortran_nodes.llamada_funcion import (
    visit_llamada_funcion as _visit_llamada_funcion,
)
from backend.src.cobra.transpilers.transpiler.fortran_nodes.imprimir import visit_imprimir as _visit_imprimir
