...
from backend.src.core.ast_nodes import NodoFuncion, NodoRetorno, NodoLlamadaFuncion, NodoLlamadaMetodo, NodoAsignacion, \
    NodoImprimir, NodoHilo, NodoThrow, NodoYield, NodoEsperar, NodoDel, NodoGlobal, NodoNoLocal, NodoIdentificador
