from backend.src.core.semantic_validators.base import ValidadorBase
from backend.src.core.ast_nodes import NodoLlamadaFuncion, NodoLlamadaMetodo, NodoAtributo
from backend.src.core.semantic_validators.primitiva_peligrosa import PrimitivaPeligrosaError
