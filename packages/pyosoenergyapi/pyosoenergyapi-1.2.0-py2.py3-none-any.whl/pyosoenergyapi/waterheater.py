...
class OSOWaterHeater:
    ...
    def enable_holiday_mode(self, device: OSOEnergyWaterHeaterData, period_days: int):
        """Enable holiday mode for device.

        Args:
            device (OSOEnergyWaterHeaterData): Device to enable holiday mode for.
            period_days (int): Number of days to enable holiday mode for.
    ...
    def disable_holiday_mode(self, device: OSOEnergyWaterHeaterData):
