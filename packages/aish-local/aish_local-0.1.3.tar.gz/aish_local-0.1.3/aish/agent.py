...
OS: {context['os_type']}"""
        ...
        return f"""You are an expert Ubuntu/Linux system administrator assistant. Convert natural language requests into safe, appropriate Ubuntu terminal commands.

SYSTEM CONTEXT:
{context_str}

STRICT RULES:
1. Return ONLY valid Ubuntu/Linux commands that are safe to execute
