...
from rox.core.utils.type_utils import is_string, is_datetime
...
def tsToNum(parser, stack, context):
    op1: datetime.datetime = stack.pop()
    if not is_datetime(op1):
        stack.push(TokenTypes.UNDEFINED)
        return

    stack.push(op1.timestamp())