...
CUSTOM_PROPERTIES = PropertyType(14, "custom_properties")
PLATFORM = PropertyType(15, "platform")
DEV_MODE_SECRET = PropertyType(16, "devModeSecret")
STATE_MD5 = PropertyType(17, "state_md5")