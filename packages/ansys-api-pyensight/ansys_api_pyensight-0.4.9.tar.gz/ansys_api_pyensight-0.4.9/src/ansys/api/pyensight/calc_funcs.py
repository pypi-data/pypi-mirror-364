...
class ens_calculator:
    ...
    def bl_cfedge(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], velocity: Union['ENS_VAR', str, int], density: Union['ENS_VAR', str, int, 'float'], viscosity: Union['ENS_VAR', str, int, 'float'], ymax: float, flow_dir_comp: int = 0, opt_for_a_gradient_of_velo_mag: Optional[Union['ENS_VAR', str, int]] = None, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def bl_cfwall(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], velocity: Union['ENS_VAR', str, int], viscosity: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], free_velocity_mag: Union['ENS_VAR', str, int, 'float'], opt_for_a_gradient_of_velo_mag: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def bl_cfwallcmp(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], velocity: Union['ENS_VAR', str, int], viscosity: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], free_velocity_mag: Union['ENS_VAR', str, int, 'float'], ymax: float, tangent_flow_comp: int = 1, opt_for_a_gradient_of_velo_mag: Optional[Union['ENS_VAR', str, int]] = None, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def bl_cfwalltau(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], velocity: Union['ENS_VAR', str, int], viscosity: Union['ENS_VAR', str, int, 'float'], ymax: float, wall_shear_stress_opt: int = 0, opt_for_a_gradient_of_velo_mag: Optional[Union['ENS_VAR', str, int]] = None, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def bl_dispthick(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], velocity: Union['ENS_VAR', str, int], density: Union['ENS_VAR', str, int, 'float'], ymax: float, flow_dir_comp: int, opt_for_a_gradient_of_velo_mag: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def bl_disttovalue(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], scalar: Union['ENS_VAR', str, int], scalar_value: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def bl_momethick(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], velocity: Union['ENS_VAR', str, int], density: Union['ENS_VAR', str, int, 'float'], ymax: float, flow_dir_i_comp: int, flow_dir_j_comp: int, opt_for_a_gradient_of_velo_mag: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def bl_y1plus(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], density: Union['ENS_VAR', str, int, 'float'], viscosity: Union['ENS_VAR', str, int, 'float'], gradient_option: int = 0, vector_variable: Optional[Union['ENS_VAR', str, int]] = None, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def constantperpart(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], constant: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def defect_count(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], Defect_scalar_per_element: Union['ENS_VAR', str, int], min_constant: Union['ENS_VAR', str, int, 'float'], max_constant: Union['ENS_VAR', str, int, 'float'], result_type: str = 'Compute_Per_case', output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def defect_netvolume(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], scalar_per_element_variable: Union['ENS_VAR', str, int, 'float'], scale_factor: float, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def density(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], pressure: Union['ENS_VAR', str, int], temperature: Union['ENS_VAR', str, int], gas_constant: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def densitylognorm(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], density: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def densitynorm(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], density: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def densitystag(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def energyt(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], density: Union['ENS_VAR', str, int, 'float'], pressure: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def enthalpy(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def enthalpynormstag(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], free_speed_of_sound: Union['ENS_VAR', str, int, 'float'], free_velocity: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def enthalpystag(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def fluidshear(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], velocity_magnitude_gradient: Union['ENS_VAR', str, int], viscosity: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def fluidshearmax(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], velocity: Union['ENS_VAR', str, int], density: Union['ENS_VAR', str, int, 'float'], turb_kinetic_energy: Union['ENS_VAR', str, int], turb_dissipation: Union['ENS_VAR', str, int], laminar_viscosity: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def helicityrelfilter(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], velocity: Union['ENS_VAR', str, int], free_velocity: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def kinen(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], velocity: Union['ENS_VAR', str, int], density: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def mach(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def makescalelem(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], constant: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def makescalnode(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], constant: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def makevect(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], scalar: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def massfluxavg(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], scalar: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], density: Union['ENS_VAR', str, int, 'float'], result_type: str = 'Compute_Per_case', output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def matspecies(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], scalar_per_elem: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def momentum(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], velocity: Union['ENS_VAR', str, int], density: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def normc(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], pressure: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], viscosity: Union['ENS_VAR', str, int, 'float'], result_type: str = 'Compute_Per_case', output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def pres(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def prescoef(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], free_speed_of_sound: Union['ENS_VAR', str, int, 'float'], free_velocity: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def presdynam(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], density: Union['ENS_VAR', str, int, 'float'], velocity: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def preslognorm(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], free_speed_of_sound: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def presnorm(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], free_speed_of_sound: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def presnormstag(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], free_speed_of_sound: Union['ENS_VAR', str, int, 'float'], free_velocity: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def prespitot(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def prespitotratio(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], free_speed_of_sound: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def presstag(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def presstagcoef(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], free_speed_of_sound: Union['ENS_VAR', str, int, 'float'], free_velocity: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def prest(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], pressure: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], density: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def shockplot3d(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def smoothmesh(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], number_of_passes: int, smoothing_weight: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def sonicspeed(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def statmoment(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], opt_variable: Union['ENS_VAR', str, int, 'float'], which: int = 0, result_type: str = 'Compute_Per_case', output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def statregspa(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], y: Union['ENS_VAR', str, int, 'float'], x0: Union['ENS_VAR', str, int, 'float'], x1: Union['ENS_VAR', str, int, 'float'], x2: Union['ENS_VAR', str, int, 'float'], x3: Union['ENS_VAR', str, int, 'float'], x4: Union['ENS_VAR', str, int, 'float'], weight: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def statregval1(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], regression_var: Union['ENS_VAR', str, int, 'float'], which_stat: int = 0, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def statregval2(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], regression_var: Union['ENS_VAR', str, int, 'float'], which_stat: int = 0, var_select: Optional[int] = None, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def swirl(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], density: Union['ENS_VAR', str, int, 'float'], velocity: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def temperature(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], gas: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def tempernorm(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], free_speed_of_sound: Union['ENS_VAR', str, int, 'float'], gas: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def tempernormstag(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], free_speed_of_sound: Union['ENS_VAR', str, int, 'float'], free_velocity: Union['ENS_VAR', str, int, 'float'], gas: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def temperstag(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], gas: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def velo(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], momentum: Union['ENS_VAR', str, int], density: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def vortgamma(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], velocity: Union['ENS_VAR', str, int], gammafunc: int = 1, proximity_radius: Optional[Union['ENS_VAR', str, int, 'float']] = None, proximity_option: int = 0, output_varname: Optional[str] = None) -> 'ENS_VAR':
