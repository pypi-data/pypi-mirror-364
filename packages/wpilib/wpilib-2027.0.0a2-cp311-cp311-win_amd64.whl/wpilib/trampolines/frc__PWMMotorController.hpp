...
struct PyTrampoline_PWMMotorController : PyTrampolineBase_PWMMotorController<PyTrampolineBase, PyTrampolineCfg> {
  using PyTrampolineBase_PWMMotorController<PyTrampolineBase, PyTrampolineCfg>::PyTrampolineBase_PWMMotorController;
    ...
    #ifndef SWGEN_UDISABLE_frc__PWMMotorController_SetSpeed
      using frc::PWMMotorController::SetSpeed;
      #define SWGEN_UDISABLE_frc__PWMMotorController_SetSpeed
    #endif
  #endif

  #ifndef SWGEN_DISABLE_KGetSpeed_v
    #ifndef SWGEN_UDISABLE_frc__PWMMotorController_GetSpeed
      using frc::PWMMotorController::GetSpeed;
      #define SWGEN_UDISABLE_frc__PWMMotorController_GetSpeed
    #endif
  #endif

  #ifndef SWGEN_DISABLE_SetBounds_Tmicrosecond_t_Tmicrosecond_t_Tmicrosecond_t_Tmicrosecond_t_Tmicrosecond_t
    #ifndef SWGEN_UDISABLE_frc__PWMMotorController_SetBounds
      using frc::PWMMotorController::SetBounds;
      #define SWGEN_UDISABLE_frc__PWMMotorController_SetBounds
    #endif
  #endif
