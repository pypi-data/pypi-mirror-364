...
class GenericHID:
    ...
    class RumbleType:
        ...
        def value(self) -> int:
            ...
    @typing.overload
    def POV(self, angle: wpilib._wpilib.DriverStation.POVDirection, loop: wpilib.event._event.EventLoop) -> wpilib.event._event.BooleanEvent:
        """
        ...
        """
    @typing.overload
    def POV(self, pov: typing.SupportsInt, angle: wpilib._wpilib.DriverStation.POVDirection, loop: wpilib.event._event.EventLoop) -> wpilib.event._event.BooleanEvent:
        """
        Constructs a BooleanEvent instance based around this angle of a POV on the
        HID.
    ...
    def getName(self) -> str:
        ...
        """
    def getPOV(self, pov: typing.SupportsInt = 0) -> wpilib._wpilib.DriverStation.POVDirection:
        """
