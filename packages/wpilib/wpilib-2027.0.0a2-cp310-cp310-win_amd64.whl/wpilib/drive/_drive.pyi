...
class DifferentialDrive(RobotDriveBase, wpiutil._wpiutil.Sendable):
    ...
    * :meth:`curvatureDrive` is similar in concept to
    ...
    def tankDriveIK(leftSpeed: typing.SupportsFloat, rightSpeed: typing.SupportsFloat, squareInputs: bool = True) -> DifferentialDrive.WheelSpeeds:
        ...
        """
    @typing.overload
    def __init__(self, leftMotor: wpilib._wpilib.interfaces.MotorController, rightMotor: wpilib._wpilib.interfaces.MotorController) -> None:
        """
        ...
        """
    @typing.overload
    def __init__(self, leftMotor: typing.Callable[[typing.SupportsFloat], None], rightMotor: typing.Callable[[typing.SupportsFloat], None]) -> None:
        """
        Construct a DifferentialDrive.
...
class MecanumDrive(RobotDriveBase, wpiutil._wpiutil.Sendable):
    ...
    def driveCartesianIK(xSpeed: typing.SupportsFloat, ySpeed: typing.SupportsFloat, zRotation: typing.SupportsFloat, gyroAngle: wpimath.geometry._geometry.Rotation2d = ...) -> MecanumDrive.WheelSpeeds:
        ...
        """
    @typing.overload
    def __init__(self, frontLeftMotor: wpilib._wpilib.interfaces.MotorController, rearLeftMotor: wpilib._wpilib.interfaces.MotorController, frontRightMotor: wpilib._wpilib.interfaces.MotorController, rearRightMotor: wpilib._wpilib.interfaces.MotorController) -> None:
        """
        ...
        """
    @typing.overload
    def __init__(self, frontLeftMotor: typing.Callable[[typing.SupportsFloat], None], rearLeftMotor: typing.Callable[[typing.SupportsFloat], None], frontRightMotor: typing.Callable[[typing.SupportsFloat], None], rearRightMotor: typing.Callable[[typing.SupportsFloat], None]) -> None:
        """
        Construct a MecanumDrive.
