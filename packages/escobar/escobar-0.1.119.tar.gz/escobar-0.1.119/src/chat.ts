...
export class ChatWidget extends Widget {
  ...
  private async autoSaveJupyterHubUsername(): Promise<void> {
    try {
      ...
      if (currentUsername !== 'User' && currentUsername !== storedUsername && currentUsername.includes('@')) {
        console.log('🔧 AUTO-SAVE: Detected JupyterHub username:', currentUsername);
        console.log('🔧 AUTO-SAVE: Current stored username:', storedUsername);
        ...
        console.log('🔧 AUTO-SAVE: Updated username in settings from JupyterHub:', currentUsername);
      } else {
        console.log('🔧 AUTO-SAVE: No JupyterHub username update needed');
        console.log('🔧 AUTO-SAVE: Current username:', currentUsername);
        console.log('🔧 AUTO-SAVE: Stored username:', storedUsername);
      }
    } catch (error) {
  ...
  private onSettingsChanged(settings: IChatSettings): void {
    ...
    console.log('🔧 SETTINGS: Updated username to:', currentUsername);
  }
  ...
  async init() {
    ...
    console.log('🔧 INIT: Updated username to:', currentUsername);
