...
def normalize_app_name(name: str) -> str:
    """Nettoie le nom de l'application : remplace espaces et tirets par des underscores"""
...
def main():
    ...
    # Fusionne tous les arguments en un seul nom (utile si pas de guillemets)
    raw_name = "_".join(sys.argv[1:])  # ex: blog app -> blog_app
    create_app(raw_name)
