...
def copy_multiplatform_artifacts(
    ...
    # 創建目標目錄
    desktop_dir = project_root / "src" / "interactive_mcp_server" / "desktop_release"
    desktop_dir.mkdir(parents=True, exist_ok=True)

    # 定義平台到文件名的映射
    platform_mapping = {
        "x86_64-pc-windows-msvc": "interactive-mcp-server-desktop.exe",
        "x86_64-apple-darwin": "interactive-mcp-server-desktop-macos-intel",
        "aarch64-apple-darwin": "interactive-mcp-server-desktop-macos-arm64",
        "x86_64-unknown-linux-gnu": "interactive-mcp-server-desktop-linux",
    }
