...
import { createManualSpan, traceMethod, setAgentName } from '@stackgen-ai/sgai-evaluator';
...
async function main() {
  ...
  // Can call the setAgentName function to set the agent name for tracing if no env var is set or for overriding the env var
  // setAgentName('CreativeStoryAgent');
  // console.log('🏷️ Agent name set to: CreativeStoryAgent\n');
