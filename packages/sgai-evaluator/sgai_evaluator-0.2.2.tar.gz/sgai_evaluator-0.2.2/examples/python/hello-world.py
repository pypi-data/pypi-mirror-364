...
from sgai_evaluator import trace, start_span, flush, set_agent_name
...
def generate_story_with_openai(prompt: str) -> str:
    ...
    with start_span('openai_story_generation') as generation_span:
        try:
            ...
            # Note: The sgai_evaluator package handles span updates automatically
            
            return story
            
        except Exception as e:
            # Error handling is automatic with sgai_evaluator
            raise
