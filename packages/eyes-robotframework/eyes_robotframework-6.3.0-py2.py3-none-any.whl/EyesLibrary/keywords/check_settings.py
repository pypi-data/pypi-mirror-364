...
class DynamicCheckSettingsKeywords(LibraryComponent):
    ...
    def dynamic_region_by_element(
        ...
        *Example:*
        ...
        is_webelement_guard(element)
        types_or_patterns = parse_dynamic_text(type_or_pattern)
        return self.current_check_settings.dynamic(element, *types_or_patterns, padding=parse_padding(padding))
    ...
    def dynamic_region_by_selector(
        ...
        *Example:*
        ...
        types_or_patterns = parse_dynamic_text(type_or_pattern)
        return self.current_check_settings.dynamic(
            *self.from_locators_to_supported_form(selector), *types_or_patterns, padding=parse_padding(padding)
        )
