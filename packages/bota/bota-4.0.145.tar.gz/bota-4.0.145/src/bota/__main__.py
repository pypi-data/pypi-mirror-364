...
def install_desktop_app(debian_installer_url, port, skip_apache_request_routing, api_base_path, custom_args):
    """
...
def uninstall_desktop_app(debian_installer_url, package_name):
    """
