...
class WindowsInstaller:
    ...
    def _is_latex_installed(self) -> bool:
        ...
        try:
            result = subprocess.run(
                ["pdflatex", "--version"], capture_output=True, text=True, encoding="utf-8", timeout=10
            )
    ...
    def _is_nodejs_installed(self) -> bool:
        ...
        try:
            ...
            npm_result = subprocess.run(
                ["npm", "--version"], capture_output=True, text=True, encoding="utf-8", timeout=10
            )
    ...
    def _is_r_installed(self) -> bool:
        ...
        try:
            result = subprocess.run(["R", "--version"], capture_output=True, text=True, encoding="utf-8", timeout=10)
            return result.returncode == 0
        except:
            return False
    ...
    def _install_latex_chocolatey(self) -> bool:
        ...
        try:
            ...
            subprocess.run(["choco", "--version"], capture_output=True, text=True, encoding="utf-8", timeout=10)
