...
__all__ = ["SubstatusTupleResponse", "SubstatusTupleResponseItem"]


class SubstatusTupleResponseItem(BaseModel):
...
SubstatusTupleResponse: TypeAlias = List[SubstatusTupleResponseItem]
