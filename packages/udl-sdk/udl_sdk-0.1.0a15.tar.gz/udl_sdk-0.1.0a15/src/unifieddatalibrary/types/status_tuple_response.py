...
__all__ = ["StatusTupleResponse", "StatusTupleResponseItem", "StatusTupleResponseItemSubStatusCollection"]


class StatusTupleResponseItemSubStatusCollection(BaseModel):
...
class StatusTupleResponseItem(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
    ...
    sub_status_collection: Optional[List[StatusTupleResponseItemSubStatusCollection]] = FieldInfo(
...
StatusTupleResponse: TypeAlias = List[StatusTupleResponseItem]
