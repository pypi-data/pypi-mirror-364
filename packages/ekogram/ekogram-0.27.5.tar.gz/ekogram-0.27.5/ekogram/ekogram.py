...
class FreeGpt:
    ...
    def toolchat(self, prompt: str = None, model: str = "grok-3-beta") -> str:
        '''Генерация ответа используя Toolbaz\nДоступные модели: gemini-2.5-pro, gemini-2.5-flash, gemini-2.0-flash-thinking, gemini-2.0-flash, o3-mini, gpt-4o-latest, gpt-4o, toolbaz_v4, toolbaz_v3.5_pro, deepseek-v3, deepseek-r1, grok-3-beta, Llama-4-Maverick, Llama-3.3-70B, L3-70B-Euryale-v2.1, midnight-rose, unfiltered_x'''
        try:
            HEADERS = {
                "accept": "*/*",
