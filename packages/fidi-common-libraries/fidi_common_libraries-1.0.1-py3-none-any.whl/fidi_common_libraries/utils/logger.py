...
def registrar_log_banco(
    ...
    Args:
        conn: Conexão com o banco de dados (cx_Oracle, oracledb, psycopg2 ou pyodbc)
    ...
    """
    if isinstance(conn, (cx_Oracle.Connection, oracledb.Connection)):
...
def registrar_log_rpa_oracle(
    ...
    Args:
        conn: Conexão com o banco de dados Oracle (cx_Oracle ou oracledb)
        ambiente: Ambiente (DEV, HML, PRD)
