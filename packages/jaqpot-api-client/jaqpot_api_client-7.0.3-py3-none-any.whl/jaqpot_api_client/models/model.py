...
class Model(BaseModel):
    ...
    raw_model: Optional[Union[Annotated[bytes, Field(strict=True, max_length=133000000)], Annotated[str, Field(strict=True, max_length=133000000)]]] = Field(default=None, description="A base64 representation of the raw model.", alias="rawModel")
