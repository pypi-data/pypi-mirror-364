...
from cirque.packages.grpc import vna_pb2, vna_pb2_grpc
...
class VNA:
    ...
    def __init__(self, connection):
        ...
        self._stub = vna_pb2_grpc.VNAServiceStub(self.connection.get_channel())
    ...
    def multiplier(self) -> int:
        ...
        """
        return self._stub.GetMultiplier(Empty()).value
    ...
    def multiplier(self, value: int):
        ...
        """
        self._stub.SetMultiplier(DoubleValue(value=value))
    ...
    def phase_unit(self, unit: PhaseUnits):
        ...
        self._stub.SetPhaseUnit(vna_pb2.PhaseUnit_(value=unit))
