        ...
        messages=[
            {
                "role": "system",
                "content": (
                    "You are an OCR information extractor. ONLY extract text that is explicitly visible in the input. "
                    "DO NOT translate Arabic to English, unless explicity specified."
                    "Return the values exactly as they appear. "
...
def translate_occupation_ar_to_en(occupation_ar: str) -> dict:
    if occupation_ar=='':
        return {'occupation_en':''}

    occupation_func = {
        "name": "translate_occupation",
        "description": "Translates Arabic occupation to English",
        "parameters": {
            "type": "object",
            "properties": {
                "occupation_en": {
                    "type": "string",
                    "description": "The translated English occupation"
                }
            },
            "required": ["occupation_en"]
        }
    }
        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "Your sole task is to translate Arabic job titles into English occupation names."
                )
            },
            {
                "role": "user",
                "content": f"Translate the Arabic occupation '{occupation_ar}' to English."
            }
        ],
        functions=[occupation_func],
        function_call={"name": "translate_occupation"}
    )
    ...
    return {"occupation_en": parsed_args["occupation_en"]}
...
def qatar_front_id_extraction(client, image_data, front_id_text, front_id_text_description):
    ...
    try:
        ...
        if isinstance(result,dict):
            ...
            occupation_en = translate_occupation_ar_to_en(result.occupation)
            ...
            'occupation_en' : occupation_en.get('occupation_en','')
            }
