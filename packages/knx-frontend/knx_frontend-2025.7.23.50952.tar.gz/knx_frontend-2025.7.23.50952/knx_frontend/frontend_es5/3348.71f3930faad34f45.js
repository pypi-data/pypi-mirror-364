"use strict";(self.webpackChunkknx_frontend=self.webpackChunkknx_frontend||[]).push([["3348"],{96642:function(e,t,i){i.d(t,{q:()=>s});i(64455),i(32192);const a=/^(\w+)\.(\w+)$/,s=e=>a.test(e)},45618:function(e,t,i){i.a(e,(async function(e,t){try{i(84730),i(39710),i(26847),i(2394),i(81738),i(94814),i(29981),i(22960),i(6989),i(72489),i(87799),i(1455),i(67886),i(65451),i(46015),i(38334),i(94880),i(75643),i(29761),i(56389),i(27530);var a=i(73742),s=i(59048),o=i(7616),l=i(28105),n=i(74608),d=i(29740),r=i(76151),c=i(93318),h=i(75012),v=i(47469),u=i(45103),p=i(47584),_=(i(86776),i(78645),i(32986),i(9459)),g=(i(14891),i(36344),i(34555)),y=i(89395),b=e([_,g]);[_,g]=b.then?(await b)():b;let f,$,k,m,w,x,j,O,C,S,z,B,F,I,M=e=>e;const L="M15.07,11.25L14.17,12.17C13.45,12.89 13,13.5 13,15H11V14.5C11,13.39 11.45,12.39 12.17,11.67L13.41,10.41C13.78,10.05 14,9.55 14,9C14,7.89 13.1,7 12,7A2,2 0 0,0 10,9H8A4,4 0 0,1 12,5A4,4 0 0,1 16,9C16,9.88 15.64,10.67 15.07,11.25M13,19H11V17H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12C22,6.47 17.5,2 12,2Z",V=(e,t)=>"object"==typeof t?!!Array.isArray(t)&&t.some((t=>e.includes(t))):e.includes(t),A=e=>e.selector&&!e.required&&!("boolean"in e.selector&&e.default);class E extends s.oi{willUpdate(e){var t,i,a,s,o,l,n,c;if(this.hasUpdated||(this.hass.loadBackendTranslation("services"),this.hass.loadBackendTranslation("selector")),!e.has("value"))return;const h=e.get("value");(null==h?void 0:h.action)!==(null===(t=this.value)||void 0===t?void 0:t.action)&&(this._checkedKeys=new Set);const v=this._getServiceInfo(null===(i=this.value)||void 0===i?void 0:i.action,this.hass.services);var u;null!==(a=this.value)&&void 0!==a&&a.action?null!=h&&h.action&&(0,r.M)(this.value.action)===(0,r.M)(h.action)||this._fetchManifest((0,r.M)(null===(u=this.value)||void 0===u?void 0:u.action)):this._manifest=void 0;if(v&&"target"in v&&(null!==(s=this.value)&&void 0!==s&&null!==(s=s.data)&&void 0!==s&&s.entity_id||null!==(o=this.value)&&void 0!==o&&null!==(o=o.data)&&void 0!==o&&o.area_id||null!==(l=this.value)&&void 0!==l&&null!==(l=l.data)&&void 0!==l&&l.device_id)){var p,_,g;const e=Object.assign({},this.value.target);!this.value.data.entity_id||null!==(p=this.value.target)&&void 0!==p&&p.entity_id||(e.entity_id=this.value.data.entity_id),!this.value.data.area_id||null!==(_=this.value.target)&&void 0!==_&&_.area_id||(e.area_id=this.value.data.area_id),!this.value.data.device_id||null!==(g=this.value.target)&&void 0!==g&&g.device_id||(e.device_id=this.value.data.device_id),this._value=Object.assign(Object.assign({},this.value),{},{target:e,data:Object.assign({},this.value.data)}),delete this._value.data.entity_id,delete this._value.data.device_id,delete this._value.data.area_id}else this._value=this.value;if((null==h?void 0:h.action)!==(null===(n=this.value)||void 0===n?void 0:n.action)){let e=!1;if(this._value&&v){const t=this.value&&!("data"in this.value);this._value.data||(this._value.data={}),v.flatFields.forEach((i=>{i.selector&&i.required&&void 0===i.default&&"boolean"in i.selector&&void 0===this._value.data[i.key]&&(e=!0,this._value.data[i.key]=!1),t&&i.selector&&void 0!==i.default&&void 0===this._value.data[i.key]&&(e=!0,this._value.data[i.key]=i.default)}))}e&&(0,d.B)(this,"value-changed",{value:Object.assign({},this._value)})}if(null!==(c=this._value)&&void 0!==c&&c.data){const e=this._yamlEditor;e&&e.value!==this._value.data&&e.setValue(this._value.data)}}_filterField(e,t){return!!t.length&&!!t.some((t=>{var i;const a=this.hass.states[t];return!!a&&(!(null===(i=e.supported_features)||void 0===i||!i.some((e=>(0,h.e)(a,e))))||!(!e.attribute||!Object.entries(e.attribute).some((([e,t])=>e in a.attributes&&V(t,a.attributes[e])))))}))}render(){var e,t,i,a,o,l,n,d;const h=this._getServiceInfo(null===(e=this._value)||void 0===e?void 0:e.action,this.hass.services),v=(null==h?void 0:h.fields.length)&&!h.hasSelector.length||h&&Object.keys((null===(t=this._value)||void 0===t?void 0:t.data)||{}).some((e=>!h.hasSelector.includes(e))),u=v&&(null==h?void 0:h.fields.find((e=>"entity_id"===e.key))),_=Boolean(!v&&(null==h?void 0:h.flatFields.some((e=>A(e))))),g=this._getTargetedEntities(null==h?void 0:h.target,this._value),y=null!==(i=this._value)&&void 0!==i&&i.action?(0,r.M)(this._value.action):void 0,b=null!==(a=this._value)&&void 0!==a&&a.action?(0,c.p)(this._value.action):void 0,z=b&&this.hass.localize(`component.${y}.services.${b}.description`)||(null==h?void 0:h.description);return(0,s.dy)(f||(f=M`${0}
    ...
    ${0} `),this.hidePicker?s.Ld:(0,s.dy)($||($=M`<ha-service-picker
        ...
        `),z?(0,s.dy)(m||(m=M`<p>${0}</p>`),z):"",this._manifest?(0,s.dy)(w||(w=M` <a
                ...
                >
                  <ha-icon-button
                    ...
                    class="help-icon"
                  ></ha-icon-button>
                </a>`),this._manifest.is_built_in?(0,p.R)(this.hass,`/integrations/${this._manifest.domain}`):this._manifest.documentation,this.hass.localize("ui.components.service-control.integration_doc"),L):s.Ld),h&&"target"in h?(0,s.dy)(x||(x=M`<ha-settings-row .narrow=${0}>
          ${0}
          <span slot="heading"
            >${0}</span
          >
        ...
        ></ha-settings-row>`),this.narrow,_?(0,s.dy)(j||(j=M`<div slot="prefix" class="checkbox-spacer"></div>`)):"",this.hass.localize("ui.components.service-control.target"),this.hass.localize("ui.components.service-control.target_secondary"),this.hass,this._targetSelector(h.target),this.disabled,this._targetChanged,null===(l=this._value)||void 0===l?void 0:l.target):u?(0,s.dy)(O||(O=M`<ha-entity-picker
            ...
            @value-changed=${0}
            allow-custom-entity
          ></ha-entity-picker>`),this.hass,this.disabled,null===(n=this._value)||void 0===n||null===(n=n.data)||void 0===n?void 0:n.entity_id,this.hass.localize(`component.${y}.services.${b}.fields.entity_id.description`)||u.description,this._entityPicked):"",v?(0,s.dy)(C||(C=M`<ha-yaml-editor
          .hass=${0}
          .label=${0}
          .name=${0}
          .readOnly=${0}
          .defaultValue=${0}
          @value-changed=${0}
        ></ha-yaml-editor>`),this.hass,this.hass.localize("ui.components.service-control.action_data"),"data",this.disabled,null===(d=this._value)||void 0===d?void 0:d.data,this._dataChanged):null==h?void 0:h.fields.map((e=>{if(!e.fields)return this._renderField(e,_,y,b,g);const t=Object.entries(e.fields).map((([e,t])=>Object.assign({key:e},t)));return t.length&&this._hasFilteredFields(t,g)?(0,s.dy)(S||(S=M`<ha-expansion-panel
                left-chevron
                .expanded=${0}
                .header=${0}
                .secondary=${0}
          ...
          <ha-selector
            ...
            .localizeValue=${0}
          ></ha-selector>
        </ha-settings-row>`),this.narrow,_?(0,s.dy)(F||(F=M`<ha-checkbox
                .key=${0}
                .checked=${0}
                .disabled=${0}
                @change=${0}
                slot="prefix"
              ></ha-checkbox>`),e.key,this._checkedKeys.has(e.key)||(null===(c=this._value)||void 0===c?void 0:c.data)&&void 0!==this._value.data[e.key],this.disabled,this._checkboxChanged):t?(0,s.dy)(B||(B=M`<div slot="prefix" class="checkbox-spacer"></div>`)):"",this.hass.localize(`component.${i}.services.${a}.fields.${e.key}.name`)||e.name||e.key,this.hass.localize(`component.${i}.services.${a}.fields.${e.key}.description`)||(null==e?void 0:e.description),this.disabled||_&&!this._checkedKeys.has(e.key)&&(!(null!==(h=this._value)&&void 0!==h&&h.data)||void 0===this._value.data[e.key]),this.hass,p,e.key,this._serviceDataChanged,null!==(v=this._value)&&void 0!==v&&v.data?this._value.data[e.key]:void 0,e.default,this._localizeValueCallback):""},this._localizeValueCallback=e=>{var t;return null!==(t=this._value)&&void 0!==t&&t.action?this.hass.localize(`component.${(0,r.M)(this._value.action)}.selector.${e}`):""}}}E.styles=(0,s.iv)(I||(I=M`
    ha-settings-row {
  ...
  `)),(0,a.__decorate)([(0,o.Cb)({attribute:!1})],E.prototype,"hass",void 0),(0,a.__decorate)([(0,o.Cb)({attribute:!1})],E.prototype,"value",void 0),(0,a.__decorate)([(0,o.Cb)({type:Boolean})],E.prototype,"disabled",void 0),(0,a.__decorate)([(0,o.Cb)({type:Boolean})],E.prototype,"narrow",void 0),(0,a.__decorate)([(0,o.Cb)({attribute:"show-advanced",type:Boolean})],E.prototype,"showAdvanced",void 0),(0,a.__decorate)([(0,o.Cb)({attribute:"show-service-id",type:Boolean})],E.prototype,"showServiceId",void 0),(0,a.__decorate)([(0,o.Cb)({attribute:"hide-picker",type:Boolean,reflect:!0})],E.prototype,"hidePicker",void 0),(0,a.__decorate)([(0,o.Cb)({attribute:"hide-description",type:Boolean})],E.prototype,"hideDescription",void 0),(0,a.__decorate)([(0,o.SB)()],E.prototype,"_value",void 0),(0,a.__decorate)([(0,o.SB)()],E.prototype,"_checkedKeys",void 0),(0,a.__decorate)([(0,o.SB)()],E.prototype,"_manifest",void 0),(0,a.__decorate)([(0,o.IO)("ha-yaml-editor")],E.prototype,"_yamlEditor",void 0),E=(0,a.__decorate)([(0,o.Mo)("ha-service-control")],E),t()}catch(f){t(f)}}))},42873:function(e,t,i){i.a(e,(async function(e,t){try{var a=i(73742),s=i(59048),o=i(7616),l=i(28177),n=i(76151),d=i(54974),r=(i(3847),i(40830),e([d]));d=(r.then?(await r)():r)[0];let c,h,v,u,p=e=>e;class _ extends s.oi{render(){if(this.icon)return(0,s.dy)(c||(c=p`<ha-icon .icon=${0}></ha-icon>`),this.icon);if(!this.service)return s.Ld;if(!this.hass)return this._renderFallback();const e=(0,d.t3)(this.hass,this.service).then((e=>e?(0,s.dy)(h||(h=p`<ha-icon .icon=${0}></ha-icon>`),e):this._renderFallback()));return(0,s.dy)(v||(v=p`${0}`),(0,l.C)(e))}_renderFallback(){const e=(0,n.M)(this.service);return(0,s.dy)(u||(u=p`
      <ha-svg-icon
        .path=${0}
      ></ha-svg-icon>
  ...
  `),0!==t,this.hass,e.id,e.primary,e.secondary,e.service_id&&this.showServiceId?(0,s.dy)(g||(g=k`<span slot="supporting-text" class="code">
    ...
    `))],v=(0,a.__decorate)([(0,n.Mo)("ha-tooltip")],v),t()}catch(c){t(c)}}))},47584:function(e,t,i){i.d(t,{R:()=>a});i(39710),i(56389);const a=(e,t)=>`https://${e.config.version.includes("b")?"rc":e.config.version.includes("dev")?"next":"www"}.home-assistant.io${t}`}}]);
//# sourceMappingURL=3348.71f3930faad34f45.js.map