/*! For license information please see 760.4094a78e1c0e5aa9.js.LICENSE.txt */
"use strict";(self.webpackChunkknx_frontend=self.webpackChunkknx_frontend||[]).push([["760"],{83379:function(e,t,o){o.a(e,(async function(e,i){try{o.r(t),o.d(t,{HaIconOverflowMenu:()=>_});o(26847),o(81738),o(6989),o(27530);var r=o(73742),n=o(59048),a=o(7616),s=o(31733),l=o(77204),d=(o(51431),o(78645),o(40830),o(27341)),c=(o(72633),o(1963),e([d]));d=(c.then?(await c)():c)[0];let m,p,h,u,v,g,y,b,f=e=>e;const x="M12,16A2,2 0 0,1 14,18A2,2 0 0,1 12,20A2,2 0 0,1 10,18A2,2 0 0,1 12,16M12,10A2,2 0 0,1 14,12A2,2 0 0,1 12,14A2,2 0 0,1 10,12A2,2 0 0,1 12,10M12,4A2,2 0 0,1 14,6A2,2 0 0,1 12,8A2,2 0 0,1 10,6A2,2 0 0,1 12,4Z";class _ extends n.oi{render(){return(0,n.dy)(m||(m=f`
      ${0}
    `),this.narrow?(0,n.dy)(p||(p=f` <!-- Collapsed representation for small screens -->
            <ha-md-button-menu
              @click=${0}
              positioning="popover"
            >
              ...
              ${0}
            </ha-md-button-menu>`),this._handleIconOverflowMenuOpened,this.hass.localize("ui.common.overflow_menu"),x,this.items.map((e=>e.divider?(0,n.dy)(h||(h=f`<ha-md-divider
                      role="separator"
                      tabindex="-1"
                    ></ha-md-divider>`)):(0,n.dy)(u||(u=f`<ha-md-menu-item
                      ?disabled=${0}
                      .clickAction=${0}
                      class=${0}
                    >
                      ...
                      ></ha-svg-icon>
                      ${0}
                    </ha-md-menu-item> `),e.disabled,e.action,(0,s.$)({warning:Boolean(e.warning)}),(0,s.$)({warning:Boolean(e.warning)}),e.path,e.label)))):(0,n.dy)(v||(v=f`
            <!-- Icon representation for big screens -->
            ${0}
          `),this.items.map((e=>{var t;return e.narrowOnly?n.Ld:e.divider?(0,n.dy)(g||(g=f`<div role="separator"></div>`)):(0,n.dy)(y||(y=f`<ha-tooltip
                      .disabled=${0}
                      .content=${0}
                    >
                      <ha-icon-button
                        ...
                        ?disabled=${0}
                      ></ha-icon-button>
                    </ha-tooltip>`),!e.tooltip,null!==(t=e.tooltip)&&void 0!==t?t:"",e.action,e.label,e.path,e.disabled)}))))}_handleIconOverflowMenuOpened(e){e.stopPropagation()}static get styles(){return[l.Qx,(0,n.iv)(b||(b=f`
        :host {
          display: flex;
...
`))},94598:function(e,t,o){o.d(t,{$:()=>_});o(26847),o(87799),o(27530);var i=o(73742),r=(o(31073),o(79239),o(12253),o(59048)),n=o(7616),a=o(31733),s=o(3939),l=o(67749),d=(o(37908),o(2394),o(81738),o(22960),o(20655),o(67419));class c{get typeaheadText(){if(null!==this.internalTypeaheadText)return this.internalTypeaheadText;const e=this.getHeadlineElements(),t=[];return e.forEach((e=>{e.textContent&&e.textContent.trim()&&t.push(e.textContent.trim())})),0===t.length&&this.getDefaultElements().forEach((e=>{e.textContent&&e.textContent.trim()&&t.push(e.textContent.trim())})),0===t.length&&this.getSupportingTextElements().forEach((e=>{e.textContent&&e.textContent.trim()&&t.push(e.textContent.trim())})),t.join(" ")}get tagName(){switch(this.host.type){case"link":return"a";case"button":return"button";default:return"li"}}get role(){return"option"===this.host.type?"option":"menuitem"}hostConnected(){this.host.toggleAttribute("md-menu-item",!0)}hostUpdate(){this.host.href&&(this.host.type="link")}setTypeaheadText(e){this.internalTypeaheadText=e}constructor(e,t){this.host=e,this.internalTypeaheadText=null,this.onClick=()=>{this.host.keepOpen||this.host.dispatchEvent((0,d.d7)(this.host,{kind:d.GB.CLICK_SELECTION}))},this.onKeydown=e=>{if(this.host.href&&"Enter"===e.code){const e=this.getInteractiveElement();e instanceof HTMLAnchorElement&&e.click()}if(e.defaultPrevented)return;const t=e.code;this.host.keepOpen&&"Escape"!==t||(0,d.kE)(t)&&(e.preventDefault(),this.host.dispatchEvent((0,d.d7)(this.host,{kind:d.GB.KEYDOWN,key:t})))},this.getHeadlineElements=t.getHeadlineElements,this.getSupportingTextElements=t.getSupportingTextElements,this.getDefaultElements=t.getDefaultElements,this.getInteractiveElement=t.getInteractiveElement,this.host.addController(this)}}let m,p,h,u,v,g,y,b,f=e=>e;const x=(0,l.T)(r.oi);class _ extends x{get typeaheadText(){return this.menuItemController.typeaheadText}set typeaheadText(e){this.menuItemController.setTypeaheadText(e)}render(){return this.renderListItem((0,r.dy)(m||(m=f`
    ...
    `),this.renderRipple(),this.renderFocusRing(),this.renderBody()))}renderListItem(e){const t="link"===this.type;let o;switch(this.menuItemController.tagName){case"a":o=(0,s.i0)(p||(p=f`a`));break;case"button":o=(0,s.i0)(h||(h=f`button`));break;default:o=(0,s.i0)(u||(u=f`li`))}const i=t&&this.target?this.target:r.Ld;return(0,s.dy)(v||(v=f`
      <${0}
        id="item"
        tabindex=${0}
        role=${0}
...
//# sourceMappingURL=760.4094a78e1c0e5aa9.js.map