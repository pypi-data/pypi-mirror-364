"use strict";(self.webpackChunkknx_frontend=self.webpackChunkknx_frontend||[]).push([["3703"],{12960:function(e,t,i){i.r(t),i.d(t,{HaFormInteger:()=>v});i(37908),i(84730),i(26847),i(70820),i(27530);var a=i(73742),s=i(59048),h=i(7616),d=i(29740);i(57275),i(86776),i(42592),i(38573);let l,o,r,u,n,c=e=>e;class v extends s.oi{focus(){this._input&&this._input.focus()}render(){var e,t;return void 0!==this.schema.valueMin&&void 0!==this.schema.valueMax&&this.schema.valueMax-this.schema.valueMin<256?(0,s.dy)(l||(l=c`
        <div>
          ${0}
          <div class="flex">
            ${0}
      ...
      `),this.label,this.schema.required?"":(0,s.dy)(o||(o=c`
                  <ha-checkbox
                    @change=${0}
                    .checked=${0}
                    .disabled=${0}
                  ></ha-checkbox>
                `),this._handleCheckboxChange,void 0!==this.data,this.disabled),this._value,this.schema.valueMin,this.schema.valueMax,this.disabled||void 0===this.data&&!this.schema.required,this._valueChanged,this.helper?(0,s.dy)(r||(r=c`<ha-input-helper-text>${0}</ha-input-helper-text>`),this.helper):""):(0,s.dy)(u||(u=c`
      <ha-textfield
        type="number"
        inputMode="numeric"
        .label=${0}
...
//# sourceMappingURL=3703.bccf256cc4647393.js.map