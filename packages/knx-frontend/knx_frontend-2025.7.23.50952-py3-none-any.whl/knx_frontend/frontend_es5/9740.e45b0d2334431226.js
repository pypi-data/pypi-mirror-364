/*! For license information please see 9740.e45b0d2334431226.js.LICENSE.txt */
"use strict";(self.webpackChunkknx_frontend=self.webpackChunkknx_frontend||[]).push([["9740"],{94262:function(e,r,a){a(26847),a(27530);var i=a(73742),s=a(59048),t=a(7616),o=a(29740);a(24340);let n,l=e=>e;class d extends s.oi{render(){return this.aliases?(0,s.dy)(n||(n=l`
      <ha-multi-textfield
        .hass=${0}
        .value=${0}
        .disabled=${0}
...
`),e.icon,e.icon);class x extends t.oi{render(){return(0,t.dy)(h||(h=f`
  ...
  `)),(0,s.__decorate)([(0,o.Cb)({attribute:!1})],x.prototype,"hass",void 0),(0,s.__decorate)([(0,o.Cb)()],x.prototype,"value",void 0),(0,s.__decorate)([(0,o.Cb)()],x.prototype,"label",void 0),(0,s.__decorate)([(0,o.Cb)()],x.prototype,"helper",void 0),(0,s.__decorate)([(0,o.Cb)()],x.prototype,"placeholder",void 0),(0,s.__decorate)([(0,o.Cb)({attribute:"error-message"})],x.prototype,"errorMessage",void 0),(0,s.__decorate)([(0,o.Cb)({type:Boolean})],x.prototype,"disabled",void 0),(0,s.__decorate)([(0,o.Cb)({type:Boolean})],x.prototype,"required",void 0),(0,s.__decorate)([(0,o.Cb)({type:Boolean})],x.prototype,"invalid",void 0),x=(0,s.__decorate)([(0,o.Mo)("ha-icon-picker")],x),i()}catch(p){i(p)}}))},21520:function(e,r,a){a.a(e,(async function(e,i){try{a.r(r);a(26847),a(81738),a(94814),a(6989),a(1455),a(67886),a(65451),a(46015),a(38334),a(94880),a(75643),a(29761),a(20655),a(27530);var s=a(73742),t=(a(98334),a(59048)),o=a(7616),n=a(88245),l=a(28105),d=a(29740),c=(a(2414),a(91572),a(22543),a(94262),a(99298)),m=a(49590),p=a(73186),h=(a(14891),a(40830),a(38573),a(99495)),g=a(77204),_=a(93700),u=a(57108),f=e([m,p,h]);[m,p,h]=f.then?(await f)():f;let y,v,b,$,w,x,k,C,A,z=e=>e;const S="M20 2H4C2.9 2 2 2.9 2 4V20C2 21.11 2.9 22 4 22H20C21.11 22 22 21.11 22 20V4C22 2.9 21.11 2 20 2M4 6L6 4H10.9L4 10.9V6M4 13.7L13.7 4H18.6L4 18.6V13.7M20 18L18 20H13.1L20 13.1V18M20 10.3L10.3 20H5.4L20 5.4V10.3Z";class X extends t.oi{showDialog(e){var r,a,i,s;this._params=e,this._error=void 0,this._name=this._params.entry?this._params.entry.name:this._params.suggestedName||"",this._aliases=(null===(r=this._params.entry)||void 0===r?void 0:r.aliases)||[],this._icon=(null===(a=this._params.entry)||void 0===a?void 0:a.icon)||null,this._level=null!==(i=null===(s=this._params.entry)||void 0===s?void 0:s.level)&&void 0!==i?i:null,this._addedAreas.clear(),this._removedAreas.clear()}closeDialog(){this._error="",this._params=void 0,this._addedAreas.clear(),this._removedAreas.clear(),(0,d.B)(this,"dialog-closed",{dialog:this.localName})}render(){var e;const r=this._floorAreas(null===(e=this._params)||void 0===e?void 0:e.entry,this.hass.areas,this._addedAreas,this._removedAreas);if(!this._params)return t.Ld;const a=this._params.entry,i=!this._isNameValid();return(0,t.dy)(y||(y=z`
      <ha-dialog
        open
        @closed=${0}
        .heading=${0}
    ...
    `),this.closeDialog,(0,c.i)(this.hass,a?this.hass.localize("ui.panel.config.floors.editor.update_floor"):this.hass.localize("ui.panel.config.floors.editor.create_floor")),this._error?(0,t.dy)(v||(v=z`<ha-alert alert-type="error">${0}</ha-alert>`),this._error):"",a?(0,t.dy)(b||(b=z`
                  <ha-settings-row>
                    <span slot="heading">
                      ${0}
                    </span>
                ...
                `),this.hass.localize("ui.panel.config.floors.editor.floor_id"),a.floor_id):t.Ld,this._name,this._nameChanged,this.hass.localize("ui.panel.config.floors.editor.name"),this.hass.localize("ui.panel.config.floors.editor.name_required"),this._level,this._levelChanged,this.hass.localize("ui.panel.config.floors.editor.level"),this.hass,this._icon,this._iconChanged,this.hass.localize("ui.panel.config.areas.editor.icon"),this._icon?t.Ld:(0,t.dy)($||($=z`
                    <ha-floor-icon
                      slot="fallback"
                      .floor=${0}
                    ></ha-floor-icon>
                  `),{level:this._level}),this.hass.localize("ui.panel.config.floors.editor.areas_section"),this.hass.localize("ui.panel.config.floors.editor.areas_description"),r.length?(0,t.dy)(w||(w=z`<ha-chip-set>
                  ${0}
                </ha-chip-set>`),(0,n.r)(r,(e=>e.area_id),(e=>(0,t.dy)(x||(x=z`<ha-input-chip
                        .area=${0}
                        @click=${0}
                        @remove=${0}
                        .label=${0}
                      >
                        ${0}
                      </ha-input-chip>`),e,this._openArea,this._removeArea,null==e?void 0:e.name,e.icon?(0,t.dy)(k||(k=z`<ha-icon
                              slot="icon"
                              .icon=${0}
                            ></ha-icon>`),e.icon):(0,t.dy)(C||(C=z`<ha-svg-icon
                              slot="icon"
                              .path=${0}
                            ></ha-svg-icon>`),S))))):t.Ld,this.hass,this._addArea,r.map((e=>e.area_id)),this.hass.localize("ui.panel.config.floors.editor.add_area"),this.hass.localize("ui.panel.config.floors.editor.aliases_section"),this.hass.localize("ui.panel.config.floors.editor.aliases_description"),this.hass,this._aliases,this._aliasesChanged,this.closeDialog,this.hass.localize("ui.common.cancel"),this._updateEntry,i||this._submitting,a?this.hass.localize("ui.common.save"):this.hass.localize("ui.common.create"))}_openArea(e){const r=e.target.area;(0,_.E)(this,{entry:r,updateEntry:e=>(0,u.IO)(this.hass,r.area_id,e)})}_removeArea(e){const r=e.target.area.area_id;if(this._addedAreas.has(r))return this._addedAreas.delete(r),void(this._addedAreas=new Set(this._addedAreas));this._removedAreas.add(r),this._removedAreas=new Set(this._removedAreas)}_addArea(e){const r=e.detail.value;if(r){if(e.target.value="",this._removedAreas.has(r))return this._removedAreas.delete(r),void(this._removedAreas=new Set(this._removedAreas));this._addedAreas.add(r),this._addedAreas=new Set(this._addedAreas)}}_isNameValid(){return""!==this._name.trim()}_nameChanged(e){this._error=void 0,this._name=e.target.value}_levelChanged(e){this._error=void 0,this._level=""===e.target.value?null:Number(e.target.value)}_iconChanged(e){this._error=void 0,this._icon=e.detail.value}async _updateEntry(){this._submitting=!0;const e=!this._params.entry;try{const r={name:this._name.trim(),icon:this._icon||(e?void 0:null),level:this._level,aliases:this._aliases};e?await this._params.createEntry(r,this._addedAreas):await this._params.updateEntry(r,this._addedAreas,this._removedAreas),this.closeDialog()}catch(r){this._error=r.message||this.hass.localize("ui.panel.config.floors.editor.unknown_error")}finally{this._submitting=!1}}_aliasesChanged(e){this._aliases=e.detail.value}static get styles(){return[g.Qx,g.yu,(0,t.iv)(A||(A=z`
        ha-textfield {
          display: block;
          margin-bottom: 16px;
        }
