"use strict";(self.webpackChunkknx_frontend=self.webpackChunkknx_frontend||[]).push([["7665"],{4910:function(e,t,i){i.a(e,(async function(e,t){try{i(39710),i(26847),i(81738),i(94814),i(6989),i(1455),i(56389),i(27530);var s=i(73742),r=i(59048),a=i(7616),o=i(29740),d=i(66299),l=i(99495),c=e([l]);l=(c.then?(await c)():c)[0];let n,h,u,v=e=>e;class p extends((0,d.f)(r.oi)){render(){if(!this.hass)return r.Ld;const e=this._currentAreas;return(0,r.dy)(n||(n=v`
      ${0}
      <div>
        <ha-area-picker
          .noAdd=${0}
