export const __webpack_ids__=["9902"];export const __webpack_modules__={76609:function(t,e,i){i.r(e),i.d(e,{HaMediaSelector:()=>u});var a=i(73742),o=i(59048),s=i(7616),d=i(31733),l=i(29740),n=i(75012),r=i(39929),c=i(41787),_=i(37198),m=(i(22543),i(91337),i(91268));const h=[{name:"media_content_id",required:!1,selector:{text:{}}},{name:"media_content_type",required:!1,selector:{text:{}}}];class u extends o.oi{willUpdate(t){if(t.has("value")){const e=this.value?.metadata?.thumbnail,i=t.get("value")?.metadata?.thumbnail;if(e===i)return;e&&e.startsWith("/")?(this._thumbnailUrl=void 0,(0,r.iI)(this.hass,e).then((t=>{this._thumbnailUrl=t.path}))):e&&e.startsWith("https://brands.home-assistant.io")?this._thumbnailUrl=(0,_.X1)({domain:(0,_.u4)(e),type:"icon",useFallback:!0,darkOptimized:this.hass.themes?.darkMode}):this._thumbnailUrl=e}}render(){const t=this.value?.entity_id?this.hass.states[this.value.entity_id]:void 0,e=!this.value?.entity_id||t&&(0,n.e)(t,c.yZ.BROWSE_MEDIA);return o.dy`<ha-entity-picker
        .hass=${this.hass}
      ...
      ${e?o.dy`<ha-card
          ...
          >
            ...
            ></ha-form>`}`}_entityChanged(t){t.stopPropagation(),(0,l.B)(this,"value-changed",{value:{entity_id:t.detail.value,media_content_id:"",media_content_type:""}})}_pickMedia(){(0,m.B)(this,{action:"pick",entityId:this.value.entity_id,navigateIds:this.value.metadata?.navigateIds,mediaPickedCallback:t=>{(0,l.B)(this,"value-changed",{value:{...this.value,media_content_id:t.item.media_content_id,media_content_type:t.item.media_content_type,metadata:{title:t.item.title,thumbnail:t.item.thumbnail,media_class:t.item.media_class,children_media_class:t.item.children_media_class,navigateIds:t.navigateIds?.map((t=>({media_content_type:t.media_content_type,media_content_id:t.media_content_id})))}}})}})}constructor(...t){super(...t),this.disabled=!1,this.required=!0,this._computeLabelCallback=t=>this.hass.localize(`ui.components.selectors.media.${t.name}`)}}u.styles=o.iv`
    ha-entity-picker {
      display: block;
      margin-bottom: 16px;
    }
