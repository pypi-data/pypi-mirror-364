...
object 3 class array type double rank 0 items {int(xs*ys*zs)} follows\n""")
    ...
    def select_grid(self,input_string:str='guv',coord_array=None):
      ...
      if 'log' in parser:
          conv_flag = True
      if 'gaussian' or 'gauss' or 'ld' in parser:
          gauss_flag = True
