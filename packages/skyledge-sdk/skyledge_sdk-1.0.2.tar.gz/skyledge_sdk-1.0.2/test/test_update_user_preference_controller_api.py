...
class TestUpdateUserPreferenceControllerApi(unittest.TestCase):
    """UpdateUserPreferenceControllerApi unit test stubs"""

    def setUp(self) -> None:
        self.api = UpdateUserPreferenceControllerApi()
