...
class TestListControlRoomEventChangesControllerApi(unittest.TestCase):
    """ListControlRoomEventChangesControllerApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ListControlRoomEventChangesControllerApi()
