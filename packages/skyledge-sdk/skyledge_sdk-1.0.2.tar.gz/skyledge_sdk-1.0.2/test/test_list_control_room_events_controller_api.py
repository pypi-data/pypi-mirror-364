...
class TestListControlRoomEventsControllerApi(unittest.TestCase):
    """ListControlRoomEventsControllerApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ListControlRoomEventsControllerApi()
