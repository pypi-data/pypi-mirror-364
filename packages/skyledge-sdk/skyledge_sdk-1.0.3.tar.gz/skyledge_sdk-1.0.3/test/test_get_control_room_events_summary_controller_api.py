...
class TestGetControlRoomEventsSummaryControllerApi(unittest.TestCase):
    """GetControlRoomEventsSummaryControllerApi unit test stubs"""

    def setUp(self) -> None:
        self.api = GetControlRoomEventsSummaryControllerApi()
