...
class TestAuthorizePaymentMethodControllerApi(unittest.TestCase):
    """AuthorizePaymentMethodControllerApi unit test stubs"""

    def setUp(self) -> None:
        self.api = AuthorizePaymentMethodControllerApi()
