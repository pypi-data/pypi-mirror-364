...
class Cycles(BaseModel):
    ...
    cycles: Optional[CyclesCycles] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of cycles
        if self.cycles:
            _dict['cycles'] = self.cycles.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cycles": CyclesCycles.from_dict(obj["cycles"]) if obj.get("cycles") is not None else None,
            "_links": dict(
