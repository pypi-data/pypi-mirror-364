...
from .simulation import moving_horizon_optimization
    ...
    def solve(self, data, par=None, ini=None, **kwargs):
        ...
        try:
            ...
            if self.optimizer_termination_condition != TerminationCondition.optimal:
                from src.imby.simulations.custom_simulations.models.power_grid import ImbalanceMarketModel
