...
class PreParation:
    ...
    def __init__(self):
        ...
        if self.emdid:
            ...
            self.update_resolution_bin = self.args.update_resolution_bin
            ...
            self.modelmap, self.onlybar, self.update_resolution_bin, self.threedfscdir, self.mofit_libpath = self.read_json(self.json)
            ...
            if self.args.positions is None:
                ...
                self.update_resolution_bin = self.args.update_resolution_bin if self.args.update_resolution_bin else None
            else:
    ...
    def read_json(self, injson):
        ...
        if injson:
            ...
            if 'update_resolution_bin' in argsdata and argsdata['update_resolution_bin'] is not None:
                update_resolution_bin = argsdata['update_resolution_bin']
            else:
            ...
            return (map, workdir, models, cl, evenmap, oddmap, fscfile,
                    ...
                    onlybar,update_resolution_bin, threedfscdir, mofit_libpath)
        else:
    ...
    def read_para():
        ...
        parser.add_argument(
            '-u', '--update_resolution_bin',
            dest='update_resolution_bin',
            type=str,
            default=None,
