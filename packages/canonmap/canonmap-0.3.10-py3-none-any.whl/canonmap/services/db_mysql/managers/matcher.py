...
class SingleEntityMatchResult(BaseModel):
    raw_entity: str
    canonical_entity: str
    score: float

class EntityMatchResponse(BaseModel):
    results: List[SingleEntityMatchResult]

class MatcherManager:
    def __init__(self, connection_manager: ConnectionManager):
        self.connection_manager = connection_manager

    def match(self, request: MatchEntityRequest, weights=None) -> EntityMatchResponse:
        ...
        return EntityMatchResponse(results=[SingleEntityMatchResult(raw_entity=name, canonical_entity=name, score=score) for name, score in ranked[:request.top_n]])
