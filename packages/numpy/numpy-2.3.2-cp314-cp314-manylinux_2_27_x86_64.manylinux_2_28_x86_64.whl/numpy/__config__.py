...
CONFIG = _cleanup(
    {
        ...
        "Build Dependencies": {
            "blas": {
                ...
                "include directory": r"/opt/_internal/cpython-3.14.0rc1/lib/python3.14/site-packages/scipy_openblas64/include",
                "lib directory": r"/opt/_internal/cpython-3.14.0rc1/lib/python3.14/site-packages/scipy_openblas64/lib",
        ...
        "Python Information": {
            "path": r"/tmp/build-env-fair2u7s/bin/python",
            "version": "3.14",
        },
        "SIMD Extensions": {
