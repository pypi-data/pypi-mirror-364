...
class OfflineRTVSolver:
    ...
    def __init__(self,server_url,SHAREABLE_COST_FACTOR=2,RTV_TIMEOUT=3000, LARGEST_TSP = 10, MAX_CARDINALITY = 8, output_folder = None):
    ...
    def solve_rtv(self, payload, interval, step_size, skip_simulation_if_no_new_requests = True, step_size_time = True, serve_asap = False):
