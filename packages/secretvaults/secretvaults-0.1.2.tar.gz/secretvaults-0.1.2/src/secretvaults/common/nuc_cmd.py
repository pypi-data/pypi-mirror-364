...
class NucCmd(Enum):
    ...
    NIL_DB_COLLECTIONS_INDEX_CREATE = "nil.db.collections.index.create"
    NIL_DB_COLLECTIONS_INDEX_DROP = "nil.db.collections.index.drop"
    ...
    NIL_DB_USERS_ROOT = "nil.db.users.root"
