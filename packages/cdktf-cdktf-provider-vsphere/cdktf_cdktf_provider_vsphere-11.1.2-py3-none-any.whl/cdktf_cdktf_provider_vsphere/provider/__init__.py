...
class VsphereProvider(
    ...
    def __init__(
        ...
        *,
        ...
        :param password: The user password for vSphere API operations. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs#password VsphereProvider#password}
        :param user: The user name for vSphere API operations. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs#user VsphereProvider#user}
        :param alias: Alias name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs#alias VsphereProvider#alias}
        :param allow_unverified_ssl: If set, VMware vSphere client will permit unverifiable SSL certificates. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs#allow_unverified_ssl VsphereProvider#allow_unverified_ssl}
        :param api_timeout: API timeout in minutes (Default: 5). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs#api_timeout VsphereProvider#api_timeout}
        :param client_debug: govmomi debug. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs#client_debug VsphereProvider#client_debug}
        :param client_debug_path: govmomi debug path for debug. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs#client_debug_path VsphereProvider#client_debug_path}
        :param client_debug_path_run: govmomi debug path for a single run. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs#client_debug_path_run VsphereProvider#client_debug_path_run}
        :param persist_session: Persist vSphere client sessions to disk. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs#persist_session VsphereProvider#persist_session}
        :param rest_session_path: The directory to save vSphere REST API sessions to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs#rest_session_path VsphereProvider#rest_session_path}
        :param vcenter_server: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs#vcenter_server VsphereProvider#vcenter_server}.
        :param vim_keep_alive: Keep alive interval for the VIM session in minutes. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs#vim_keep_alive VsphereProvider#vim_keep_alive}
        :param vim_session_path: The directory to save vSphere SOAP API sessions to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs#vim_session_path VsphereProvider#vim_session_path}
        :param vsphere_server: The vSphere Server name for vSphere API operations. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs#vsphere_server VsphereProvider#vsphere_server}
        '''
        if __debug__:
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing VsphereProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs#import import section} in the documentation of this resource for the id to use
