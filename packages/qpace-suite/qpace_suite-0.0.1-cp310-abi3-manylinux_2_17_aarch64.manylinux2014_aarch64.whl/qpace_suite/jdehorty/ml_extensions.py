...
`normalizeDeriv(series<float> src, int quadraticMeanLength) -> float`
    """
    return _lib.Incr_fn_normalizeDeriv_21c972(ctx=ctx, ).collect(_31691_src=src, _31692_quadraticMeanLength=quadraticMeanLength)
...
`normalizeDeriv(series<float> src, int quadraticMeanLength) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_normalizeDeriv_21c972(ctx, )
        self.locals = NormalizeDerivLocals(self.inner)

    def next(self, src: float, quadraticMeanLength: int) -> Optional[float]:
        return self.inner.next(_31691_src=src, _31692_quadraticMeanLength=quadraticMeanLength)
...
`normalize(series<float> src, float min, float max) -> float`
    """
    return _lib.Incr_fn_normalize_9250dd(ctx=ctx, ).collect(_31697_src=src, _31698_min=min, _31699_max=max)
...
class NormalizeLocals:
    ...
    def _historicMin(self) -> float:
        return self.__inner._31700__historicMin()
  

    @property
    def _historicMax(self) -> float:
        return self.__inner._31701__historicMax()
...
`normalize(series<float> src, float min, float max) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_normalize_9250dd(ctx, )
        self.locals = NormalizeLocals(self.inner)

    def next(self, src: float, min: float, max: float) -> Optional[float]:
        return self.inner.next(_31697_src=src, _31698_min=min, _31699_max=max)
...
`rescale(series<float> src, float oldMin, float oldMax, float newMin, float newMax) -> float`
    """
    return _lib.Incr_fn_rescale_9e7235(ctx=ctx, ).collect(_31703_src=src, _31704_oldMin=oldMin, _31705_oldMax=oldMax, _31706_newMin=newMin, _31707_newMax=newMax)
...
`rescale(series<float> src, float oldMin, float oldMax, float newMin, float newMax) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_rescale_9e7235(ctx, )
    ...
    def next(self, src: float, oldMin: float, oldMax: float, newMin: float, newMax: float) -> Optional[float]:
        return self.inner.next(_31703_src=src, _31704_oldMin=oldMin, _31705_oldMax=oldMax, _31706_newMin=newMin, _31707_newMax=newMax)
...
`color_green(float prediction) -> color`
    """
    return _lib.Incr_fn_color_green_5a31c4(ctx=ctx, ).collect(_31727_prediction=prediction)
...
`color_red(float prediction) -> color`
    """
    return _lib.Incr_fn_color_red_d52e9c(ctx=ctx, ).collect(_31729_prediction=prediction)
...
`color_red(float prediction) -> color`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_color_red_d52e9c(ctx, )
        self.locals = ColorRedLocals(self.inner)

    def next(self, prediction: float) -> Optional[Tuple[int, int, int, int]]:
        return self.inner.next(_31729_prediction=prediction)
...
`tanh(series<float> src) -> float`
    """
    return _lib.Incr_fn_tanh_5dbc18(ctx=ctx, ).collect(_31731_src=src)
...
`tanh(series<float> src) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_tanh_5dbc18(ctx, )
        self.locals = TanhLocals(self.inner)

    def next(self, src: float) -> Optional[float]:
        return self.inner.next(_31731_src=src)
...
`dualPoleFilter(series<float> src, int lookback) -> float`
    """
    return _lib.Incr_fn_dualPoleFilter_fe7cdc(ctx=ctx, ).collect(_31734_src=src, _31735_lookback=lookback)
...
`dualPoleFilter(series<float> src, int lookback) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_dualPoleFilter_fe7cdc(ctx, )
        self.locals = DualPoleFilterLocals(self.inner)

    def next(self, src: float, lookback: int) -> Optional[float]:
        return self.inner.next(_31734_src=src, _31735_lookback=lookback)
...
`tanhTransform(series<float> src, int smoothingFrequency, int quadraticMeanLength) -> float`
    """
    return _lib.Incr_fn_tanhTransform_0dee33(ctx=ctx, ).collect(_31744_src=src, _31745_smoothingFrequency=smoothingFrequency, _31746_quadraticMeanLength=quadraticMeanLength)
...
`tanhTransform(series<float> src, int smoothingFrequency, int quadraticMeanLength) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_tanhTransform_0dee33(ctx, )
    ...
    def next(self, src: float, smoothingFrequency: int, quadraticMeanLength: int) -> Optional[float]:
        return self.inner.next(_31744_src=src, _31745_smoothingFrequency=smoothingFrequency, _31746_quadraticMeanLength=quadraticMeanLength)
...
`n_rsi(series<float> src, int n1, int n2) -> float`
    """
    return _lib.Incr_fn_n_rsi_e24fcb(ctx=ctx, ).collect(_31749_src=src, _31750_n1=n1, _31751_n2=n2)
...
`n_rsi(series<float> src, int n1, int n2) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_n_rsi_e24fcb(ctx, )
        self.locals = NRsiLocals(self.inner)

    def next(self, src: float, n1: int, n2: int) -> Optional[float]:
        return self.inner.next(_31749_src=src, _31750_n1=n1, _31751_n2=n2)
...
`n_cci(series<float> src, int n1, int n2) -> float`
    """
    return _lib.Incr_fn_n_cci_d0d59f(ctx=ctx, ).collect(_31753_src=src, _31754_n1=n1, _31755_n2=n2)
...
`n_cci(series<float> src, int n1, int n2) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_n_cci_d0d59f(ctx, )
        self.locals = NCciLocals(self.inner)

    def next(self, src: float, n1: int, n2: int) -> Optional[float]:
        return self.inner.next(_31753_src=src, _31754_n1=n1, _31755_n2=n2)
...
`n_wt(series<float> src, int n1 = 10, int n2 = 11) -> float`
    """
    return _lib.Incr_fn_n_wt_7187fa(ctx=ctx, ).collect(_31757_src=src, _31758_n1=n1, _31759_n2=n2)
...
`n_adx(series<float> highSrc, series<float> lowSrc, series<float> closeSrc, int n1) -> float`
    """
    return _lib.Incr_fn_n_adx_5b3fa6(ctx=ctx, ).collect(_31766_highSrc=highSrc, _31767_lowSrc=lowSrc, _31768_closeSrc=closeSrc, _31769_n1=n1)
...
`n_adx(series<float> highSrc, series<float> lowSrc, series<float> closeSrc, int n1) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_n_adx_5b3fa6(ctx, )
        self.locals = NAdxLocals(self.inner)

    def next(self, highSrc: float, lowSrc: float, closeSrc: float, n1: int) -> Optional[float]:
        return self.inner.next(_31766_highSrc=highSrc, _31767_lowSrc=lowSrc, _31768_closeSrc=closeSrc, _31769_n1=n1)
...
`regime_filter(series<float> src = ohlc4, float threshold, bool useRegimeFilter) -> bool`
    """
    return _lib.Incr_fn_regime_filter_51a81c(ctx=ctx, ).collect(_31783_src=src, _31784_threshold=threshold, _31785_useRegimeFilter=useRegimeFilter)
...
`regime_filter(series<float> src = ohlc4, float threshold, bool useRegimeFilter) -> bool`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_regime_filter_51a81c(ctx, )
    ...
    def next(self, src: Optional[float] = None, threshold: Optional[float] = None, useRegimeFilter: Optional[bool] = None) -> Optional[bool]:
        return self.inner.next(_31783_src=src, _31784_threshold=threshold, _31785_useRegimeFilter=useRegimeFilter)
...
`filter_adx(series<float> src = close, int length = 14, int adxThreshold, bool useAdxFilter) -> bool`
    """
    return _lib.Incr_fn_filter_adx_b78c85(ctx=ctx, ).collect(_31795_src=src, _31796_length=length, _31797_adxThreshold=adxThreshold, _31798_useAdxFilter=useAdxFilter)
...
`filter_adx(series<float> src = close, int length = 14, int adxThreshold, bool useAdxFilter) -> bool`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_filter_adx_b78c85(ctx, )
    ...
    def next(self, src: Optional[float] = None, length: Optional[int] = None, adxThreshold: Optional[int] = None, useAdxFilter: Optional[bool] = None) -> Optional[bool]:
        return self.inner.next(_31795_src=src, _31796_length=length, _31797_adxThreshold=adxThreshold, _31798_useAdxFilter=useAdxFilter)
...
`filter_volatility(int minLength = 1, int maxLength = 10, bool useVolatilityFilter) -> bool`
    """
    return _lib.Incr_fn_filter_volatility_fdd0b7(ctx=ctx, ).collect(_31810_minLength=minLength, _31811_maxLength=maxLength, _31812_useVolatilityFilter=useVolatilityFilter)
...
`filter_volatility(int minLength = 1, int maxLength = 10, bool useVolatilityFilter) -> bool`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_filter_volatility_fdd0b7(ctx, )
    ...
    def next(self, minLength: Optional[int] = None, maxLength: Optional[int] = None, useVolatilityFilter: Optional[bool] = None) -> Optional[bool]:
        return self.inner.next(_31810_minLength=minLength, _31811_maxLength=maxLength, _31812_useVolatilityFilter=useVolatilityFilter)
...
`backtest(series<float> high, series<float> low, series<float> open, series<bool> startLongTrade, series<bool> endLongTrade, series<bool> startShortTrade, series<bool> endShortTrade, series<bool> isEarlySignalFlip, int maxBarsBackIndex, int thisBarIndex, series<float> src, bool useWorstCase) -> [float, float, float, float, string, float, float]`
    """
    return _lib.Incr_fn_backtest_5655c5(ctx=ctx, ).collect(_31816_high=high, _31817_low=low, _31818_open=open, _31819_startLongTrade=startLongTrade, _31820_endLongTrade=endLongTrade, _31821_startShortTrade=startShortTrade, _31822_endShortTrade=endShortTrade, _31823_isEarlySignalFlip=isEarlySignalFlip, _31824_maxBarsBackIndex=maxBarsBackIndex, _31825_thisBarIndex=thisBarIndex, _31826_src=src, _31827_useWorstCase=useWorstCase)
...
class BacktestLocals:
    ...
    def start_long_trade(self) -> float:
        return self.__inner._31829_start_long_trade()
  

    @property
    def start_short_trade(self) -> float:
        return self.__inner._31830_start_short_trade()
  

    @property
    def total_short_profit(self) -> float:
        return self.__inner._31831_total_short_profit()
  

    @property
    def total_long_profit(self) -> float:
        return self.__inner._31832_total_long_profit()
  

    @property
    def wins(self) -> int:
        return self.__inner._31833_wins()
  

    @property
    def losses(self) -> int:
        return self.__inner._31834_losses()
  

    @property
    def trade_count(self) -> int:
        return self.__inner._31835_trade_count()
  

    @property
    def early_signal_flip_count(self) -> int:
        return self.__inner._31836_early_signal_flip_count()
  

    @property
    def tookProfit(self) -> bool:
        return self.__inner._31837_tookProfit()
...
`backtest(series<float> high, series<float> low, series<float> open, series<bool> startLongTrade, series<bool> endLongTrade, series<bool> startShortTrade, series<bool> endShortTrade, series<bool> isEarlySignalFlip, int maxBarsBackIndex, int thisBarIndex, series<float> src, bool useWorstCase) -> [float, float, float, float, string, float, float]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_backtest_5655c5(ctx, )
    ...
    def next(self, high: float, low: float, open: float, startLongTrade: bool, endLongTrade: bool, startShortTrade: bool, endShortTrade: bool, isEarlySignalFlip: bool, maxBarsBackIndex: int, thisBarIndex: int, src: float, useWorstCase: bool) -> Optional[Tuple[float, float, float, float, str, float, float]]:
        return self.inner.next(_31816_high=high, _31817_low=low, _31818_open=open, _31819_startLongTrade=startLongTrade, _31820_endLongTrade=endLongTrade, _31821_startShortTrade=startShortTrade, _31822_endShortTrade=endShortTrade, _31823_isEarlySignalFlip=isEarlySignalFlip, _31824_maxBarsBackIndex=maxBarsBackIndex, _31825_thisBarIndex=thisBarIndex, _31826_src=src, _31827_useWorstCase=useWorstCase)
...
`main() -> void`
    """
    return _lib.Incr_fn_main_e375da(ctx=ctx, ).collect()
...
`main() -> void`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_main_e375da(ctx, )
