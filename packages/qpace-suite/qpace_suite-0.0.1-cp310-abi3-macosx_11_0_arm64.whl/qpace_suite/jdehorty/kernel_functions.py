...
`rationalQuadratic(series<float> _src, int _lookback, float _relativeWeight, int startAtBar) -> float`
    """
    return _lib.Incr_fn_rationalQuadratic_fcaa27(ctx=ctx, ).collect(_28724__src=_src, _28725__lookback=_lookback, _28726__relativeWeight=_relativeWeight, _28727_startAtBar=startAtBar)
...
`rationalQuadratic(series<float> _src, int _lookback, float _relativeWeight, int startAtBar) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_rationalQuadratic_fcaa27(ctx, )
    ...
    def next(self, _src: float, _lookback: int, _relativeWeight: float, startAtBar: int) -> Optional[float]:
        return self.inner.next(_28724__src=_src, _28725__lookback=_lookback, _28726__relativeWeight=_relativeWeight, _28727_startAtBar=startAtBar)
...
`gaussian(series<float> _src, int _lookback, int startAtBar) -> float`
    """
    return _lib.Incr_fn_gaussian_b5b90a(ctx=ctx, ).collect(_28736__src=_src, _28737__lookback=_lookback, _28738_startAtBar=startAtBar)
...
`gaussian(series<float> _src, int _lookback, int startAtBar) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_gaussian_b5b90a(ctx, )
        self.locals = GaussianLocals(self.inner)

    def next(self, _src: float, _lookback: int, startAtBar: int) -> Optional[float]:
        return self.inner.next(_28736__src=_src, _28737__lookback=_lookback, _28738_startAtBar=startAtBar)
...
`periodic(series<float> _src, int _lookback, int _period, int startAtBar) -> float`
    """
    return _lib.Incr_fn_periodic_f168bf(ctx=ctx, ).collect(_28747__src=_src, _28748__lookback=_lookback, _28749__period=_period, _28750_startAtBar=startAtBar)
...
`periodic(series<float> _src, int _lookback, int _period, int startAtBar) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_periodic_f168bf(ctx, )
        self.locals = PeriodicLocals(self.inner)

    def next(self, _src: float, _lookback: int, _period: int, startAtBar: int) -> Optional[float]:
        return self.inner.next(_28747__src=_src, _28748__lookback=_lookback, _28749__period=_period, _28750_startAtBar=startAtBar)
...
`locallyPeriodic(series<float> _src, int _lookback, int _period, int startAtBar) -> float`
    """
    return _lib.Incr_fn_locallyPeriodic_a60fcf(ctx=ctx, ).collect(_28759__src=_src, _28760__lookback=_lookback, _28761__period=_period, _28762_startAtBar=startAtBar)
...
`locallyPeriodic(series<float> _src, int _lookback, int _period, int startAtBar) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_locallyPeriodic_a60fcf(ctx, )
        self.locals = LocallyPeriodicLocals(self.inner)

    def next(self, _src: float, _lookback: int, _period: int, startAtBar: int) -> Optional[float]:
        return self.inner.next(_28759__src=_src, _28760__lookback=_lookback, _28761__period=_period, _28762_startAtBar=startAtBar)
...
`main() -> void`
    """
    return _lib.Incr_fn_main_66d271(ctx=ctx, ).collect()
...
`main() -> void`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_main_66d271(ctx, )
