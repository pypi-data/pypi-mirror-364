...
`normalizeDeriv(series<float> src, int quadraticMeanLength) -> float`
    """
    return _lib.Incr_fn_normalizeDeriv_db3ccf(ctx=ctx, ).collect(_28772_src=src, _28773_quadraticMeanLength=quadraticMeanLength)
...
`normalizeDeriv(series<float> src, int quadraticMeanLength) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_normalizeDeriv_db3ccf(ctx, )
        self.locals = NormalizeDerivLocals(self.inner)

    def next(self, src: float, quadraticMeanLength: int) -> Optional[float]:
        return self.inner.next(_28772_src=src, _28773_quadraticMeanLength=quadraticMeanLength)
...
`normalize(series<float> src, float min, float max) -> float`
    """
    return _lib.Incr_fn_normalize_86ad11(ctx=ctx, ).collect(_28778_src=src, _28779_min=min, _28780_max=max)
...
class NormalizeLocals:
    ...
    def _historicMin(self) -> float:
        return self.__inner._28781__historicMin()
  

    @property
    def _historicMax(self) -> float:
        return self.__inner._28782__historicMax()
...
`normalize(series<float> src, float min, float max) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_normalize_86ad11(ctx, )
        self.locals = NormalizeLocals(self.inner)

    def next(self, src: float, min: float, max: float) -> Optional[float]:
        return self.inner.next(_28778_src=src, _28779_min=min, _28780_max=max)
...
`rescale(series<float> src, float oldMin, float oldMax, float newMin, float newMax) -> float`
    """
    return _lib.Incr_fn_rescale_534cac(ctx=ctx, ).collect(_28784_src=src, _28785_oldMin=oldMin, _28786_oldMax=oldMax, _28787_newMin=newMin, _28788_newMax=newMax)
...
`rescale(series<float> src, float oldMin, float oldMax, float newMin, float newMax) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_rescale_534cac(ctx, )
    ...
    def next(self, src: float, oldMin: float, oldMax: float, newMin: float, newMax: float) -> Optional[float]:
        return self.inner.next(_28784_src=src, _28785_oldMin=oldMin, _28786_oldMax=oldMax, _28787_newMin=newMin, _28788_newMax=newMax)
...
`color_green(float prediction) -> color`
    """
    return _lib.Incr_fn_color_green_d2615e(ctx=ctx, ).collect(_28808_prediction=prediction)
...
`color_red(float prediction) -> color`
    """
    return _lib.Incr_fn_color_red_e7b159(ctx=ctx, ).collect(_28810_prediction=prediction)
...
`color_red(float prediction) -> color`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_color_red_e7b159(ctx, )
        self.locals = ColorRedLocals(self.inner)

    def next(self, prediction: float) -> Optional[Tuple[int, int, int, int]]:
        return self.inner.next(_28810_prediction=prediction)
...
`tanh(series<float> src) -> float`
    """
    return _lib.Incr_fn_tanh_e29083(ctx=ctx, ).collect(_28812_src=src)
...
`tanh(series<float> src) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_tanh_e29083(ctx, )
        self.locals = TanhLocals(self.inner)

    def next(self, src: float) -> Optional[float]:
        return self.inner.next(_28812_src=src)
...
`dualPoleFilter(series<float> src, int lookback) -> float`
    """
    return _lib.Incr_fn_dualPoleFilter_d2f30e(ctx=ctx, ).collect(_28815_src=src, _28816_lookback=lookback)
...
`dualPoleFilter(series<float> src, int lookback) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_dualPoleFilter_d2f30e(ctx, )
        self.locals = DualPoleFilterLocals(self.inner)

    def next(self, src: float, lookback: int) -> Optional[float]:
        return self.inner.next(_28815_src=src, _28816_lookback=lookback)
...
`tanhTransform(series<float> src, int smoothingFrequency, int quadraticMeanLength) -> float`
    """
    return _lib.Incr_fn_tanhTransform_b314a4(ctx=ctx, ).collect(_28825_src=src, _28826_smoothingFrequency=smoothingFrequency, _28827_quadraticMeanLength=quadraticMeanLength)
...
`tanhTransform(series<float> src, int smoothingFrequency, int quadraticMeanLength) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_tanhTransform_b314a4(ctx, )
    ...
    def next(self, src: float, smoothingFrequency: int, quadraticMeanLength: int) -> Optional[float]:
        return self.inner.next(_28825_src=src, _28826_smoothingFrequency=smoothingFrequency, _28827_quadraticMeanLength=quadraticMeanLength)
...
`n_rsi(series<float> src, int n1, int n2) -> float`
    """
    return _lib.Incr_fn_n_rsi_c4720b(ctx=ctx, ).collect(_28830_src=src, _28831_n1=n1, _28832_n2=n2)
...
`n_rsi(series<float> src, int n1, int n2) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_n_rsi_c4720b(ctx, )
        self.locals = NRsiLocals(self.inner)

    def next(self, src: float, n1: int, n2: int) -> Optional[float]:
        return self.inner.next(_28830_src=src, _28831_n1=n1, _28832_n2=n2)
...
`n_cci(series<float> src, int n1, int n2) -> float`
    """
    return _lib.Incr_fn_n_cci_c5bd75(ctx=ctx, ).collect(_28834_src=src, _28835_n1=n1, _28836_n2=n2)
...
`n_cci(series<float> src, int n1, int n2) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_n_cci_c5bd75(ctx, )
        self.locals = NCciLocals(self.inner)

    def next(self, src: float, n1: int, n2: int) -> Optional[float]:
        return self.inner.next(_28834_src=src, _28835_n1=n1, _28836_n2=n2)
...
`n_wt(series<float> src, int n1 = 10, int n2 = 11) -> float`
    """
    return _lib.Incr_fn_n_wt_68ff50(ctx=ctx, ).collect(_28838_src=src, _28839_n1=n1, _28840_n2=n2)
...
`n_adx(series<float> highSrc, series<float> lowSrc, series<float> closeSrc, int n1) -> float`
    """
    return _lib.Incr_fn_n_adx_9a3674(ctx=ctx, ).collect(_28847_highSrc=highSrc, _28848_lowSrc=lowSrc, _28849_closeSrc=closeSrc, _28850_n1=n1)
...
`n_adx(series<float> highSrc, series<float> lowSrc, series<float> closeSrc, int n1) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_n_adx_9a3674(ctx, )
        self.locals = NAdxLocals(self.inner)

    def next(self, highSrc: float, lowSrc: float, closeSrc: float, n1: int) -> Optional[float]:
        return self.inner.next(_28847_highSrc=highSrc, _28848_lowSrc=lowSrc, _28849_closeSrc=closeSrc, _28850_n1=n1)
...
`regime_filter(series<float> src = ohlc4, float threshold, bool useRegimeFilter) -> bool`
    """
    return _lib.Incr_fn_regime_filter_95549c(ctx=ctx, ).collect(_28864_src=src, _28865_threshold=threshold, _28866_useRegimeFilter=useRegimeFilter)
...
`regime_filter(series<float> src = ohlc4, float threshold, bool useRegimeFilter) -> bool`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_regime_filter_95549c(ctx, )
    ...
    def next(self, src: Optional[float] = None, threshold: Optional[float] = None, useRegimeFilter: Optional[bool] = None) -> Optional[bool]:
        return self.inner.next(_28864_src=src, _28865_threshold=threshold, _28866_useRegimeFilter=useRegimeFilter)
...
`filter_adx(series<float> src = close, int length = 14, int adxThreshold, bool useAdxFilter) -> bool`
    """
    return _lib.Incr_fn_filter_adx_145ab2(ctx=ctx, ).collect(_28876_src=src, _28877_length=length, _28878_adxThreshold=adxThreshold, _28879_useAdxFilter=useAdxFilter)
...
`filter_adx(series<float> src = close, int length = 14, int adxThreshold, bool useAdxFilter) -> bool`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_filter_adx_145ab2(ctx, )
    ...
    def next(self, src: Optional[float] = None, length: Optional[int] = None, adxThreshold: Optional[int] = None, useAdxFilter: Optional[bool] = None) -> Optional[bool]:
        return self.inner.next(_28876_src=src, _28877_length=length, _28878_adxThreshold=adxThreshold, _28879_useAdxFilter=useAdxFilter)
...
`filter_volatility(int minLength = 1, int maxLength = 10, bool useVolatilityFilter) -> bool`
    """
    return _lib.Incr_fn_filter_volatility_153329(ctx=ctx, ).collect(_28891_minLength=minLength, _28892_maxLength=maxLength, _28893_useVolatilityFilter=useVolatilityFilter)
...
`filter_volatility(int minLength = 1, int maxLength = 10, bool useVolatilityFilter) -> bool`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_filter_volatility_153329(ctx, )
    ...
    def next(self, minLength: Optional[int] = None, maxLength: Optional[int] = None, useVolatilityFilter: Optional[bool] = None) -> Optional[bool]:
        return self.inner.next(_28891_minLength=minLength, _28892_maxLength=maxLength, _28893_useVolatilityFilter=useVolatilityFilter)
...
`backtest(series<float> high, series<float> low, series<float> open, series<bool> startLongTrade, series<bool> endLongTrade, series<bool> startShortTrade, series<bool> endShortTrade, series<bool> isEarlySignalFlip, int maxBarsBackIndex, int thisBarIndex, series<float> src, bool useWorstCase) -> [float, float, float, float, string, float, float]`
    """
    return _lib.Incr_fn_backtest_b64dc3(ctx=ctx, ).collect(_28897_high=high, _28898_low=low, _28899_open=open, _28900_startLongTrade=startLongTrade, _28901_endLongTrade=endLongTrade, _28902_startShortTrade=startShortTrade, _28903_endShortTrade=endShortTrade, _28904_isEarlySignalFlip=isEarlySignalFlip, _28905_maxBarsBackIndex=maxBarsBackIndex, _28906_thisBarIndex=thisBarIndex, _28907_src=src, _28908_useWorstCase=useWorstCase)
...
class BacktestLocals:
    ...
    def start_long_trade(self) -> float:
        return self.__inner._28910_start_long_trade()
  

    @property
    def start_short_trade(self) -> float:
        return self.__inner._28911_start_short_trade()
  

    @property
    def total_short_profit(self) -> float:
        return self.__inner._28912_total_short_profit()
  

    @property
    def total_long_profit(self) -> float:
        return self.__inner._28913_total_long_profit()
  

    @property
    def wins(self) -> int:
        return self.__inner._28914_wins()
  

    @property
    def losses(self) -> int:
        return self.__inner._28915_losses()
  

    @property
    def trade_count(self) -> int:
        return self.__inner._28916_trade_count()
  

    @property
    def early_signal_flip_count(self) -> int:
        return self.__inner._28917_early_signal_flip_count()
  

    @property
    def tookProfit(self) -> bool:
        return self.__inner._28918_tookProfit()
...
`backtest(series<float> high, series<float> low, series<float> open, series<bool> startLongTrade, series<bool> endLongTrade, series<bool> startShortTrade, series<bool> endShortTrade, series<bool> isEarlySignalFlip, int maxBarsBackIndex, int thisBarIndex, series<float> src, bool useWorstCase) -> [float, float, float, float, string, float, float]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_backtest_b64dc3(ctx, )
    ...
    def next(self, high: float, low: float, open: float, startLongTrade: bool, endLongTrade: bool, startShortTrade: bool, endShortTrade: bool, isEarlySignalFlip: bool, maxBarsBackIndex: int, thisBarIndex: int, src: float, useWorstCase: bool) -> Optional[Tuple[float, float, float, float, str, float, float]]:
        return self.inner.next(_28897_high=high, _28898_low=low, _28899_open=open, _28900_startLongTrade=startLongTrade, _28901_endLongTrade=endLongTrade, _28902_startShortTrade=startShortTrade, _28903_endShortTrade=endShortTrade, _28904_isEarlySignalFlip=isEarlySignalFlip, _28905_maxBarsBackIndex=maxBarsBackIndex, _28906_thisBarIndex=thisBarIndex, _28907_src=src, _28908_useWorstCase=useWorstCase)
...
`main() -> void`
    """
    return _lib.Incr_fn_main_5c3cf1(ctx=ctx, ).collect()
...
`main() -> void`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_main_5c3cf1(ctx, )
