...
def test_batch_alist_hx(batch_size=1000, target_error=100):
        ...
        for err, llr, _ in error_dataloader:
            ...
            for i in range(num_decoders):
                batch_total_time, batch_average_time_sample, batch_average_iter, batch_average_time_sample_iter, data_qubit_acc, \
                    data_frame_error_rate, synd_frame_error_rate, correction_acc, batch_logical_error_rate, \
                ...
                correction_acc_all[i] += correction_acc
    ...
    for i in range(num_decoders):
        _, _, _, _, _, _, _, _, _, _ = compute_avg_metrics(target_error, i, num_batches, total_time_all,
