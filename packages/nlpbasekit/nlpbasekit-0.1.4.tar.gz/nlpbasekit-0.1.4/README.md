...
- [Features](#features)
- [LogisticClassifier API](#logisticclassifier-api)
- [SupportVectorClassifier API](#supportvectorclassifier-api)
- [DTC API](#dtc-api)
- [NeigbhorClassifier API](#neigbhorclassifier-api)
- [SGD API](#sgd-api)
- [GBC API](#gbc-api)
- [GaussianProcess API](#gaussianprocess-api)
- [NMeans API](#nmeans-api) -->
