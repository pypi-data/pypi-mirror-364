...
ISSHARED_ANY_OF_SCHEMAS = ["bool", "object"]
...
class Isshared(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = Isshared.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in Isshared with anyOf schemas: bool, object. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Isshared with anyOf schemas: bool, object. Details: " + ", ".join(error_messages))
        else:
            return instance
