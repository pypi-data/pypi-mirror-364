...
class SuitBase(object):
    ...
    @property
    def name(self) -> str:
        """Returns the single character name of the suit as a string
            (e.g. 'S' or 'D').
        """
        return self._name
    ...
    def full_name(self) -> str:
        """Returns the full name of the suit as a string
            (e.g. 'spades' or 'diamonds').
        """
        return self._full_name

    @property
    def rank(self) -> int:
        """Returns the rank of the suit as an integer
            (e.g. 0 for 'S' or 2 for 'D').
        """
        return self._rank
