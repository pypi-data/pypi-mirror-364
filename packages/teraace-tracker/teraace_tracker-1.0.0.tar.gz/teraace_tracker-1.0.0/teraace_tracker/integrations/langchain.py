...
class LangChainTracker(BaseCallbackHandler):
    """LangChain callback handler for tracking agent events."""
    ...
    def __init__(
        ...
        logger.info(f"LangChain tracker initialized for agent '{agent_name}' session '{self.session_id}'")
