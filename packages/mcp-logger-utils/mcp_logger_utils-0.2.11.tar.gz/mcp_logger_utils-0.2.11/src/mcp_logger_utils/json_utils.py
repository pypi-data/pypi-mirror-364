...
# Create a simple logger without tool_name binding
default_logger = loguru_logger.bind()
...
def repair_and_parse_json(
    ...
    """
    # Use provided logger or create a minimal one without tool_name binding
    if logger_instance:
        log = logger_instance
    else:
        # Create a default logger without tool_name binding to avoid KeyError
        log = default_logger
