...
class ContextBuilder:
    ...
    @staticmethod
    def relevant_contexts(agent: ChattyAIAgent, chat:Chat) -> str:
        context = ""
    ...
    @staticmethod
    def relevant_faqs(agent: ChattyAIAgent, chat:Chat) -> str:
        context = f"\n\nHere are the FAQ:"
    ...
    @staticmethod
    def relevant_examples(agent: ChattyAIAgent, chat:Chat) -> str:
