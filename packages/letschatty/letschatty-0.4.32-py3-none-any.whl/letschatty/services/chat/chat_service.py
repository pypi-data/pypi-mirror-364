...
class ChatService:
    ...
    @staticmethod
    def add_workflow_link(chat : Chat, link : LinkItem, flow:FlowPreview, execution_context: ExecutionContext, description: str, last_incoming_message_id: Optional[str] = None, next_call: Optional[datetime] = None, is_smart_follow_up: bool = False) -> FlowStateAssignedToChat:
        """
        Add a tag to the chat.
        """
        ...
        state = FlowStateAssignedToChat.from_link(link, execution_context, description, last_incoming_message_id, next_call, is_smart_follow_up)
