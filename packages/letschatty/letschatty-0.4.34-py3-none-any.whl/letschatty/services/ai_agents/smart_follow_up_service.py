...
class SmartFollowUpService:
    ...
    @staticmethod
    def update_strategy(workflow_link_state: SmartFollowUpState, strategy: FollowUpStrategy):
        """Update the strategy with the new consecutive count"""
        workflow_link_state.follow_up_strategy_id = strategy.id
