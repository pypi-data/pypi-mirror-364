...
class BlueprintObject(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["applications", "authors", "created", "description", "enabled", "icon", "id", "license", "name", "nodeTypes", "publicationReferences", "resourceLinks", "summary", "typeId", "useCaseIds", "useCaseNames", "variantTags", "version"]
