...
class AddColumnReference(BaseModel):
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["cardinality", "cellJsonSchema", "enabledViewers", "inlineViewer", "isRequired", "jsonField", "name", "referenceDatabaseRowId", "systemType", "type"]
