...
class ApplicationResponse(BaseModel):
    ...
    version: StrictStr
    __properties: ClassVar[List[str]] = ["authors", "created", "description", "icon", "id", "license", "name", "publicationReferences", "requirements", "resourceLinks", "summary", "typeId", "useCaseIds", "useCaseNames", "variantTags", "version"]
