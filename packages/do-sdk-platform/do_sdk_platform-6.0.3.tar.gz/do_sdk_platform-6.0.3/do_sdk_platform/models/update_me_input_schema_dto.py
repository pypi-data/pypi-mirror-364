...
class UpdateMeInputSchemaDto(BaseModel):
    ...
    title: StrictStr
    __properties: ClassVar[List[str]] = ["appNotificationsDisabled", "company", "emailNotificationsDisabled", "expertise", "firstName", "industries", "lastName", "newPassword", "notificationsDisabled", "title"]
