...
class GetSubscriptionsResultsSchemaDtoSubscriptionsInnerPlansInnerMeta(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["academic", "can_buy_credits", "coming_soon", "demo_url", "doc_url", "gateway", "includes", "index", "is_beta", "is_coming_soon", "max_days", "max_invites", "max_subscriptions", "needs_credit_card", "renewable"]
