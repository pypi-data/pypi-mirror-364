...
class NotebookObject(BaseModel):
    ...
    version: StrictStr
    __properties: ClassVar[List[str]] = ["authors", "created", "description", "id", "license", "name", "publicationReferences", "resourceLinks", "summary", "typeId", "useCaseIds", "useCaseNames", "variantTags", "version"]
