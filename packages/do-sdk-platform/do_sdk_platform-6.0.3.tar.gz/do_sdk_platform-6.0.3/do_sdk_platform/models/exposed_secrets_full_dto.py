...
class ExposedSecretsFullDto(BaseModel):
    ...
    default_region: StrictStr = Field(alias="defaultRegion")
    filename: StrictStr
    key: StrictStr
    ...
    username: StrictStr
    value: StrictStr
    __properties: ClassVar[List[str]] = ["accessKey", "defaultRegion", "filename", "key", "keyGroup", "name", "password", "profileName", "repository", "secretKey", "type", "username", "value"]
