...
class ApiCheck200Response(BaseModel):
    """
    ApiCheck200Response
    """ # noqa: E501
    details: Optional[Dict[str, ApiCheck200ResponseDetailsValue]] = None
    error: Optional[Dict[str, ApiCheck200ResponseErrorValue]] = None
    info: Optional[Dict[str, ApiCheck200ResponseErrorValue]] = None
    status: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["details", "error", "info", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiCheck200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiCheck200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "details": dict(
                (_k, ApiCheck200ResponseDetailsValue.from_dict(_v))
                for _k, _v in obj["details"].items()
            )
            if obj.get("details") is not None
            else None,
            "error": dict(
                (_k, ApiCheck200ResponseErrorValue.from_dict(_v))
