...
class ToolDefinitionSchemaDto(BaseModel):
    ...
    inputs: FunctionDefinitionSchemaDtoInputSchema
    key: StrictStr
    outputs: Optional[Any]
    tool_manifest_version: StrictStr = Field(alias="toolManifestVersion")
    version: StrictStr
    __properties: ClassVar[List[str]] = ["billingParser", "changes", "description", "example", "examples", "executors", "inputs", "key", "outputs", "toolManifestVersion", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inputs": FunctionDefinitionSchemaDtoInputSchema.from_dict(obj["inputs"]) if obj.get("inputs") is not None else None,
            "key": obj.get("key"),
