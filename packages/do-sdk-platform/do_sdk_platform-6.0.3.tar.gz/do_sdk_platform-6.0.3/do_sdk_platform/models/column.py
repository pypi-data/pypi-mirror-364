...
class Column(ColumnTypeBase):
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["type", "expressionCode", "expressionReturnType", "configFile", "configNumeric", "referenceDatabaseRowId", "configSelect", "lookupExternalColumn", "lookupExternalColumnId", "lookupSourceColumnId", "cardinality", "cellJsonSchema", "enabledViewers", "id", "inlineViewer", "isRequired", "jsonField", "name", "parentId", "systemType"]
