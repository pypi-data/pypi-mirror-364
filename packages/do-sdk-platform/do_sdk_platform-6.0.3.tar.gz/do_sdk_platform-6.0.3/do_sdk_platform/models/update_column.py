...
class UpdateColumn(ColumnTypeBase):
    ...
    __properties: ClassVar[List[str]] = ["type", "expressionCode", "expressionReturnType", "configFile", "configNumeric", "referenceDatabaseRowId", "configSelect", "lookupExternalColumn", "lookupExternalColumnId", "lookupSourceColumnId", "cardinality", "cellJsonSchema", "enabledViewers", "inlineViewer", "isRequired", "jsonField", "name", "systemType"]
