...
class Workspace(BaseModel):
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["createdByUserDrn", "creationBlockId", "creationParentId", "dateCreated", "dateUpdated", "editedByUserDrn", "editor", "hid", "id", "name", "parentHid", "parentId", "type"]
