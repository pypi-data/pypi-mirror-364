...
class AddColumnLookup(BaseModel):
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["cardinality", "cellJsonSchema", "enabledViewers", "inlineViewer", "isRequired", "jsonField", "lookupExternalColumnId", "lookupSourceColumnId", "name", "systemType", "type"]
