...
class OperatingSystemObject(BaseModel):
    ...
    version: StrictStr
    __properties: ClassVar[List[str]] = ["authors", "created", "description", "familyId", "icon", "license", "location", "name", "publicationReferences", "requirements", "resourceLinks", "summary", "typeId", "useCaseIds", "useCaseNames", "variantTags", "version"]
