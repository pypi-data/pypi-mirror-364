...
class ComputeBenchDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accessMethods", "accessSettings", "autoStopIdleCPUThreshold", "autoStopIdleDuration", "blueprint", "cloudProvider", "clusterId", "created", "description", "drn", "enableAutoStop", "name", "nextUserActions", "orgHandle", "owner", "requestedResources", "state", "status", "summary", "templateVersion", "updated", "userAccessMethods", "userHandle", "volumeDrns", "wasAutoStopped"]
