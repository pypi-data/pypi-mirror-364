...
class NodeTypeResponse(BaseModel):
    ...
    summary: StrictStr
    __properties: ClassVar[List[str]] = ["applications", "entryPoints", "fixedResources", "homeDataLocation", "id", "imageLocation", "name", "notebooks", "operatingSystem", "requirements", "sharedDriveRequired", "summary"]
