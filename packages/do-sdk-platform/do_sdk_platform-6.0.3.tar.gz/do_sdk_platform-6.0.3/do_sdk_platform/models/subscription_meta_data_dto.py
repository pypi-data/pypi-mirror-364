...
class SubscriptionMetaDataDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["academic", "canBuyCredits", "comingSoon", "includes", "index", "isComingSoon", "maxDays", "maxInvites", "maxSubscriptions", "needsCreditCard", "renewable"]
