...
class AddColumnExpression(BaseModel):
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["cardinality", "cellJsonSchema", "enabledViewers", "expressionCode", "expressionReturnType", "inlineViewer", "isRequired", "jsonField", "name", "systemType", "type"]
