...
class DatabaseRow(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["createdByUserDrn", "creationBlockId", "creationParentId", "dateCreated", "dateUpdated", "editedByUserDrn", "fields", "hid", "id", "isTemplate", "name", "parentHid", "parentId", "type", "validationStatus"]
