...
class NucleusApiListRowBackReferences200ResponseDataRowsInner(Row):
    ...
    __properties: ClassVar[List[str]] = ["cols", "createdByUserDrn", "creationBlockId", "creationParentId", "dateCreated", "dateUpdated", "editedByUserDrn", "editor", "hid", "hidPrefix", "id", "isInlineDatabase", "isLocked", "name", "parentHid", "parentId", "rowJsonSchema", "type", "fields", "isTemplate", "validationStatus", "referencedColumn"]
