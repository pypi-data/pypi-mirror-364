...
#     @validate_call
    def files_get_object_directory(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "FileApiGetObject200ResponseOneOf",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
...
#     @validate_call
    def files_get_object_directory_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FileApiGetObject200ResponseOneOf]:
        """files_get_object_directory
...
#     @validate_call
    def files_put_object(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "FileApiPutObject200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
...
#     @validate_call
    def files_put_object_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FileApiPutObject200Response]:
        """files_put_object
