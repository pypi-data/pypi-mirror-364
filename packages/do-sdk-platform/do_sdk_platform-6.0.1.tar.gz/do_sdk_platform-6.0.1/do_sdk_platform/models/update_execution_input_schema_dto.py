...
class UpdateExecutionInputSchemaDto(BaseModel):
    ...
    started_at: Optional[Any] = Field(default=None, alias="startedAt")
    completed_at: Optional[Any] = Field(default=None, alias="completedAt")
    job_outputs: Optional[Any] = Field(default=None, alias="jobOutputs")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if job_outputs (nullable) is None
        # and model_fields_set contains the field
        if self.job_outputs is None and "job_outputs" in self.model_fields_set:
            _dict['jobOutputs'] = None
