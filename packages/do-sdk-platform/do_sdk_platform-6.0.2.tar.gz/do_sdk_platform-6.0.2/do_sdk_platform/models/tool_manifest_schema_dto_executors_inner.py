...
class ToolManifestSchemaDtoExecutorsInner(BaseModel):
    """
    ...
    environment: List[ToolManifestSchemaDtoExecutorsInnerEnvironmentInner]
    ports: Optional[List[ToolManifestSchemaDtoExecutorsInnerPortsInner]] = None
    resource_requirements: ToolManifestSchemaDtoExecutorsInnerResourceRequirements = Field(alias="resourceRequirements")
    storage_requirements: List[ToolManifestSchemaDtoExecutorsInnerStorageRequirementsInner] = Field(alias="storageRequirements")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ToolManifestSchemaDtoExecutorsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ToolManifestSchemaDtoExecutorsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "environment": [ToolManifestSchemaDtoExecutorsInnerEnvironmentInner.from_dict(_item) for _item in obj["environment"]] if obj.get("environment") is not None else None,
            "ports": [ToolManifestSchemaDtoExecutorsInnerPortsInner.from_dict(_item) for _item in obj["ports"]] if obj.get("ports") is not None else None,
            "resourceRequirements": ToolManifestSchemaDtoExecutorsInnerResourceRequirements.from_dict(obj["resourceRequirements"]) if obj.get("resourceRequirements") is not None else None,
            "storageRequirements": [ToolManifestSchemaDtoExecutorsInnerStorageRequirementsInner.from_dict(_item) for _item in obj["storageRequirements"]] if obj.get("storageRequirements") is not None else None,
