...
class NucleusApiEnsureRowsRequestRowsInnerRow(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["creationParentId", "creationBlockId", "isTemplate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NucleusApiEnsureRowsRequestRowsInnerRow from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NucleusApiEnsureRowsRequestRowsInnerRow from a dict"""
        if obj is None:
            return None
