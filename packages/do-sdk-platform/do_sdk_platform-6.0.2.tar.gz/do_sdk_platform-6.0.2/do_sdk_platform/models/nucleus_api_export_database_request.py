...
class NucleusApiExportDatabaseRequest(BaseModel):
    """
    ...
    format: StrictStr
    __properties: ClassVar[List[str]] = ["databaseId", "filter", "columnSelection", "rowSort", "limit", "offset", "format"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NucleusApiExportDatabaseRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NucleusApiExportDatabaseRequest from a dict"""
        if obj is None:
            return None
