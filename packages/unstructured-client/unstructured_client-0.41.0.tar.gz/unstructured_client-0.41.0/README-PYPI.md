...
* [`ServerError`](https://github.com/Unstructured-IO/unstructured-python-client/blob/master/./src/unstructured_client/models/errors/servererror.py): Server Error. Status code `5XX`. Applicable to 1 of 29 methods.*
