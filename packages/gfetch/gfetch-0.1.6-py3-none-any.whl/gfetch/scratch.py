...
if __name__ == "__main__":
    class DirConfig:
        ...
        """
        BASE_DIR = Path.cwd()
        RAW_EMAIL_DIR = BASE_DIR / 'emails'
        CLEAN_EMAIL_DIR = BASE_DIR / 'emails'
        ATTACHMENTS_DIR = BASE_DIR / 'emails'
    DirConfig.CLEAN_EMAIL_DIR.mkdir(parents=True, exist_ok=True)
    email_path = Path.home() / "gfetch-cli" / "tests" / "raw_emails" / "many_attachments.eml"
    clean_email(email_path, DirConfig, 1)