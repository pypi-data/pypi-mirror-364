...
def __extendCommand(
    ...
    match (controller, service, model):
        case (True, False, False, False): testPaths.append("src/controllers")
        case (False, True, False, False): testPaths.append("src/services")
        case (False, False, True, False): testPaths.append("src/models")
