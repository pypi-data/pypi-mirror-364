...
class UpdateHighAvailability(ResultsToDb):
    """
    Takes "get_high_availability" and maps it to the high_availability table
    """
    ...
    def __init__(self, hostname: str, host_ip: str, results: Result, engine: Engine):
        """
        ha data comes in as a dict, and our base code expects a list of entries.
        """

        super().__init__(hostname, host_ip, [results], engine)
