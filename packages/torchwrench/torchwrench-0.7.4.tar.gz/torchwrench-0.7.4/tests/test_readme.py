...
class TestReadme(TestCase):
    ...
    def test_lengths_to_non_pad_mask_example(self) -> None:
        ...
        assert tw.equal(pad_mask, expected)
    ...
    def test_probs_to_multinames_example(self) -> None:
        probs = tw.as_tensor([[0.9, 0.1], [0.6, 0.9]])
    ...
    def test_insert_at_indices_example(self) -> None:
        ...
        expected = tw.as_tensor([5, 1, 2, 5, 3, 4])

        assert tw.equal(result, expected)
