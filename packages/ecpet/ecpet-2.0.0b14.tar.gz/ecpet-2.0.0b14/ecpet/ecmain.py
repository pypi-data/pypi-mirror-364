...
def INSANE(self, message, *args, **kws):
    self.log(logging.INSANE, message, *args, **kws)
...
def NORMAL(self, message, *args, **kws):
    self.log(logging.NORMAL, message, *args, **kws)
...
def user_interface():
    ...
    logger.debug('selected command: {:s}'.format(options['command']))
