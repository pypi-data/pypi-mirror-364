...
class SkillLink:
    ...
    def __init__(self, autoReload=False, cycleInterval=60, useThreading=False):
        if getattr(self, 'initialized', False):
            return
        self._initComponents(autoReload, cycleInterval, useThreading)
        self.initialized = True

    def _initComponents(self, autoReload, cycleInterval, useThreading):
        self.loader               = Loader()
