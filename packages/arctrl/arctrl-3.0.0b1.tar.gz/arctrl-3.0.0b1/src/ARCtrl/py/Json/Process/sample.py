...
def ROCrate_encoder(oa: Sample) -> IEncodable:
    ...
    def _arrow2666(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2666()), ("@type", list_1_2(singleton(ObjectExpr2670()))), ("additionalType", ObjectExpr2671()), try_include("name", _arrow2673, oa.Name), try_include_list("additionalProperties", _arrow2674, additional_properties), ("@context", context_jsonvalue)]))
