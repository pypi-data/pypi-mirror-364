...
class ArcAssay(ArcTables):
    def __init__(self, identifier: str, title: str | None=None, description: str | None=None, measurement_type: OntologyAnnotation | None=None, technology_type: OntologyAnnotation | None=None, technology_platform: OntologyAnnotation | None=None, tables: Array[ArcTable] | None=None, datamap: DataMap | None=None, performers: Array[Person] | None=None, comments: Array[Comment] | None=None) -> None:
        ...
        def _arrow955(__unit: None=None) -> str:
            identifier_1: str = identifier.strip()
            check_valid_characters(identifier_1)
            return identifier_1

        self.identifier_0040129: str = _arrow955()
            ...
            def predicate(s: ArcStudy) -> bool:
                ...
                class ObjectExpr907:
                    ...
                    def Equals(self) -> Callable[[str, str], bool]:
                        def _arrow906(x: str, y: str) -> bool:
                            return x == y
                ...
                return contains(this.Identifier, source, ObjectExpr907())
    ...
    def init_table(table_name: str, index: int | None=None) -> Callable[[ArcAssay], tuple[ArcAssay, ArcTable]]:
        def _arrow910(assay: ArcAssay) -> tuple[ArcAssay, ArcTable]:
            c: ArcAssay = assay.Copy()
    ...
    def get_table_at(index: int) -> Callable[[ArcAssay], ArcTable]:
        def _arrow912(assay: ArcAssay) -> ArcTable:
    ...
    def get_table(name: str) -> Callable[[ArcAssay], ArcTable]:
        def _arrow913(assay: ArcAssay) -> ArcTable:
            new_assay: ArcAssay = assay.Copy()
    ...
    def get_column_at(table_index: int, column_index: int) -> Callable[[ArcAssay], CompositeColumn]:
        def _arrow930(assay: ArcAssay) -> CompositeColumn:
            new_assay: ArcAssay = assay.Copy()
    ...
    def get_column(table_name: str, column_index: int) -> Callable[[ArcAssay], CompositeColumn]:
        def _arrow931(assay: ArcAssay) -> CompositeColumn:
            new_assay: ArcAssay = assay.Copy()
    ...
    def get_row_at(table_index: int, row_index: int) -> Callable[[ArcAssay], Array[CompositeCell]]:
        def _arrow938(assay: ArcAssay) -> Array[CompositeCell]:
            new_assay: ArcAssay = assay.Copy()
    ...
    def get_row(table_name: str, row_index: int) -> Callable[[ArcAssay], Array[CompositeCell]]:
        def _arrow939(assay: ArcAssay) -> Array[CompositeCell]:
            new_assay: ArcAssay = assay.Copy()
            ...
            if not append_sequences_1:
                ...
                try: 
                    while enumerator.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e, combined, ObjectExpr940()):
                            (combined.append(e))
                ...
                try: 
                    while enumerator_1.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_1, combined, ObjectExpr941()):
                            (combined.append(e_1))
            ...
            if not append_sequences_1:
                ...
                try: 
                    while enumerator_2.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_2, combined_1, ObjectExpr942()):
                ...
                try: 
                    while enumerator_1_1.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_1_1, combined_1, ObjectExpr943()):
            ...
            if not append_sequences_1:
                ...
                try: 
                    while enumerator_3.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_3, combined_2, ObjectExpr944()):
                ...
                try: 
                    while enumerator_1_2.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_1_2, combined_2, ObjectExpr945()):
    ...
    def StructurallyEquals(self, other: ArcAssay) -> bool:
        ...
        def _arrow948(__unit: None=None) -> bool:
            ...
            def _arrow947(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow946(i_1: int) -> bool:
                    return equals(item(i_1, a), item(i_1, b))

                return map_1(_arrow946, range_big_int(0, 1, length(a) - 1))

            return fold(folder, True, to_list(delay(_arrow947))) if (length(a) == length(b)) else False

        def _arrow951(__unit: None=None) -> bool:
            ...
            def _arrow950(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow949(i_2: int) -> bool:
                    return equals(item(i_2, a_1), item(i_2, b_1))

                return map_1(_arrow949, range_big_int(0, 1, length(a_1) - 1))

            return fold(folder_1, True, to_list(delay(_arrow950))) if (length(a_1) == length(b_1)) else False

        def _arrow954(__unit: None=None) -> bool:
...
class ArcStudy(ArcTables):
    def __init__(self, identifier: str, title: str | None=None, description: str | None=None, submission_date: str | None=None, public_release_date: str | None=None, publications: Array[Publication] | None=None, contacts: Array[Person] | None=None, study_design_descriptors: Array[OntologyAnnotation] | None=None, tables: Array[ArcTable] | None=None, datamap: DataMap | None=None, registered_assay_identifiers: Array[str] | None=None, comments: Array[Comment] | None=None) -> None:
        ...
        comments_1: Array[Comment] = default_arg(comments, [])
        def _arrow1030(__unit: None=None) -> str:
            identifier_1: str = identifier.strip()
            check_valid_characters(identifier_1)
            return identifier_1

        self.identifier_0040579: str = _arrow1030()
        self.investigation: ArcInvestigation | None = None
    ...
    def init_registered_assay(assay_identifier: str) -> Callable[[ArcStudy], tuple[ArcStudy, ArcAssay]]:
        def _arrow961(study: ArcStudy) -> tuple[ArcStudy, ArcAssay]:
    ...
    def RegisterAssay(self, assay_identifier: str) -> None:
        ...
        class ObjectExpr963:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow962(x: str, y: str) -> bool:
                    return x == y
        ...
        if contains(assay_identifier, this.RegisteredAssayIdentifiers, ObjectExpr963()):
    ...
    def DeregisterAssay(self, assay_identifier: str) -> None:
        ...
        class ObjectExpr966:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow965(x: str, y: str) -> bool:
                    return x == y
        ...
        ignore(remove_in_place(assay_identifier, this.RegisteredAssayIdentifiers, ObjectExpr966()))
    ...
    def GetRegisteredAssay(self, assay_identifier: str) -> ArcAssay:
        ...
        class ObjectExpr971:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow970(x: str, y: str) -> bool:
                    return x == y
        ...
        if not contains(assay_identifier, this.RegisteredAssayIdentifiers, ObjectExpr971()):
    ...
    def get_registered_assay(assay_identifier: str) -> Callable[[ArcStudy], ArcAssay]:
        def _arrow972(study: ArcStudy) -> ArcAssay:
            copy: ArcStudy = study.Copy()
    ...
    def get_registered_assays_or_identifier(__unit: None=None) -> Callable[[ArcStudy], Array[ArcAssay]]:
        def _arrow974(study: ArcStudy) -> Array[ArcAssay]:
            copy: ArcStudy = study.Copy()
    ...
    def init_table(table_name: str, index: int | None=None) -> Callable[[ArcStudy], tuple[ArcStudy, ArcTable]]:
        def _arrow977(study: ArcStudy) -> tuple[ArcStudy, ArcTable]:
            c: ArcStudy = study.Copy()
            return (c, c.InitTable(table_name, index))
    ...
    def get_table(name: str) -> Callable[[ArcStudy], ArcTable]:
        def _arrow980(study: ArcStudy) -> ArcTable:
            new_assay: ArcStudy = study.Copy()
            return new_assay.GetTable(name)
    ...
    def get_column_at(table_index: int, column_index: int) -> Callable[[ArcStudy], CompositeColumn]:
        def _arrow1000(study: ArcStudy) -> CompositeColumn:
            new_assay: ArcStudy = study.Copy()
            return new_assay.GetColumnAt(table_index, column_index)
    ...
    def get_column(table_name: str, column_index: int) -> Callable[[ArcStudy], CompositeColumn]:
        def _arrow1003(study: ArcStudy) -> CompositeColumn:
            new_assay: ArcStudy = study.Copy()
            return new_assay.GetColumn(table_name, column_index)
    ...
    def get_row(table_name: str, row_index: int) -> Callable[[ArcStudy], Array[CompositeCell]]:
        def _arrow1011(study: ArcStudy) -> Array[CompositeCell]:
            new_assay: ArcStudy = study.Copy()
            return new_assay.GetRow(table_name, row_index)
    ...
    def StructurallyEquals(self, other: ArcStudy) -> bool:
        ...
        def _arrow1014(__unit: None=None) -> bool:
            ...
            def _arrow1013(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1012(i_1: int) -> bool:
                    return equals(item(i_1, a), item(i_1, b))

                return map_1(_arrow1012, range_big_int(0, 1, length(a) - 1))

            return fold(folder, True, to_list(delay(_arrow1013))) if (length(a) == length(b)) else False
        ...
        def _arrow1017(__unit: None=None) -> bool:
            ...
            def _arrow1016(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1015(i_2: int) -> bool:
                    return equals(item(i_2, a_1), item(i_2, b_1))

                return map_1(_arrow1015, range_big_int(0, 1, length(a_1) - 1))

            return fold(folder_1, True, to_list(delay(_arrow1016))) if (length(a_1) == length(b_1)) else False
        ...
        def _arrow1020(__unit: None=None) -> bool:
            ...
            def _arrow1019(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1018(i_3: int) -> bool:
                    return equals(item(i_3, a_2), item(i_3, b_2))

                return map_1(_arrow1018, range_big_int(0, 1, length(a_2) - 1))

            return fold(folder_2, True, to_list(delay(_arrow1019))) if (length(a_2) == length(b_2)) else False
        ...
        def _arrow1023(__unit: None=None) -> bool:
            ...
            def _arrow1022(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1021(i_4: int) -> bool:
                    return equals(item(i_4, a_3), item(i_4, b_3))

                return map_1(_arrow1021, range_big_int(0, 1, length(a_3) - 1))

            return fold(folder_3, True, to_list(delay(_arrow1022))) if (length(a_3) == length(b_3)) else False
        ...
        def _arrow1026(__unit: None=None) -> bool:
            ...
            def _arrow1025(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1024(i_5: int) -> bool:
                    return item(i_5, a_4) == item(i_5, b_4)

                return map_1(_arrow1024, range_big_int(0, 1, length(a_4) - 1))

            return fold(folder_4, True, to_list(delay(_arrow1025))) if (length(a_4) == length(b_4)) else False

        def _arrow1029(__unit: None=None) -> bool:
            ...
            def _arrow1028(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1027(i_6: int) -> bool:
                    return equals(item(i_6, a_5), item(i_6, b_5))

                return map_1(_arrow1027, range_big_int(0, 1, length(a_5) - 1))

            return fold(folder_5, True, to_list(delay(_arrow1028))) if (length(a_5) == length(b_5)) else False

        return for_all(predicate, to_enumerable([this.Identifier == other.Identifier, equals(this.Title, other.Title), equals(this.Description, other.Description), equals(this.SubmissionDate, other.SubmissionDate), equals(this.PublicReleaseDate, other.PublicReleaseDate), equals(this.DataMap, other.DataMap), _arrow1014(), _arrow1017(), _arrow1020(), _arrow1023(), _arrow1026(), _arrow1029()]))
...
class ArcRun(ArcTables):
    ...
    def init_table(table_name: str, index: int | None=None) -> Callable[[ArcRun], tuple[ArcRun, ArcTable]]:
        def _arrow1036(run: ArcRun) -> tuple[ArcRun, ArcTable]:
            c: ArcRun = run.Copy()
            return (c, c.InitTable(table_name, index))
    ...
    def get_table_at(index: int) -> Callable[[ArcRun], ArcTable]:
        def _arrow1038(run: ArcRun) -> ArcTable:
    ...
    def get_table(name: str) -> Callable[[ArcRun], ArcTable]:
        def _arrow1039(run: ArcRun) -> ArcTable:
            new_run: ArcRun = run.Copy()
    ...
    def get_column_at(table_index: int, column_index: int) -> Callable[[ArcRun], CompositeColumn]:
        def _arrow1056(run: ArcRun) -> CompositeColumn:
            new_run: ArcRun = run.Copy()
    ...
    def get_column(table_name: str, column_index: int) -> Callable[[ArcRun], CompositeColumn]:
        def _arrow1057(run: ArcRun) -> CompositeColumn:
            new_run: ArcRun = run.Copy()
    ...
    def get_row_at(table_index: int, row_index: int) -> Callable[[ArcRun], Array[CompositeCell]]:
        def _arrow1064(run: ArcRun) -> Array[CompositeCell]:
            new_run: ArcRun = run.Copy()
    ...
    def get_row(table_name: str, row_index: int) -> Callable[[ArcRun], Array[CompositeCell]]:
        def _arrow1065(run: ArcRun) -> Array[CompositeCell]:
            new_run: ArcRun = run.Copy()
            ...
            if not append_sequences_1:
                ...
                try: 
                    while enumerator.System_Collections_IEnumerator_MoveNext():
                        ...
                        class ObjectExpr1067:
                            @property
                            def Equals(self) -> Callable[[str, str], bool]:
                                def _arrow1066(x_1: str, y: str) -> bool:
                                    return x_1 == y
                        ...
                        if not contains_1(e, combined, ObjectExpr1067()):
                            (combined.append(e))
                ...
                try: 
                    while enumerator_1.System_Collections_IEnumerator_MoveNext():
                        ...
                        class ObjectExpr1069:
                            @property
                            def Equals(self) -> Callable[[str, str], bool]:
                                def _arrow1068(x_2: str, y_1: str) -> bool:
                                    return x_2 == y_1
                        ...
                        if not contains_1(e_1, combined, ObjectExpr1069()):
                            (combined.append(e_1))
            ...
            if not append_sequences_1:
                ...
                try: 
                    while enumerator_2.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_2, combined_1, ObjectExpr1070()):
                            (combined_1.append(e_2))
                ...
                try: 
                    while enumerator_1_1.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_1_1, combined_1, ObjectExpr1071()):
                            (combined_1.append(e_1_1))
            ...
            if not append_sequences_1:
                ...
                try: 
                    while enumerator_3.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_3, combined_2, ObjectExpr1072()):
                            (combined_2.append(e_3))
                ...
                try: 
                    while enumerator_1_2.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_1_2, combined_2, ObjectExpr1073()):
                            (combined_2.append(e_1_2))
            ...
            if not append_sequences_1:
                ...
                try: 
                    while enumerator_4.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_4, combined_3, ObjectExpr1074()):
                ...
                try: 
                    while enumerator_1_3.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_1_3, combined_3, ObjectExpr1075()):
    ...
    def StructurallyEquals(self, other: ArcRun) -> bool:
        ...
        def _arrow1079(__unit: None=None) -> bool:
            ...
            def _arrow1078(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1077(i_1: int) -> bool:
                    return item(i_1, a) == item(i_1, b)

                return map_1(_arrow1077, range_big_int(0, 1, length(a) - 1))

            return fold(folder, True, to_list(delay(_arrow1078))) if (length(a) == length(b)) else False
        ...
        def _arrow1082(__unit: None=None) -> bool:
            ...
            def _arrow1081(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1080(i_2: int) -> bool:
                    return equals(item(i_2, a_1), item(i_2, b_1))

                return map_1(_arrow1080, range_big_int(0, 1, length(a_1) - 1))

            return fold(folder_1, True, to_list(delay(_arrow1081))) if (length(a_1) == length(b_1)) else False
        ...
        def _arrow1085(__unit: None=None) -> bool:
            ...
            def _arrow1084(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1083(i_3: int) -> bool:
                    return equals(item(i_3, a_2), item(i_3, b_2))

                return map_1(_arrow1083, range_big_int(0, 1, length(a_2) - 1))

            return fold(folder_2, True, to_list(delay(_arrow1084))) if (length(a_2) == length(b_2)) else False
        ...
        def _arrow1088(__unit: None=None) -> bool:
            ...
            def _arrow1087(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1086(i_4: int) -> bool:
                    return equals(item(i_4, a_3), item(i_4, b_3))

                return map_1(_arrow1086, range_big_int(0, 1, length(a_3) - 1))

            return fold(folder_3, True, to_list(delay(_arrow1087))) if (length(a_3) == length(b_3)) else False

        return for_all(predicate, to_enumerable([this.Identifier == other.Identifier, equals(this.Title, other.Title), equals(this.Description, other.Description), equals(this.MeasurementType, other.MeasurementType), equals(this.TechnologyType, other.TechnologyType), equals(this.TechnologyPlatform, other.TechnologyPlatform), _arrow1079(), equals(this.DataMap, other.DataMap), _arrow1082(), _arrow1085(), _arrow1088()]))
...
class ArcInvestigation:
    ...
    def contains_workflow(workflow_identifier: str) -> Callable[[ArcInvestigation], bool]:
        def _arrow1151(inv: ArcInvestigation) -> bool:
    ...
    def set_workflow(workflow_identifier: str, workflow: ArcWorkflow) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1152(inv: ArcInvestigation) -> ArcInvestigation:
            copy: ArcInvestigation = inv.Copy()
    ...
    def GetRunIndex(self, run_identifier: str) -> int:
        this: ArcInvestigation = self
        def _arrow1154(r: ArcRun) -> bool:
            return r.Identifier == run_identifier

        index: int = find_index(_arrow1154, this.Runs) or 0
        if index == -1:
    ...
    def get_run_index(run_identifier: str) -> Callable[[ArcInvestigation], int]:
        def _arrow1155(inv: ArcInvestigation) -> int:
    ...
    def init_run(run_identifier: str) -> Callable[[ArcInvestigation], ArcRun]:
        def _arrow1157(inv: ArcInvestigation) -> ArcRun:
            copy: ArcInvestigation = inv.Copy()
    ...
    def get_run_at(index: int) -> Callable[[ArcInvestigation], ArcRun]:
        def _arrow1161(inv: ArcInvestigation) -> ArcRun:
            copy: ArcInvestigation = inv.Copy()
    ...
    def get_run(run_identifier: str) -> Callable[[ArcInvestigation], ArcRun]:
        def _arrow1162(inv: ArcInvestigation) -> ArcRun:
            copy: ArcInvestigation = inv.Copy()
    ...
    def try_get_run(run_identifier: str) -> Callable[[ArcInvestigation], ArcRun | None]:
        def _arrow1163(inv: ArcInvestigation) -> ArcRun | None:
            copy: ArcInvestigation = inv.Copy()
    ...
    def contains_run(run_identifier: str) -> Callable[[ArcInvestigation], bool]:
        def _arrow1164(inv: ArcInvestigation) -> bool:
    ...
    def GetAllPersons(self, __unit: None=None) -> Array[Person]:
        ...
        return Array_distinct(list(persons), ObjectExpr1167())
    ...
    def GetAllPublications(self, __unit: None=None) -> Array[Publication]:
        ...
        return Array_distinct(list(pubs), ObjectExpr1168())
            ...
            while enumerator.System_Collections_IEnumerator_MoveNext():
                ...
                try: 
                    while enumerator_1.System_Collections_IEnumerator_MoveNext():
                        ...
                        class ObjectExpr1170:
                            @property
                            def Equals(self) -> Callable[[str, str], bool]:
                                def _arrow1169(x: str, y: str) -> bool:
                                    return x == y
                        ...
                        if not contains(registered_assay, existing_assays, ObjectExpr1170()):
    ...
    def UpdateIOTypeByEntityID(self, __unit: None=None) -> None:
        this: ArcInvestigation = self
        def _arrow1177(__unit: None=None) -> IEnumerable_1[ArcTable]:
            def _arrow1172(study: ArcStudy) -> IEnumerable_1[ArcTable]:
                return study.Tables

            def _arrow1176(__unit: None=None) -> IEnumerable_1[ArcTable]:
                def _arrow1173(assay: ArcAssay) -> IEnumerable_1[ArcTable]:
                    return assay.Tables

                def _arrow1175(__unit: None=None) -> IEnumerable_1[ArcTable]:
                    def _arrow1174(run: ArcRun) -> IEnumerable_1[ArcTable]:
                        return run.Tables

                    return collect(_arrow1174, this.Runs)

                return append_4(collect(_arrow1173, this.Assays), delay(_arrow1175))

            return append_4(collect(_arrow1172, this.Studies), delay(_arrow1176))

        io_map: Any = ArcTablesAux_getIOMap(list(to_list(delay(_arrow1177))))
        enumerator: Any = get_enumerator(this.Studies)
        try: 
            while enumerator.System_Collections_IEnumerator_MoveNext():
    ...
    def StructurallyEquals(self, other: ArcInvestigation) -> bool:
        ...
        def _arrow1180(__unit: None=None) -> bool:
            ...
            def _arrow1179(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1178(i_1: int) -> bool:
                    return equals(item(i_1, a), item(i_1, b))

                return map_1(_arrow1178, range_big_int(0, 1, length(a) - 1))

            return fold(folder, True, to_list(delay(_arrow1179))) if (length(a) == length(b)) else False
        ...
        def _arrow1183(__unit: None=None) -> bool:
            ...
            def _arrow1182(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1181(i_2: int) -> bool:
                    return equals(item(i_2, a_1), item(i_2, b_1))

                return map_1(_arrow1181, range_big_int(0, 1, length(a_1) - 1))

            return fold(folder_1, True, to_list(delay(_arrow1182))) if (length(a_1) == length(b_1)) else False
        ...
        def _arrow1186(__unit: None=None) -> bool:
            ...
            def _arrow1185(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1184(i_3: int) -> bool:
                    return equals(item(i_3, a_2), item(i_3, b_2))

                return map_1(_arrow1184, range_big_int(0, 1, length(a_2) - 1))

            return fold(folder_2, True, to_list(delay(_arrow1185))) if (length(a_2) == length(b_2)) else False

        def _arrow1189(__unit: None=None) -> bool:
            ...
            def _arrow1188(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1187(i_4: int) -> bool:
                    return equals(item(i_4, a_3), item(i_4, b_3))

                return map_1(_arrow1187, range_big_int(0, 1, length(a_3) - 1))

            return fold(folder_3, True, to_list(delay(_arrow1188))) if (length(a_3) == length(b_3)) else False

        def _arrow1192(__unit: None=None) -> bool:
            ...
            def _arrow1191(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1190(i_5: int) -> bool:
                    return equals(item(i_5, a_4), item(i_5, b_4))

                return map_1(_arrow1190, range_big_int(0, 1, length(a_4) - 1))

            return fold(folder_4, True, to_list(delay(_arrow1191))) if (length(a_4) == length(b_4)) else False
        ...
        def _arrow1195(__unit: None=None) -> bool:
            ...
            def _arrow1194(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1193(i_6: int) -> bool:
                    return equals(item(i_6, a_5), item(i_6, b_5))

                return map_1(_arrow1193, range_big_int(0, 1, length(a_5) - 1))

            return fold(folder_5, True, to_list(delay(_arrow1194))) if (length(a_5) == length(b_5)) else False
        ...
        def _arrow1198(__unit: None=None) -> bool:
            ...
            def _arrow1197(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1196(i_7: int) -> bool:
                    return equals(item(i_7, a_6), item(i_7, b_6))

                return map_1(_arrow1196, range_big_int(0, 1, length(a_6) - 1))

            return fold(folder_6, True, to_list(delay(_arrow1197))) if (length(a_6) == length(b_6)) else False
        ...
        def _arrow1201(__unit: None=None) -> bool:
            ...
            def _arrow1200(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1199(i_8: int) -> bool:
                    return item(i_8, a_7) == item(i_8, b_7)

                return map_1(_arrow1199, range_big_int(0, 1, length(a_7) - 1))

            return fold(folder_7, True, to_list(delay(_arrow1200))) if (length(a_7) == length(b_7)) else False
        ...
        def _arrow1204(__unit: None=None) -> bool:
            ...
            def _arrow1203(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1202(i_9: int) -> bool:
                    return equals(item(i_9, a_8), item(i_9, b_8))

                return map_1(_arrow1202, range_big_int(0, 1, length(a_8) - 1))

            return fold(folder_8, True, to_list(delay(_arrow1203))) if (length(a_8) == length(b_8)) else False
        ...
        def _arrow1207(__unit: None=None) -> bool:
            ...
            def _arrow1206(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1205(i_10: int) -> bool:
                    return equals(item(i_10, a_9), item(i_10, b_9))

                return map_1(_arrow1205, range_big_int(0, 1, length(a_9) - 1))

            return fold(folder_9, True, to_list(delay(_arrow1206))) if (length(a_9) == length(b_9)) else False

        return for_all(predicate, to_enumerable([this.Identifier == other.Identifier, equals(this.Title, other.Title), equals(this.Description, other.Description), equals(this.SubmissionDate, other.SubmissionDate), equals(this.PublicReleaseDate, other.PublicReleaseDate), _arrow1180(), _arrow1183(), _arrow1186(), _arrow1189(), _arrow1192(), _arrow1195(), _arrow1198(), _arrow1201(), _arrow1204(), _arrow1207()]))
...
ArcInvestigation_reflection = _expr1208
...
def ArcWorkflow_addSubWorkflow_Z1C75CB0E(sub_workflow: ArcWorkflow) -> Callable[[ArcWorkflow], ArcWorkflow]:
    def _arrow1209(workflow: ArcWorkflow, sub_workflow: Any=sub_workflow) -> ArcWorkflow:
...
def ArcWorkflow_initSubWorkflow_Z721C83C5(sub_workflow_identifier: str) -> Callable[[ArcWorkflow], tuple[ArcWorkflow, ArcWorkflow]]:
    def _arrow1210(workflow: ArcWorkflow, sub_workflow_identifier: Any=sub_workflow_identifier) -> tuple[ArcWorkflow, ArcWorkflow]:
...
def ArcWorkflow__RegisterSubWorkflow_Z721C83C5(this: ArcWorkflow, sub_workflow_identifier: str) -> None:
    class ObjectExpr1212:
        @property
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow1211(x: str, y: str) -> bool:
                return x == y
    ...
    if contains(sub_workflow_identifier, ArcWorkflow__get_SubWorkflowIdentifiers(this), ObjectExpr1212()):
...
def ArcWorkflow_registerSubWorkflow_Z721C83C5(sub_workflow_identifier: str) -> Callable[[ArcWorkflow], ArcWorkflow]:
    def _arrow1213(workflow: ArcWorkflow, sub_workflow_identifier: Any=sub_workflow_identifier) -> ArcWorkflow:
        copy: ArcWorkflow = ArcWorkflow__Copy_6FCE9E49(workflow)
...
def ArcWorkflow__DeregisterSubWorkflow_Z721C83C5(this: ArcWorkflow, sub_workflow_identifier: str) -> None:
    class ObjectExpr1215:
        @property
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow1214(x: str, y: str) -> bool:
                return x == y
    ...
    ignore(remove_in_place(sub_workflow_identifier, ArcWorkflow__get_SubWorkflowIdentifiers(this), ObjectExpr1215()))


def ArcWorkflow_deregisterSubWorkflow_Z721C83C5(sub_workflow_identifier: str) -> Callable[[ArcWorkflow], ArcWorkflow]:
    def _arrow1216(workflow: ArcWorkflow, sub_workflow_identifier: Any=sub_workflow_identifier) -> ArcWorkflow:
        copy: ArcWorkflow = ArcWorkflow__Copy_6FCE9E49(workflow)
...
def ArcWorkflow__GetRegisteredSubWorkflow_Z721C83C5(this: ArcWorkflow, sub_workflow_identifier: str) -> ArcWorkflow:
    ...
    if not contains(sub_workflow_identifier, ArcWorkflow__get_SubWorkflowIdentifiers(this), ObjectExpr1218()):
...
def ArcWorkflow_getRegisteredSubWorkflow_Z721C83C5(sub_workflow_identifier: str) -> Callable[[ArcWorkflow], ArcWorkflow]:
    def _arrow1219(workflow: ArcWorkflow, sub_workflow_identifier: Any=sub_workflow_identifier) -> ArcWorkflow:
...
def ArcWorkflow_getRegisteredSubWorkflows(__unit: None=None) -> Callable[[ArcWorkflow], Array[ArcWorkflow]]:
    def _arrow1220(workflow: ArcWorkflow) -> Array[ArcWorkflow]:
...
def ArcWorkflow__StructurallyEquals_Z1C75CB0E(this: ArcWorkflow, other: ArcWorkflow) -> bool:
    ...
    def _arrow1224(__unit: None=None, this: Any=this, other: Any=other) -> bool:
        ...
        def _arrow1223(__unit: None=None) -> IEnumerable_1[bool]:
            def _arrow1222(i_1: int) -> bool:
                return item(i_1, a) == item(i_1, b)

            return map_1(_arrow1222, range_big_int(0, 1, length(a) - 1))

        return fold(folder, True, to_list(delay(_arrow1223))) if (length(a) == length(b)) else False

    def _arrow1227(__unit: None=None, this: Any=this, other: Any=other) -> bool:
        ...
        def _arrow1226(__unit: None=None) -> IEnumerable_1[bool]:
            def _arrow1225(i_2: int) -> bool:
                return equals(item(i_2, a_1), item(i_2, b_1))

            return map_1(_arrow1225, range_big_int(0, 1, length(a_1) - 1))

        return fold(folder_1, True, to_list(delay(_arrow1226))) if (length(a_1) == length(b_1)) else False

    def _arrow1230(__unit: None=None, this: Any=this, other: Any=other) -> bool:
        ...
        def _arrow1229(__unit: None=None) -> IEnumerable_1[bool]:
            def _arrow1228(i_3: int) -> bool:
                return equals(item(i_3, a_2), item(i_3, b_2))

            return map_1(_arrow1228, range_big_int(0, 1, length(a_2) - 1))

        return fold(folder_2, True, to_list(delay(_arrow1229))) if (length(a_2) == length(b_2)) else False

    def _arrow1233(__unit: None=None, this: Any=this, other: Any=other) -> bool:
        ...
        def _arrow1232(__unit: None=None) -> IEnumerable_1[bool]:
            def _arrow1231(i_4: int) -> bool:
                return equals(item(i_4, a_3), item(i_4, b_3))

            return map_1(_arrow1231, range_big_int(0, 1, length(a_3) - 1))

        return fold(folder_3, True, to_list(delay(_arrow1232))) if (length(a_3) == length(b_3)) else False

    def _arrow1236(__unit: None=None, this: Any=this, other: Any=other) -> bool:
