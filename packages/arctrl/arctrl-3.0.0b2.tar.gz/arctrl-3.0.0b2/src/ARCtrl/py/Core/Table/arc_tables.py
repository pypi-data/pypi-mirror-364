...
def ArcTablesAux_SanityChecks_validateSheetIndex(index: int, allow_append: bool, sheets: Array[ArcTable]) -> None:
    ...
    def _arrow715(__unit: None=None, index: Any=index, allow_append: Any=allow_append, sheets: Any=sheets) -> bool:
        x: int = index or 0
...
def ArcTablesAux_SanityChecks_validateNamesUnique(names: IEnumerable_1[str]) -> None:
    ...
    if not (length(names) == length(distinct(names, ObjectExpr717()))):
...
def ArcTablesAux_SanityChecks_validateNewNameUnique(new_name: str, existing_names: IEnumerable_1[str]) -> None:
    def _arrow719(x: str, new_name: Any=new_name, existing_names: Any=existing_names) -> bool:
        return x == new_name

    match_value: int | None = try_find_index(_arrow719, existing_names)
    if match_value is None:
        pass
...
def ArcTablesAux_SanityChecks_validateNewNameAtUnique(index: int, new_name: str, existing_names: IEnumerable_1[str]) -> None:
    def _arrow720(x: str, index: Any=index, new_name: Any=new_name, existing_names: Any=existing_names) -> bool:
        return x == new_name

    match_value: int | None = try_find_index(_arrow720, existing_names)
    if match_value is None:
        pass
...
def ArcTablesAux_SanityChecks_validateNewNamesUnique(new_names: IEnumerable_1[str], existing_names: IEnumerable_1[str]) -> None:
    ...
    same: Any = intersect(of_seq(new_names, ObjectExpr721()), of_seq(existing_names, ObjectExpr722()))
...
class ArcTables:
    def __init__(self, init_tables: Array[ArcTable]) -> None:
        ...
        self.tables: Array[ArcTable] = _expr755()
    ...
    def TableNames(self, __unit: None=None) -> FSharpList[str]:
        this: ArcTables = self
        def _arrow726(__unit: None=None) -> IEnumerable_1[str]:
            def _arrow725(s: ArcTable) -> str:
                return s.Name

            return map_1(_arrow725, this.Tables)

        return to_list(delay(_arrow726))
    ...
    def RemoveColumnAt(self, table_index: int, column_index: int) -> None:
        this: ArcTables = self
        def _arrow733(table: ArcTable) -> None:
            table.RemoveColumn(column_index)

        this.MapTableAt(table_index, _arrow733)
    ...
    def AddRowAt(self, table_index: int, cells: Array[CompositeCell] | None=None, row_index: int | None=None) -> None:
        this: ArcTables = self
        def _arrow738(table: ArcTable) -> None:
            table.AddRow(cells, row_index)

        this.MapTableAt(table_index, _arrow738)
    ...
    def RemoveRowAt(self, table_index: int, row_index: int) -> None:
        this: ArcTables = self
        def _arrow740(table: ArcTable) -> None:
            table.RemoveRow(row_index)

        this.MapTableAt(table_index, _arrow740)
    ...
    def UpdateRowAt(self, table_index: int, row_index: int, cells: Array[CompositeCell]) -> None:
        ...
        this.MapTableAt(table_index, _arrow741)
    ...
    def update_reference_tables_by_sheets(reference_tables: ArcTables, sheet_tables: ArcTables, keep_unused_ref_tables: bool | None=None) -> ArcTables:
        ...
        reference_table_map: Any = of_seq_1(choose(chooser, reference_tables.Tables), ObjectExpr744())
        def _arrow751(__unit: None=None) -> IEnumerable_1[ArcTable]:
            ...
            def _arrow749(__unit: None=None) -> Array[ArcTable]:
                a: Array[ArcTable] = sheet_tables.Tables
                return ResizeArray_collect(ArcTable.SplitByProtocolREF(), a)

            s: Array[ArcTable] = ResizeArray_map(f_3, ResizeArray_groupBy(f_2, ResizeArray_map(f_1, _arrow749())))
        ...
        return ArcTables(list(_arrow751()))
