...
class ArcAssay(ArcTables):
    def __init__(self, identifier: str, title: str | None=None, description: str | None=None, measurement_type: OntologyAnnotation | None=None, technology_type: OntologyAnnotation | None=None, technology_platform: OntologyAnnotation | None=None, tables: Array[ArcTable] | None=None, datamap: DataMap | None=None, performers: Array[Person] | None=None, comments: Array[Comment] | None=None) -> None:
        ...
        def _arrow957(__unit: None=None) -> str:
            identifier_1: str = identifier.strip()
            check_valid_characters(identifier_1)
            return identifier_1

        self.identifier_0040129: str = _arrow957()
    ...
    def StructurallyEquals(self, other: ArcAssay) -> bool:
        ...
        def _arrow949(__unit: None=None) -> bool:
            ...
            def _arrow948(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow947(i_1: int) -> bool:
                    return equals(item(i_1, a), item(i_1, b))

                return map_1(_arrow947, range_big_int(0, 1, length(a) - 1))

            return fold(folder, True, to_list(delay(_arrow948))) if (length(a) == length(b)) else False

        def _arrow953(__unit: None=None) -> bool:
            ...
            def _arrow951(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow950(i_2: int) -> bool:
                    return equals(item(i_2, a_1), item(i_2, b_1))

                return map_1(_arrow950, range_big_int(0, 1, length(a_1) - 1))

            return fold(folder_1, True, to_list(delay(_arrow951))) if (length(a_1) == length(b_1)) else False

        def _arrow956(__unit: None=None) -> bool:
...
class ArcStudy(ArcTables):
    ...
    def init_registered_assay(assay_identifier: str) -> Callable[[ArcStudy], tuple[ArcStudy, ArcAssay]]:
        def _arrow965(study: ArcStudy) -> tuple[ArcStudy, ArcAssay]:
    ...
    def RegisterAssay(self, assay_identifier: str) -> None:
        ...
        if contains(assay_identifier, this.RegisteredAssayIdentifiers, ObjectExpr967()):
    ...
    def DeregisterAssay(self, assay_identifier: str) -> None:
        ...
        ignore(remove_in_place(assay_identifier, this.RegisteredAssayIdentifiers, ObjectExpr971()))
    ...
    def GetRegisteredAssay(self, assay_identifier: str) -> ArcAssay:
        ...
        class ObjectExpr974:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow973(x: str, y: str) -> bool:
                    return x == y
        ...
        if not contains(assay_identifier, this.RegisteredAssayIdentifiers, ObjectExpr974()):
...
def ArcWorkflow_getRegisteredSubWorkflow_Z721C83C5(sub_workflow_identifier: str) -> Callable[[ArcWorkflow], ArcWorkflow]:
    def _arrow1222(workflow: ArcWorkflow, sub_workflow_identifier: Any=sub_workflow_identifier) -> ArcWorkflow:
...
def ArcWorkflow_getRegisteredSubWorkflows(__unit: None=None) -> Callable[[ArcWorkflow], Array[ArcWorkflow]]:
    def _arrow1223(workflow: ArcWorkflow) -> Array[ArcWorkflow]:
...
def ArcWorkflow__StructurallyEquals_Z1C75CB0E(this: ArcWorkflow, other: ArcWorkflow) -> bool:
    ...
    def _arrow1227(__unit: None=None, this: Any=this, other: Any=other) -> bool:
        ...
        def _arrow1226(__unit: None=None) -> IEnumerable_1[bool]:
            def _arrow1225(i_1: int) -> bool:
                return item(i_1, a) == item(i_1, b)

            return map_1(_arrow1225, range_big_int(0, 1, length(a) - 1))

        return fold(folder, True, to_list(delay(_arrow1226))) if (length(a) == length(b)) else False
    ...
    def _arrow1231(__unit: None=None, this: Any=this, other: Any=other) -> bool:
        ...
        def _arrow1229(__unit: None=None) -> IEnumerable_1[bool]:
            def _arrow1228(i_2: int) -> bool:
                return equals(item(i_2, a_1), item(i_2, b_1))

            return map_1(_arrow1228, range_big_int(0, 1, length(a_1) - 1))

        return fold(folder_1, True, to_list(delay(_arrow1229))) if (length(a_1) == length(b_1)) else False
    ...
    def _arrow1246(__unit: None=None, this: Any=this, other: Any=other) -> bool:
        ...
        def _arrow1245(__unit: None=None) -> IEnumerable_1[bool]:
            def _arrow1244(i_3: int) -> bool:
                return equals(item(i_3, a_2), item(i_3, b_2))

            return map_1(_arrow1244, range_big_int(0, 1, length(a_2) - 1))

        return fold(folder_2, True, to_list(delay(_arrow1245))) if (length(a_2) == length(b_2)) else False
    ...
    def _arrow1249(__unit: None=None, this: Any=this, other: Any=other) -> bool:
        ...
        def _arrow1248(__unit: None=None) -> IEnumerable_1[bool]:
            def _arrow1247(i_4: int) -> bool:
                return equals(item(i_4, a_3), item(i_4, b_3))

            return map_1(_arrow1247, range_big_int(0, 1, length(a_3) - 1))

        return fold(folder_3, True, to_list(delay(_arrow1248))) if (length(a_3) == length(b_3)) else False
