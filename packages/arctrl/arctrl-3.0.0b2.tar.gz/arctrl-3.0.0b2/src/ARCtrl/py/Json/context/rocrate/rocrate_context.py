...
def _arrow1906(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1899()), ("arc", ObjectExpr1900()), ("CreativeWork", ObjectExpr1901()), ("about", ObjectExpr1902()), ("conformsTo", ObjectExpr1904())])
...
context_jsonvalue: IEncodable = _arrow1906()
