...
def ISAJson_encoder(study_name: str | None, assay_name: str | None, id_map: Any | None, oa: Process) -> IEncodable:
    def f(oa_1: Process, study_name: Any=study_name, assay_name: Any=assay_name, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2749(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2751(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2752(oa_2: Protocol, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(study_name, assay_name, oa_1.Name, id_map, oa_2)

        def _arrow2753(oa_3: ProcessParameterValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, oa_3)

        def _arrow2755(value_4: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2757(value_6: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2758(oa_4: Process, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder(study_name, assay_name, id_map, oa_4)

        def _arrow2759(oa_5: Process, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder(study_name, assay_name, id_map, oa_5)

        def _arrow2760(value_8: ProcessInput, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, value_8)

        def _arrow2761(value_9: ProcessOutput, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_4(id_map, value_9)

        def _arrow2762(comment: Comment, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_5(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2749, ROCrate_genID(oa_1)), try_include("name", _arrow2751, oa_1.Name), try_include("executesProtocol", _arrow2752, oa_1.ExecutesProtocol), try_include_list_opt("parameterValues", _arrow2753, oa_1.ParameterValues), try_include("performer", _arrow2755, oa_1.Performer), try_include("date", _arrow2757, oa_1.Date), try_include("previousProcess", _arrow2758, oa_1.PreviousProcess), try_include("nextProcess", _arrow2759, oa_1.NextProcess), try_include_list_opt("inputs", _arrow2760, oa_1.Inputs), try_include_list_opt("outputs", _arrow2761, oa_1.Outputs), try_include_list_opt("comments", _arrow2762, oa_1.Comments)]))
    ...
    if id_map is not None:
        def _arrow2764(p: Process, study_name: Any=study_name, assay_name: Any=assay_name, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(p)

        return encode(_arrow2764, f, oa, id_map)
...
def _arrow2777(__unit: None=None) -> Decoder_1[Process]:
    def decode(__unit: None=None) -> Decoder_1[Process]:
        def _arrow2776(get: IGetters) -> Process:
            ...
            def _arrow2767(__unit: None=None) -> Protocol | None:
                object_arg_2: IOptionalGetter = get.Optional
                return object_arg_2.Field("executesProtocol", ISAJson_decoder_1)

            def _arrow2768(__unit: None=None) -> FSharpList[ProcessParameterValue] | None:
