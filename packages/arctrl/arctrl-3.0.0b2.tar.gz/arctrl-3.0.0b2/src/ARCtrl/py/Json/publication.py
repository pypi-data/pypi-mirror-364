...
def _arrow2322(get: IGetters) -> Publication:
    ...
    def _arrow2319(__unit: None=None) -> str | None:
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("title", string)

    def _arrow2320(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("status", OntologyAnnotation_ROCrate_decoderDefinedTerm)

    def _arrow2321(__unit: None=None) -> Array[Comment] | None:
        arg_11: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoderDisambiguatingDescription)
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("comments", arg_11)

    return Publication(_arrow2316(), _arrow2317(), _arrow2318(), _arrow2319(), _arrow2320(), _arrow2321())


ROCrate_decoder: Decoder_1[Publication] = object(_arrow2322)
...
def ISAJson_encoder(id_map: Any | None, oa: Publication) -> IEncodable:
    ...
    def _arrow2330(value: str, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2336(value_2: str, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2338(value_4: str, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2341(value_6: str, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2344(comment: Comment, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        return ISAJson_encoder_1(id_map, comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("pubMedID", _arrow2330, oa.PubMedID), try_include("doi", _arrow2336, oa.DOI), try_include("authorList", _arrow2338, oa.Authors), try_include("title", _arrow2341, oa.Title), try_include("status", _arrow2343, oa.Status), try_include_seq("comments", _arrow2344, oa.Comments)]))
