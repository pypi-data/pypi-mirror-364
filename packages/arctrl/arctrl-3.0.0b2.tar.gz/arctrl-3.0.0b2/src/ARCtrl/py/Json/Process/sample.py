...
def ROCrate_encoder(oa: Sample) -> IEncodable:
    ...
    def _arrow2669(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2673(value_5: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2674(x: IEncodable, oa: Any=oa) -> IEncodable:
        return x

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2669()), ("@type", list_1_2(singleton(ObjectExpr2670()))), ("additionalType", ObjectExpr2671()), try_include("name", _arrow2673, oa.Name), try_include_list("additionalProperties", _arrow2674, additional_properties), ("@context", context_jsonvalue)]))
...
def _arrow2689(get: IGetters) -> Sample:
    ...
    def _arrow2688(__unit: None=None) -> FSharpList[Source] | None:
        arg_15: Decoder_1[FSharpList[Source]] = list_1_3(ROCrate_decoder_3)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("derivesFrom", arg_15)

    return Sample(_arrow2682(), _arrow2684(), pattern_input[0], pattern_input[1], _arrow2688())


ROCrate_decoder: Decoder_1[Sample] = object(_arrow2689)
...
def ISAJson_encoder(id_map: Any | None, oa: Sample) -> IEncodable:
    def f(oa_1: Sample, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2693(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2695(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2696(oa_2: MaterialAttributeValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(id_map, oa_2)

        def _arrow2697(fv: FactorValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, fv)

        def _arrow2698(oa_3: Source, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, oa_3)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2693, ROCrate_genID(oa_1)), try_include("name", _arrow2695, oa_1.Name), try_include_list_opt("characteristics", _arrow2696, oa_1.Characteristics), try_include_list_opt("factorValues", _arrow2697, oa_1.FactorValues), try_include_list_opt("derivesFrom", _arrow2698, oa_1.DerivesFrom)]))
    ...
    if id_map is not None:
        def _arrow2700(s_1: Sample, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(s_1)

        return encode(_arrow2700, f, oa, id_map)
...
def _arrow2706(get: IGetters) -> Sample:
    ...
    def _arrow2703(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    def _arrow2704(__unit: None=None) -> FSharpList[FactorValue] | None:
        arg_7: Decoder_1[FSharpList[FactorValue]] = list_1_3(ISAJson_decoder_2)
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("factorValues", arg_7)

    def _arrow2705(__unit: None=None) -> FSharpList[Source] | None:
        arg_9: Decoder_1[FSharpList[Source]] = list_1_3(ISAJson_decoder_3)
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("derivesFrom", arg_9)

    return Sample(_arrow2701(), _arrow2702(), _arrow2703(), _arrow2704(), _arrow2705())


ISAJson_decoder: Decoder_1[Sample] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2706)
