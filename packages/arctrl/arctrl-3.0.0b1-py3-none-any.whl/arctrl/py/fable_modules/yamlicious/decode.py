...
class Getter:
    def __init__(self, ele: YAMLElement) -> None:
        ...
        def _arrow457(__unit: None=None) -> IOptionalGetter:
            _this_1: Any = self
            class ObjectExpr456(IOptionalGetter):
        ...
        self.optional: IOptionalGetter = _arrow457()
        def _arrow459(__unit: None=None) -> IMultipleOptionalGetter:
            _this_2: Any = self
            class ObjectExpr458(IMultipleOptionalGetter):
        ...
        self.multiple_optional: IMultipleOptionalGetter = _arrow459()
        def _arrow462(__unit: None=None) -> IOverflowGetter:
            _this_3: Any = self
            class ObjectExpr461(IOverflowGetter):
        ...
        self.overflow: IOverflowGetter = _arrow462()
