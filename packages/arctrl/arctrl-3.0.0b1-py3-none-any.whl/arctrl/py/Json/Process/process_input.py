...
def _arrow2657(Item: Sample) -> ProcessInput:
    return ProcessInput(1, Item)


def _arrow2658(Item_1: Source) -> ProcessInput:
    return ProcessInput(0, Item_1)


def _arrow2659(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow2660(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ROCrate_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2657, ROCrate_decoder_1), map(_arrow2658, ROCrate_decoder_2), map(_arrow2659, ROCrate_decoder_3), map(_arrow2660, ROCrate_decoder_4)]))
...
def _arrow2662(Item: Source) -> ProcessInput:
    return ProcessInput(0, Item)


def _arrow2667(Item_1: Sample) -> ProcessInput:
    return ProcessInput(1, Item_1)


def _arrow2668(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow2669(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ISAJson_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2662, ISAJson_decoder_1), map(_arrow2667, ISAJson_decoder_2), map(_arrow2668, ISAJson_decoder_3), map(_arrow2669, ISAJson_decoder_4)]))
