...
def _arrow1919(decoders: IGetters) -> LDRef:
    def _arrow1918(__unit: None=None) -> str:
        object_arg: IRequiredGetter = decoders.Required
        return object_arg.Field("@id", string)

    return LDRef(_arrow1918())


decoder: Decoder_1[LDRef] = object(_arrow1919)

def encoder(r: LDRef) -> IEncodable:
    def _arrow1922(__unit: None=None, r: Any=r) -> IEncodable:
        value: str = r.Id
    ...
    values: FSharpList[tuple[str, IEncodable]] = singleton(("@id", _arrow1922()))
