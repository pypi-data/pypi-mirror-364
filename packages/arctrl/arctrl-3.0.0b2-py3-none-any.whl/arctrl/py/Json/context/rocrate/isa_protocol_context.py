...
def _arrow1848(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1827()), ("bio", ObjectExpr1828()), ("Protocol", ObjectExpr1829()), ("name", ObjectExpr1830()), ("protocolType", ObjectExpr1831()), ("description", ObjectExpr1833()), ("version", ObjectExpr1835()), ("components", ObjectExpr1837()), ("reagents", ObjectExpr1839()), ("computationalTools", ObjectExpr1841()), ("uri", ObjectExpr1843()), ("comments", ObjectExpr1844())])
