...
def encoder_compressed(string_table: Any, oa_table: Any, cell_table: Any, study: ArcStudy) -> IEncodable:
    ...
    def _arrow3087(dm: DataMap, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_compressed_2(string_table, oa_table, cell_table, dm)

    def _arrow3089(value_9: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
...
def decoder_compressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[ArcStudy]:
    def _arrow3107(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> ArcStudy:
        def _arrow3094(__unit: None=None) -> str:
            object_arg: IRequiredGetter = get.Required
            return object_arg.Field("Identifier", string)
        ...
        def _arrow3099(__unit: None=None) -> str | None:
            object_arg_4: IOptionalGetter = get.Optional
            return object_arg_4.Field("PublicReleaseDate", string)

        def _arrow3100(__unit: None=None) -> Array[Publication] | None:
            arg_11: Decoder_1[Array[Publication]] = resize_array(decoder_2)
            object_arg_5: IOptionalGetter = get.Optional
            return object_arg_5.Field("Publications", arg_11)

        def _arrow3101(__unit: None=None) -> Array[Person] | None:
            arg_13: Decoder_1[Array[Person]] = resize_array(decoder_3)
            object_arg_6: IOptionalGetter = get.Optional
            return object_arg_6.Field("Contacts", arg_13)

        def _arrow3102(__unit: None=None) -> Array[OntologyAnnotation] | None:
            arg_15: Decoder_1[Array[OntologyAnnotation]] = resize_array(OntologyAnnotation_decoder)
            object_arg_7: IOptionalGetter = get.Optional
            return object_arg_7.Field("StudyDesignDescriptors", arg_15)

        def _arrow3103(__unit: None=None) -> Array[ArcTable] | None:
            arg_17: Decoder_1[Array[ArcTable]] = resize_array(decoder_compressed_1(string_table, oa_table, cell_table))
            object_arg_8: IOptionalGetter = get.Optional
            return object_arg_8.Field("Tables", arg_17)

        def _arrow3104(__unit: None=None) -> DataMap | None:
            arg_19: Decoder_1[DataMap] = decoder_compressed_2(string_table, oa_table, cell_table)
            object_arg_9: IOptionalGetter = get.Optional
            return object_arg_9.Field("DataMap", arg_19)

        def _arrow3105(__unit: None=None) -> Array[str] | None:
            arg_21: Decoder_1[Array[str]] = resize_array(string)
            object_arg_10: IOptionalGetter = get.Optional
            return object_arg_10.Field("RegisteredAssayIdentifiers", arg_21)

        def _arrow3106(__unit: None=None) -> Array[Comment] | None:
            arg_23: Decoder_1[Array[Comment]] = resize_array(decoder_6)
            object_arg_11: IOptionalGetter = get.Optional
            return object_arg_11.Field("Comments", arg_23)

        return ArcStudy(_arrow3094(), _arrow3095(), _arrow3096(), _arrow3098(), _arrow3099(), _arrow3100(), _arrow3101(), _arrow3102(), _arrow3103(), _arrow3104(), _arrow3105(), _arrow3106())

    return object(_arrow3107)
...
def ROCrate_encoder(assays: FSharpList[ArcAssay] | None, s: ArcStudy) -> IEncodable:
    ...
    def _arrow3115(__unit: None=None, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3117(value_4: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3119(value_6: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3121(value_8: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3122(oa: OntologyAnnotation, assays: Any=assays, s: Any=s) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa)

    def _arrow3124(value_10: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3126(value_12: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3127(oa_1: Publication, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_1(oa_1)

    def _arrow3128(oa_2: Person, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_2(oa_2)

    def _arrow3130(__unit: None=None, assays: Any=assays, s: Any=s) -> Callable[[Process], IEncodable]:
        study_name: str | None = s.Identifier
        def _arrow3129(oa_3: Process) -> IEncodable:
            return ROCrate_encoder_3(study_name, None, oa_3)

        return _arrow3129

    def _arrow3132(__unit: None=None, assays: Any=assays, s: Any=s) -> Callable[[ArcAssay], IEncodable]:
        study_name_1: str | None = s.Identifier
        def _arrow3131(a_1: ArcAssay) -> IEncodable:
            return ROCrate_encoder_4(study_name_1, a_1)

        return _arrow3131

    def _arrow3133(oa_4: Data, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_5(oa_4)

    def _arrow3134(comment: Comment, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_6(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow3111()), ("@type", list_1_1(singleton(ObjectExpr3112()))), ("additionalType", ObjectExpr3113()), ("identifier", _arrow3115()), try_include("filename", _arrow3117, file_name), try_include("title", _arrow3119, s.Title), try_include("description", _arrow3121, s.Description), try_include_seq("studyDesignDescriptors", _arrow3122, s.StudyDesignDescriptors), try_include("submissionDate", _arrow3124, s.SubmissionDate), try_include("publicReleaseDate", _arrow3126, s.PublicReleaseDate), try_include_seq("publications", _arrow3127, s.Publications), try_include_seq("people", _arrow3128, s.Contacts), try_include_list("processSequence", _arrow3130(), processes), try_include_seq("assays", _arrow3132(), assays_1), try_include_list("dataFiles", _arrow3133, get_data(processes)), try_include_seq("comments", _arrow3134, s.Comments), ("@context", context_jsonvalue)]))
...
def _arrow3146(get: IGetters) -> tuple[ArcStudy, FSharpList[ArcAssay]]:
    def _arrow3136(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("filename", string)

    identifier: str = default_arg(bind(Study_tryIdentifierFromFileName, _arrow3136()), create_missing_identifier())
    ...
    def _arrow3137(__unit: None=None) -> FSharpList[Process] | None:
        arg_6: Decoder_1[FSharpList[Process]] = list_1_2(ROCrate_decoder_2)
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("processSequence", arg_6)

    tables: Array[ArcTable] | None = map(mapping_2, _arrow3137())
    def _arrow3138(__unit: None=None) -> str | None:
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("title", string)

    def _arrow3139(__unit: None=None) -> str | None:
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("description", string)

    def _arrow3140(__unit: None=None) -> str | None:
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("submissionDate", string)

    def _arrow3141(__unit: None=None) -> str | None:
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("publicReleaseDate", string)

    def _arrow3142(__unit: None=None) -> Array[Publication] | None:
    ...
    def _arrow3144(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    return (ArcStudy(identifier, _arrow3138(), _arrow3139(), _arrow3140(), _arrow3141(), _arrow3142(), _arrow3143(), _arrow3144(), tables, None, assay_identifiers, _arrow3145()), default_arg(assays, empty()))


ROCrate_decoder: Decoder_1[tuple[ArcStudy, FSharpList[ArcAssay]]] = object(_arrow3146)
...
def ISAJson_encoder(id_map: Any | None, assays: FSharpList[ArcAssay] | None, s: ArcStudy) -> IEncodable:
    def f(s_1: ArcStudy, id_map: Any=id_map, assays: Any=assays, s: Any=s) -> IEncodable:
        ...
        def _arrow3148(ps: FSharpList[Process], s_1: Any=s_1) -> IEncodable:
            return encoder_12(id_map, ps)

        encoded_materials: tuple[str, IEncodable | None] = try_include("materials", _arrow3148, Option_fromValueWithDefault(empty(), processes))
        encoded_protocols: tuple[str, IEncodable | None]
        value_5: FSharpList[Protocol] = get_protocols(processes)
        def _arrow3150(__unit: None=None, s_1: Any=s_1) -> Callable[[Protocol], IEncodable]:
            study_name: str | None = s_1.Identifier
            def _arrow3149(oa_1: Protocol) -> IEncodable:
                return ISAJson_encoder_1(study_name, None, None, id_map, oa_1)

            return _arrow3149

        encoded_protocols = try_include_list("protocols", _arrow3150(), value_5)
        ...
        def _arrow3155(__unit: None=None, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3160(value_9: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3162(value_11: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3164(value_13: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3166(value_15: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3167(oa_2: Publication, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, oa_2)

        def _arrow3168(person_2: Person, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, person_2)

        def _arrow3169(oa_3: OntologyAnnotation, s_1: Any=s_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_3)

        def _arrow3171(__unit: None=None, s_1: Any=s_1) -> Callable[[Process], IEncodable]:
            study_name_1: str | None = s_1.Identifier
            def _arrow3170(oa_4: Process) -> IEncodable:
                return ISAJson_encoder_4(study_name_1, None, id_map, oa_4)

            return _arrow3170

        def _arrow3173(__unit: None=None, s_1: Any=s_1) -> Callable[[ArcAssay], IEncodable]:
            study_name_2: str | None = s_1.Identifier
            def _arrow3172(a_2: ArcAssay) -> IEncodable:
                return ISAJson_encoder_5(study_name_2, id_map, a_2)

            return _arrow3172

        def _arrow3174(comment: Comment, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_6(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow3155()), ("filename", ObjectExpr3156()), ("identifier", _arrow3158()), try_include("title", _arrow3160, study.Title), try_include("description", _arrow3162, study.Description), try_include("submissionDate", _arrow3164, study.SubmissionDate), try_include("publicReleaseDate", _arrow3166, study.PublicReleaseDate), try_include_seq("publications", _arrow3167, study.Publications), try_include_seq("people", _arrow3168, study.Contacts), try_include_seq("studyDesignDescriptors", _arrow3169, study.StudyDesignDescriptors), encoded_protocols, encoded_materials, try_include_list("processSequence", _arrow3171(), processes), try_include_seq("assays", _arrow3173(), assays_1), encoded_factors, encoded_characteristics, encoded_units, try_include_seq("comments", _arrow3174, study.Comments)]))
    ...
    if id_map is not None:
        def _arrow3176(s_2: ArcStudy, id_map: Any=id_map, assays: Any=assays, s: Any=s) -> str:
            return ROCrate_genID(s_2)

        return encode(_arrow3176, f, s, id_map)
...
def _arrow3187(get: IGetters) -> tuple[ArcStudy, FSharpList[ArcAssay]]:
    def _arrow3177(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("identifier", string)
    ...
    def def_thunk(__unit: None=None) -> str:
        ...
        return default_arg(bind(Study_tryIdentifierFromFileName, _arrow3178()), create_missing_identifier())

    identifier: str = default_arg_with(_arrow3177(), def_thunk)
    ...
    def _arrow3184(__unit: None=None) -> Array[Publication] | None:
        arg_21: Decoder_1[Array[Publication]] = resize_array(ISAJson_decoder_4)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("publications", arg_21)

    def _arrow3185(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    def _arrow3186(__unit: None=None) -> Array[Comment] | None:
        arg_25: Decoder_1[Array[Comment]] = resize_array(ISAJson_decoder_5)
        object_arg_11: IOptionalGetter = get.Optional
        return object_arg_11.Field("comments", arg_25)

    return (ArcStudy(identifier, _arrow3180(), _arrow3181(), _arrow3182(), _arrow3183(), _arrow3184(), None if (len(persons) == 0) else persons, _arrow3185(), tables, None, assay_identifiers, _arrow3186()), default_arg(assays, empty()))


ISAJson_decoder: Decoder_1[tuple[ArcStudy, FSharpList[ArcAssay]]] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow3187)
