...
def _arrow2393(get: IGetters) -> str:
    object_arg: IRequiredGetter = get.Required
    return object_arg.Field("name", string)


ROCrate_Affiliation_decoder: Decoder_1[str] = object(_arrow2393)
...
def ROCrate_encoder(oa: Person) -> IEncodable:
    ...
    def _arrow2402(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2407(value_2: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2410(value_4: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2415(value_6: str, oa: Any=oa) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2402()), ("@type", ObjectExpr2403()), try_include("orcid", _arrow2407, oa.ORCID), try_include("firstName", _arrow2410, oa.FirstName), try_include("lastName", _arrow2415, oa.LastName), try_include("midInitials", _arrow2418, oa.MidInitials), try_include("email", _arrow2420, oa.EMail), try_include("phone", _arrow2422, oa.Phone), try_include("fax", _arrow2424, oa.Fax), try_include("address", _arrow2426, oa.Address), try_include("affiliation", _arrow2427, oa.Affiliation), try_include_seq("roles", _arrow2428, oa.Roles), try_include_seq("comments", _arrow2429, oa.Comments), ("@context", context_jsonvalue_1)]))
...
def _arrow2456(get: IGetters) -> str:
    def _arrow2455(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("name", string)

    return default_arg(_arrow2455(), "")


ROCrate_decodeAuthorListString: Decoder_1[str] = map_3(ctor, array_3(object(_arrow2456)))
