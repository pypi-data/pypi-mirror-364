...
def _arrow2663(Item_1: Sample) -> ProcessInput:
    return ProcessInput(1, Item_1)


def _arrow2664(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow2665(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ISAJson_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2662, ISAJson_decoder_1), map(_arrow2663, ISAJson_decoder_2), map(_arrow2664, ISAJson_decoder_3), map(_arrow2665, ISAJson_decoder_4)]))
