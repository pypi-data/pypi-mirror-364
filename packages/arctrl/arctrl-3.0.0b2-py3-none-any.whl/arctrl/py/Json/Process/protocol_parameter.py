...
def encoder(id_map: Any | None, value: ProtocolParameter) -> IEncodable:
    def f(value_1: ProtocolParameter, id_map: Any=id_map, value: Any=value) -> IEncodable:
        ...
        def _arrow2451(value_2: str, value_1: Any=value_1) -> IEncodable:
        ...
        def _arrow2452(oa: OntologyAnnotation, value_1: Any=value_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2451, gen_id(value_1)), try_include("parameterName", _arrow2452, value_1.ParameterName)]))
    ...
    if id_map is not None:
        def _arrow2457(p_1: ProtocolParameter, id_map: Any=id_map, value: Any=value) -> str:
            return gen_id(p_1)

        return encode(_arrow2457, f, value, id_map)
...
def _arrow2459(get: IGetters) -> ProtocolParameter:
    ...
    return ProtocolParameter(None, _arrow2458())


decoder: Decoder_1[ProtocolParameter] = object(_arrow2459)
