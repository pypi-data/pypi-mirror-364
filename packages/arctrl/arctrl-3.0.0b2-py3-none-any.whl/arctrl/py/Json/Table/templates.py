...
def _arrow2808(arg: Organisation) -> IEncodable:
...
Template_Organisation_encoder: Callable[[Organisation], IEncodable] = _arrow2808
...
def Template_encoder(template: Template) -> IEncodable:
    def _arrow2810(__unit: None=None, template: Any=template) -> IEncodable:
        value_1: str
    ...
    def _arrow2814(__unit: None=None, template: Any=template) -> IEncodable:
    ...
    def _arrow2817(__unit: None=None, template: Any=template) -> IEncodable:
    ...
    def _arrow2819(__unit: None=None, template: Any=template) -> IEncodable:
    ...
    values_3: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("id", _arrow2810()), ("table", encoder(template.Table)), ("name", _arrow2814()), ("description", _arrow2817()), ("organisation", Template_Organisation_encoder(template.Organisation)), ("version", _arrow2819()), ("authors", seq(map(mapping, template.Authors))), ("endpoint_repositories", seq(map(mapping_1, template.EndpointRepositories))), ("tags", seq(map(mapping_2, template.Tags))), ("last_updated", date_time(template.LastUpdated))])
...
def _arrow2856(get: IGetters) -> Template:
    ...
    def _arrow2842(__unit: None=None) -> Organisation:
    ...
    def _arrow2848(__unit: None=None) -> Array[Person] | None:
    ...
    def _arrow2854(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    def _arrow2855(__unit: None=None) -> Any:
        object_arg_9: IRequiredGetter = get.Required
        return object_arg_9.Field("last_updated", Decode_datetime)

    return Template.create(_arrow2834(), _arrow2838(), _arrow2839(), _arrow2840(), _arrow2842(), _arrow2845(), _arrow2848(), _arrow2851(), _arrow2854(), _arrow2855())


Template_decoder: Decoder_1[Template] = object(_arrow2856)

def Template_encoderCompressed(string_table: Any, oa_table: Any, cell_table: Any, template: Template) -> IEncodable:
    def _arrow2860(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, template: Any=template) -> IEncodable:
        value_1: str
        copy_of_struct: str = template.Id
        value_1 = str(copy_of_struct)
    ...
    def _arrow2866(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, template: Any=template) -> IEncodable:
        value_4: str = template.Description
    ...
    def _arrow2881(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, template: Any=template) -> IEncodable:
    ...
    values_3: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("id", _arrow2860()), ("table", encoder_compressed(string_table, oa_table, cell_table, template.Table)), ("name", _arrow2863()), ("description", _arrow2866()), ("organisation", Template_Organisation_encoder(template.Organisation)), ("version", _arrow2870()), ("authors", seq(map(mapping, template.Authors))), ("endpoint_repositories", seq(map(mapping_1, template.EndpointRepositories))), ("tags", seq(map(mapping_2, template.Tags))), ("last_updated", _arrow2881())])
...
def Template_decoderCompressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[Template]:
    def _arrow2898(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> Template:
        def _arrow2885(__unit: None=None) -> str:
            object_arg: IRequiredGetter = get.Required
            return object_arg.Field("id", guid)

        def _arrow2886(__unit: None=None) -> ArcTable:
        ...
        def _arrow2888(__unit: None=None) -> str:
            object_arg_3: IRequiredGetter = get.Required
            return object_arg_3.Field("description", string)

        def _arrow2889(__unit: None=None) -> Organisation:
            object_arg_4: IRequiredGetter = get.Required
            return object_arg_4.Field("organisation", Template_Organisation_decoder)
        ...
        def _arrow2896(__unit: None=None) -> Array[OntologyAnnotation] | None:
            arg_17: Decoder_1[Array[OntologyAnnotation]] = resize_array(OntologyAnnotation_decoder)
            object_arg_8: IOptionalGetter = get.Optional
            return object_arg_8.Field("tags", arg_17)

        def _arrow2897(__unit: None=None) -> Any:
            object_arg_9: IRequiredGetter = get.Required
            return object_arg_9.Field("last_updated", datetime_local)

        return Template.create(_arrow2885(), _arrow2886(), _arrow2887(), _arrow2888(), _arrow2889(), _arrow2890(), _arrow2892(), _arrow2894(), _arrow2896(), _arrow2897())
