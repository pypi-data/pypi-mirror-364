...
class ObjectExpr336(IDecoderHelpers_1[Any]):
...
Decode_helpers: IDecoderHelpers_1[Any] = ObjectExpr336()

def Decode_fromValue(decoder: Decoder_1[Any]) -> Callable[[Any], FSharpResult_2[_T, str]]:
    def _arrow340(value: Any=None, decoder: Any=decoder) -> FSharpResult_2[_T, str]:
