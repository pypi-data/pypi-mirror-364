...
class Getter:
    def __init__(self, ele: YAMLElement) -> None:
        def _arrow456(__unit: None=None) -> IRequiredGetter:
            _this: Any = self
            class ObjectExpr455(IRequiredGetter):
        ...
        self.required: IRequiredGetter = _arrow456()
        ...
        def _arrow464(__unit: None=None) -> IOverflowGetter:
            _this_3: Any = self
            class ObjectExpr463(IOverflowGetter):
        ...
        self.overflow: IOverflowGetter = _arrow464()
