...
class AppModelDeviceDevice2(BaseModel):
    """
    AppModelDeviceDevice2
    """ # noqa: E501
    report: Optional[ComplianceReportInput] = None
    tags: Optional[List[StrictStr]] = None
    platform: Optional[Annotated[str, Field(strict=True)]] = None
    ipaddress: Optional[Annotated[str, Field(min_length=2, strict=True, max_length=254)]] = None
    ...
    __properties: ClassVar[List[str]] = ["report", "tags", "platform", "ipaddress", "vault", "licensed", "tenant_id", "exclude", "agent_id", "firmware", "os_version", "name", "port"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AppModelDeviceDevice2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AppModelDeviceDevice2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "report": ComplianceReportInput.from_dict(obj["report"]) if obj.get("report") is not None else None,
            "tags": obj.get("tags"),
