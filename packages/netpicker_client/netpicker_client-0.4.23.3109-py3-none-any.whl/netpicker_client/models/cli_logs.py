...
class CliLogs(BaseModel):
    """
    CliLogs
    """ # noqa: E501
    logs: Optional[List[CliLog]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CliLogs from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CliLogs from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "logs": [CliLog.from_dict(_item) for _item in obj["logs"]] if obj.get("logs") is not None else None
        })
        return _obj
