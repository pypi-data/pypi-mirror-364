...
class AppModelDeviceDevice1(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "ipaddress", "port", "name", "platform", "vault", "tags", "exclude", "licensed", "firmware", "report", "agent_id", "os_version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AppModelDeviceDevice1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AppModelDeviceDevice1 from a dict"""
        if obj is None:
            return None
