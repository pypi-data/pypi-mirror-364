...
class DeviceConfigBase(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "device_id", "upload_date", "upload_agent", "file_size", "digest", "commit", "data", "readout_error", "os_version", "initiator", "extras"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeviceConfigBase from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeviceConfigBase from a dict"""
        if obj is None:
            return None
