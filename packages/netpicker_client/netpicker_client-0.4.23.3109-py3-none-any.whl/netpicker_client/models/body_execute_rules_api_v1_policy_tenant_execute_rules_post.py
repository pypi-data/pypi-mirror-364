...
class BodyExecuteRulesApiV1PolicyTenantExecuteRulesPost(BaseModel):
    """
    BodyExecuteRulesApiV1PolicyTenantExecuteRulesPost
    """ # noqa: E501
    devices: Optional[List[StrictStr]] = None
    policies: Optional[List[StrictStr]] = None
    rules: Optional[List[StrictStr]] = None
    tags: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["devices", "policies", "rules", "tags"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BodyExecuteRulesApiV1PolicyTenantExecuteRulesPost from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BodyExecuteRulesApiV1PolicyTenantExecuteRulesPost from a dict"""
        if obj is None:
            return None
