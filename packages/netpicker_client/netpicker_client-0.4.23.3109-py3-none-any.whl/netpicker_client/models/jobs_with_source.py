...
class JobsWithSource(BaseModel):
    """
    JobsWithSource
    """ # noqa: E501
    jobs: Optional[List[Job]] = None
    sources: Optional[Dict[str, StrictStr]] = None
    __properties: ClassVar[List[str]] = ["jobs", "sources"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JobsWithSource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JobsWithSource from a dict"""
        if obj is None:
            return None
