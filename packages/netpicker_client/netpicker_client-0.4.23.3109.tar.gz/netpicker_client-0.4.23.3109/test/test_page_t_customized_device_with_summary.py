...
class TestPageTCustomizedDeviceWithSummary(unittest.TestCase):
    """PageTCustomizedDeviceWithSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageTCustomizedDeviceWithSummary:
        """Test PageTCustomizedDeviceWithSummary
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageTCustomizedDeviceWithSummary`
        """
        model = PageTCustomizedDeviceWithSummary()
        if include_optional:
            return PageTCustomizedDeviceWithSummary(
                items = [
                    netpicker_client.models.device_with_summary.DeviceWithSummary(
                        id = '', 
                        tenant_id = 56, 
    ...
    def testPageTCustomizedDeviceWithSummary(self):
        """Test PageTCustomizedDeviceWithSummary"""
