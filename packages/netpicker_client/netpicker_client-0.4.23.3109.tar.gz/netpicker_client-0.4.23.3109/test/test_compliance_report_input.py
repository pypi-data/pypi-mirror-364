...
class TestComplianceReportInput(unittest.TestCase):
    """ComplianceReportInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComplianceReportInput:
        """Test ComplianceReportInput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ComplianceReportInput`
        """
        model = ComplianceReportInput()
        if include_optional:
    ...
    def testComplianceReportInput(self):
        """Test ComplianceReportInput"""
