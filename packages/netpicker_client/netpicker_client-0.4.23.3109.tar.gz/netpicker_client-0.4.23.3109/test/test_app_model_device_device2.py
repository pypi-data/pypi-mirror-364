...
class TestAppModelDeviceDevice2(unittest.TestCase):
    """AppModelDeviceDevice2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppModelDeviceDevice2:
        """Test AppModelDeviceDevice2
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppModelDeviceDevice2`
        """
        model = AppModelDeviceDevice2()
        if include_optional:
            return AppModelDeviceDevice2(
    ...
    def testAppModelDeviceDevice2(self):
        """Test AppModelDeviceDevice2"""
