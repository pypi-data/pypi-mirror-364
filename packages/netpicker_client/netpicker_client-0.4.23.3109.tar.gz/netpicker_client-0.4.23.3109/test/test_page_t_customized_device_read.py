...
class TestPageTCustomizedDeviceRead(unittest.TestCase):
    """PageTCustomizedDeviceRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageTCustomizedDeviceRead:
        """Test PageTCustomizedDeviceRead
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageTCustomizedDeviceRead`
        """
        model = PageTCustomizedDeviceRead()
        if include_optional:
            return PageTCustomizedDeviceRead(
                items = [
                    netpicker_client.models.device_read.DeviceRead(
                        id = '', 
                        tenant_id = 56, 
    ...
    def testPageTCustomizedDeviceRead(self):
        """Test PageTCustomizedDeviceRead"""
