...
class TestDeviceWithSummary(unittest.TestCase):
    """DeviceWithSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceWithSummary:
        """Test DeviceWithSummary
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceWithSummary`
        """
        model = DeviceWithSummary()
        if include_optional:
            return DeviceWithSummary(
                id = '',
                tenant_id = 56,
    ...
    def testDeviceWithSummary(self):
        """Test DeviceWithSummary"""
