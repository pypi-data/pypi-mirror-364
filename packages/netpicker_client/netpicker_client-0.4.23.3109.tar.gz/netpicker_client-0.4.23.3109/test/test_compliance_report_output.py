...
class TestComplianceReportOutput(unittest.TestCase):
    """ComplianceReportOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComplianceReportOutput:
        """Test ComplianceReportOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ComplianceReportOutput`
        """
        model = ComplianceReportOutput()
        if include_optional:
            return ComplianceReportOutput(
    ...
    def testComplianceReportOutput(self):
        """Test ComplianceReportOutput"""
