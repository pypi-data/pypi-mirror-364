...
class TestDeviceWithConfig(unittest.TestCase):
    """DeviceWithConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceWithConfig:
        """Test DeviceWithConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceWithConfig`
        """
        model = DeviceWithConfig()
        if include_optional:
            return DeviceWithConfig(
                id = '',
                tenant_id = 56,
