...
class TestAppModelDeviceDevice1(unittest.TestCase):
    """AppModelDeviceDevice1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppModelDeviceDevice1:
        """Test AppModelDeviceDevice1
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppModelDeviceDevice1`
        """
        model = AppModelDeviceDevice1()
        if include_optional:
            return AppModelDeviceDevice1(
                id = '',
    ...
    def testAppModelDeviceDevice1(self):
        """Test AppModelDeviceDevice1"""
