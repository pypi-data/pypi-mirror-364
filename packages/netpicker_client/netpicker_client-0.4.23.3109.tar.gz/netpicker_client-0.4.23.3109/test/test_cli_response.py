...
class TestCliResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CliResponse:
        """Test CliResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CliResponse`
        """
        model = CliResponse()
        if include_optional:
            return CliResponse(
