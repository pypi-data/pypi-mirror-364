...
class TestComplianceLogInput(unittest.TestCase):
    """ComplianceLogInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComplianceLogInput:
        """Test ComplianceLogInput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ComplianceLogInput`
        """
        model = ComplianceLogInput()
        if include_optional:
            return ComplianceLogInput(
                outcome = 'SUCCESS',
                rule_name = '',
                rule_id = '',
    ...
    def testComplianceLogInput(self):
        """Test ComplianceLogInput"""
