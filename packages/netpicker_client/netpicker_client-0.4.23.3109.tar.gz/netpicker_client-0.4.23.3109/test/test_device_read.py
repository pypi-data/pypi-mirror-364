...
class TestDeviceRead(unittest.TestCase):
    """DeviceRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceRead:
        """Test DeviceRead
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceRead`
        """
        model = DeviceRead()
        if include_optional:
            return DeviceRead(
