...
class TestSimpleRule(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SimpleRule:
        """Test SimpleRule
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleRule`
        """
        model = SimpleRule()
        if include_optional:
            return SimpleRule(
