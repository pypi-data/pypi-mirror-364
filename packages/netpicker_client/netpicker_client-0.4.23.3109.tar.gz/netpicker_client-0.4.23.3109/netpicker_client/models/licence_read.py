...
class LicenceRead(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "licensee", "volume", "valid_till", "revoked", "features"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LicenceRead from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LicenceRead from a dict"""
        if obj is None:
            return None
