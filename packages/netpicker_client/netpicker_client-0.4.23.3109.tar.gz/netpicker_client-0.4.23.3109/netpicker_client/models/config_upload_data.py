...
class ConfigUploadData(BaseModel):
    """
    ConfigUploadData
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["commands", "variables", "success", "error", "context", "initiator", "log"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigUploadData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigUploadData from a dict"""
        if obj is None:
            return None
