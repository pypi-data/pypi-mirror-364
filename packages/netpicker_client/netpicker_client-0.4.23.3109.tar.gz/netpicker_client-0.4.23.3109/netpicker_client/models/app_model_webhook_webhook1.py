...
class AppModelWebhookWebhook1(BaseModel):
    """
    AppModelWebhookWebhook1
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "enabled", "events", "method", "url", "headers", "template"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AppModelWebhookWebhook1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AppModelWebhookWebhook1 from a dict"""
        if obj is None:
            return None
