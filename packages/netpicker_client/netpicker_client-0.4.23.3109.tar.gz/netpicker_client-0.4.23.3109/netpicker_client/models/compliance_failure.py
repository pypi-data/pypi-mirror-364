...
class ComplianceFailure(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ipaddress", "executed", "summary"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if executed (nullable) is None
        # and model_fields_set contains the field
        if self.executed is None and "executed" in self.model_fields_set:
            _dict['executed'] = None
