...
class BodyExecuteJobTestApiV1AutomationTenantDebugPost(BaseModel):
    """
    BodyExecuteJobTestApiV1AutomationTenantDebugPost
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["name", "sources", "variables", "ipaddress", "tags"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BodyExecuteJobTestApiV1AutomationTenantDebugPost from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BodyExecuteJobTestApiV1AutomationTenantDebugPost from a dict"""
        if obj is None:
            return None
