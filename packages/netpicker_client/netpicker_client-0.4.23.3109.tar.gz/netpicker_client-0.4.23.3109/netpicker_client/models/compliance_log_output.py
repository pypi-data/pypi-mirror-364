...
class ComplianceLogOutput(BaseModel):
    """
    ComplianceLogOutput
    """ # noqa: E501
    outcome: Outcome
    ...
    __properties: ClassVar[List[str]] = ["outcome", "rule_name", "rule_id", "exec_at", "exec_ns", "commit", "excinfo", "passinfo", "cli_log", "policy"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ComplianceLogOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ComplianceLogOutput from a dict"""
        if obj is None:
            return None
