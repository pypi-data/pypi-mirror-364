...
class DeviceWithConfig(BaseModel):
    """
    DeviceWithConfig
    """ # noqa: E501
    id: StrictStr
    ...
    licensed: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "tenant_id", "ipaddress", "port", "name", "platform", "vault", "tags", "exclude", "licensed", "firmware", "report", "agent_id", "os_version", "last_config"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeviceWithConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeviceWithConfig from a dict"""
        if obj is None:
            return None
