...
class QJobWithSources(BaseModel):
    """
    QJobWithSources
    """ # noqa: E501
    id: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["id", "tenant_id", "branch", "submitter", "submitted", "reviewer", "reviewed", "expires", "job_name", "job_id", "devices", "tags", "variables", "execron", "status", "sources"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QJobWithSources from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QJobWithSources from a dict"""
        if obj is None:
            return None
