...
class JobListItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "platforms", "variables", "tags", "author", "is_simple"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JobListItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JobListItem from a dict"""
        if obj is None:
            return None
