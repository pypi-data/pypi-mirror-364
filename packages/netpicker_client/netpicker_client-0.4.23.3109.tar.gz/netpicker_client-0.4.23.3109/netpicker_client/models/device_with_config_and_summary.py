...
class DeviceWithConfigAndSummary(BaseModel):
    """
    ...
    last_config: Optional[DeviceConfigBase] = None
    compliance: Optional[Outcome] = None
    summary: Optional[Dict[str, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["id", "tenant_id", "ipaddress", "port", "name", "platform", "vault", "tags", "exclude", "licensed", "firmware", "report", "agent_id", "os_version", "last_config", "compliance", "summary"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeviceWithConfigAndSummary from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of last_config
        if self.last_config:
            _dict['last_config'] = self.last_config.to_dict()
        ...
        # set to None if last_config (nullable) is None
        # and model_fields_set contains the field
        if self.last_config is None and "last_config" in self.model_fields_set:
            _dict['last_config'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeviceWithConfigAndSummary from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "last_config": DeviceConfigBase.from_dict(obj["last_config"]) if obj.get("last_config") is not None else None,
