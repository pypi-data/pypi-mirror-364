...
class JobRead(BaseModel):
    ...
    total_run_count: Optional[StrictInt] = 0
    __properties: ClassVar[List[str]] = ["crontab", "interval", "name", "task", "description", "one_off", "date_changed", "headers", "args", "kwargs", "queue", "exchange", "routing_key", "expires", "enabled", "author", "last_run_at", "total_run_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total_run_count": obj.get("total_run_count") if obj.get("total_run_count") is not None else 0
        })
        return _obj
