...
__all__ = [
    ...
    "sndio", "Faiff", "SF_FORMAT_SUBMASK", "SF_FORMAT_TYPEMASK", "SF_FORMAT_ENDMASK",
     "SfInfo", "SfFormatInfo", "SfDitherInfo", "SfEmbedFileInfo", "SfCuePoint",
     "loop_name_to_id", "loop_id_to_name", "SfInstrumentLoop", "SfInstrument",
     "SfLoopInfo", "SfBroadcastInfo", "channel_map_name_to_id",
