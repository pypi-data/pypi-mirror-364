...
class FistaTestRunner:
    def __init__(self, device_type="cuda", dtype=torch.float32, version="AUTOMATIC"):
    ...
    def run_all(self, p_list, seeds):
        ...
        filename_html = f"compute_multi_fista_solver_{self.version}_{self.device_type}_{self.dtype_map.get(self.dtype)}_{timestamp}.html".lower()
