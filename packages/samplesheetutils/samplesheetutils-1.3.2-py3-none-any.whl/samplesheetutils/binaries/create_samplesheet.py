...
def create_samplesheet():
    ...
    if mode == MODE_STRING_CSV:
        ...
        aa_sample_name = sample_name(args.aa_string.strip(), seq_chars=args.seq_chars)
        ...
        sample_data = Sample(aa_sample_name, aa_path, args.aa_string.strip())
