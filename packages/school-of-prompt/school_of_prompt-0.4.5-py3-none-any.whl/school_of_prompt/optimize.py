...
from .tasks.auto_task import create_task
...
def optimize(
    ...
    task_type: str = "generation",  # NEW: Explicit task type
    ...
    # Single dataset case - create task with explicit type
    if verbose:
        print("🎯 Setting up task...")
    task_obj = create_task(task_type, task, dataset)
