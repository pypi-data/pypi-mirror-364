...
class IrCron(models.Model):
    ...
    def _callback(self, cron_name, server_action_id, *args, **kwargs):
        ...
        span_atts = {"odoo.cron.action_id": server_action_id, "odoo.cron.manual": False}
        self.otel_instrumentor.odoo_run_cron.add(1, attributes=attrs)
        with self.otel_instrumentor.odoo_call_wrapper(self._name, "callback", attrs=attrs, span_atts=span_atts):
