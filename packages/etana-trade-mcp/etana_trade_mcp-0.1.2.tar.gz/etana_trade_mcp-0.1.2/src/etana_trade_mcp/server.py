...
mcp = FastMCP("etana_trade_mcp")

config = json.load(open("./src/etana_trade_mcp/config.json"))
...
@mcp.tool()
async def get_userid_by_name(name: str) -> str:
...
@mcp.tool()
async def get_accounts_by_name(userId: str) -> str:
