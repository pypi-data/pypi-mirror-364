...
class Entity(Annotation):
    ...
    @staticmethod
    def next(sentence: List[Annotation], object: Entity) -> Entity:
        """Get the next Entity in the sentence.

        Args:
            sentence (List[Annotation]): The list of annotations in the sentence.
            object (Entity): The current object.

        Returns:
            Entity: The next Entity.

        Raises:
            ErrorAnnotationNotFound: If no next entity is found.
        """
    ...
    @staticmethod
    def prev(sentence: List[Annotation], object: Entity) -> Entity:
        ...
        Returns:
            Entity: The previous Entity.

        Raises:
            ErrorAnnotationNotFound: If no previous entity is found.
        """
        index = object.index - 1
        while index >= 0:
            if sentence[index].is_concept:
