...
class Token(Annotation):
    ...
    @staticmethod
    def next(sentence, object: Token) -> Token:
        ...
        Returns:
            Token: The next token in the sentence.

        Raises:
            ErrorAnnotationNotFound: If no next token is found.
        """
    ...
    @staticmethod
    def prev(sentence, object: Entity | Token) -> Token:
        ...
        Returns:
            Token: The previous token in the sentence.

        Raises:
            ErrorAnnotationNotFound: If no previous token is found.
        """
        index = object.index - 1
        while index >= 0:
            if sentence[index].is_token:
