...
class TestResource(SyncAPIResource):
    ...
    def cite_image(
        ...
        *,
        ...
        return self._post(
            "/api/v1/chat/test/image-citation",
...
class TestResourceWithRawResponse:
    ...
    def __init__(self, test: TestResource) -> None:
        ...
        self.cite_image = to_raw_response_wrapper(
            test.cite_image,
        )
...
class AsyncTestResourceWithRawResponse:
    def __init__(self, test: AsyncTestResource) -> None:
        ...
        self.cite_image = async_to_raw_response_wrapper(
            test.cite_image,
        )
...
class TestResourceWithStreamingResponse:
    ...
    def __init__(self, test: TestResource) -> None:
        ...
        self.cite_image = to_streamed_response_wrapper(
            test.cite_image,
        )
...
class AsyncTestResourceWithStreamingResponse:
    def __init__(self, test: AsyncTestResource) -> None:
        ...
        self.cite_image = async_to_streamed_response_wrapper(
            test.cite_image,
        )
