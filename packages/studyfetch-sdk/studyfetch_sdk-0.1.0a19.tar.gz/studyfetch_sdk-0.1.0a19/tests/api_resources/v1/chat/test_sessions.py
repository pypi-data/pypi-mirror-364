...
class TestSessions:
    ...
    def test_method_create(self, client: StudyfetchSDK) -> None:
        session = client.v1.chat.sessions.create()
        assert session is None

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_create(self, client: StudyfetchSDK) -> None:
        response = client.v1.chat.sessions.with_raw_response.create()
    ...
    def test_streaming_response_create(self, client: StudyfetchSDK) -> None:
        with client.v1.chat.sessions.with_streaming_response.create() as response:
    ...
    def test_method_retrieve(self, client: StudyfetchSDK) -> None:
        session = client.v1.chat.sessions.retrieve(
            user_id="userId",
            limit="limit",
        )
        assert session is None
    ...
    def test_raw_response_retrieve(self, client: StudyfetchSDK) -> None:
        response = client.v1.chat.sessions.with_raw_response.retrieve(
            user_id="userId",
            limit="limit",
        )
    ...
    def test_streaming_response_retrieve(self, client: StudyfetchSDK) -> None:
        with client.v1.chat.sessions.with_streaming_response.retrieve(
            user_id="userId",
            limit="limit",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_retrieve(self, client: StudyfetchSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `user_id` but received ''"):
            client.v1.chat.sessions.with_raw_response.retrieve(
                user_id="",
                limit="limit",
            )
...
class TestAsyncSessions:
    ...
    async def test_method_create(self, async_client: AsyncStudyfetchSDK) -> None:
        session = await async_client.v1.chat.sessions.create()
        assert session is None

    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_create(self, async_client: AsyncStudyfetchSDK) -> None:
        response = await async_client.v1.chat.sessions.with_raw_response.create()
    ...
    async def test_streaming_response_create(self, async_client: AsyncStudyfetchSDK) -> None:
        async with async_client.v1.chat.sessions.with_streaming_response.create() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_retrieve(self, async_client: AsyncStudyfetchSDK) -> None:
        session = await async_client.v1.chat.sessions.retrieve(
            user_id="userId",
            limit="limit",
        )
        assert session is None
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncStudyfetchSDK) -> None:
        response = await async_client.v1.chat.sessions.with_raw_response.retrieve(
            user_id="userId",
            limit="limit",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncStudyfetchSDK) -> None:
        async with async_client.v1.chat.sessions.with_streaming_response.retrieve(
            user_id="userId",
            limit="limit",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve(self, async_client: AsyncStudyfetchSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `user_id` but received ''"):
            await async_client.v1.chat.sessions.with_raw_response.retrieve(
                user_id="",
                limit="limit",
            )
