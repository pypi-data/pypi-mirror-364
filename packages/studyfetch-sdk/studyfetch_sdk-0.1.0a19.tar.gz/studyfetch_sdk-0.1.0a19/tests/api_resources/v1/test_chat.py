...
class TestChat:
    ...
    def test_method_get_history(self, client: StudyfetchSDK) -> None:
        chat = client.v1.chat.get_history()
        assert chat is None

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_get_history(self, client: StudyfetchSDK) -> None:
        response = client.v1.chat.with_raw_response.get_history()
    ...
    def test_streaming_response_get_history(self, client: StudyfetchSDK) -> None:
        with client.v1.chat.with_streaming_response.get_history() as response:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_get_session(self, client: StudyfetchSDK) -> None:
        chat = client.v1.chat.get_session(
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_get_session(self, client: StudyfetchSDK) -> None:
        response = client.v1.chat.with_raw_response.get_session(
            session_id="sessionId",
            user_id="userId",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_get_session(self, client: StudyfetchSDK) -> None:
        with client.v1.chat.with_streaming_response.get_session(
            session_id="sessionId",
            user_id="userId",
        ) as response:
            assert not response.is_closed
    ...
    @pytest.mark.skip()
    @parametrize
    def test_path_params_get_session(self, client: StudyfetchSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `session_id` but received ''"):
            client.v1.chat.with_raw_response.get_session(
                session_id="",
                user_id="userId",
            )
    ...
    def test_method_send_followups(self, client: StudyfetchSDK) -> None:
        chat = client.v1.chat.send_followups()
        assert chat is None

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_send_followups(self, client: StudyfetchSDK) -> None:
        response = client.v1.chat.with_raw_response.send_followups()
    ...
    def test_streaming_response_send_followups(self, client: StudyfetchSDK) -> None:
        with client.v1.chat.with_streaming_response.send_followups() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_send_message(self, client: StudyfetchSDK) -> None:
        chat = client.v1.chat.send_message(
    ...
    def test_raw_response_send_message(self, client: StudyfetchSDK) -> None:
        response = client.v1.chat.with_raw_response.send_message(
            component_id="componentId",
            message={},
            x_component_id="x-component-id",
        )
    ...
    def test_streaming_response_send_message(self, client: StudyfetchSDK) -> None:
        with client.v1.chat.with_streaming_response.send_message(
            component_id="componentId",
            message={},
            x_component_id="x-component-id",
        ) as response:
...
class TestAsyncChat:
    ...
    async def test_method_get_history(self, async_client: AsyncStudyfetchSDK) -> None:
        chat = await async_client.v1.chat.get_history()
        assert chat is None

    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_get_history(self, async_client: AsyncStudyfetchSDK) -> None:
        response = await async_client.v1.chat.with_raw_response.get_history()
    ...
    async def test_streaming_response_get_history(self, async_client: AsyncStudyfetchSDK) -> None:
        async with async_client.v1.chat.with_streaming_response.get_history() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_get_session(self, async_client: AsyncStudyfetchSDK) -> None:
        chat = await async_client.v1.chat.get_session(
            session_id="sessionId",
            user_id="userId",
        )
        assert chat is None
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_get_session(self, async_client: AsyncStudyfetchSDK) -> None:
        response = await async_client.v1.chat.with_raw_response.get_session(
            session_id="sessionId",
            user_id="userId",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_get_session(self, async_client: AsyncStudyfetchSDK) -> None:
        async with async_client.v1.chat.with_streaming_response.get_session(
            session_id="sessionId",
            user_id="userId",
        ) as response:
            assert not response.is_closed
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_path_params_get_session(self, async_client: AsyncStudyfetchSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `session_id` but received ''"):
            await async_client.v1.chat.with_raw_response.get_session(
                session_id="",
                user_id="userId",
            )
    ...
    async def test_method_send_followups(self, async_client: AsyncStudyfetchSDK) -> None:
        chat = await async_client.v1.chat.send_followups()
        assert chat is None

    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_send_followups(self, async_client: AsyncStudyfetchSDK) -> None:
        response = await async_client.v1.chat.with_raw_response.send_followups()
    ...
    async def test_streaming_response_send_followups(self, async_client: AsyncStudyfetchSDK) -> None:
        async with async_client.v1.chat.with_streaming_response.send_followups() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_send_message(self, async_client: AsyncStudyfetchSDK) -> None:
        chat = await async_client.v1.chat.send_message(
            component_id="componentId",
            message={},
            x_component_id="x-component-id",
        )
    ...
    async def test_raw_response_send_message(self, async_client: AsyncStudyfetchSDK) -> None:
        response = await async_client.v1.chat.with_raw_response.send_message(
            component_id="componentId",
            message={},
            x_component_id="x-component-id",
        )
    ...
    async def test_streaming_response_send_message(self, async_client: AsyncStudyfetchSDK) -> None:
        async with async_client.v1.chat.with_streaming_response.send_message(
            component_id="componentId",
            message={},
            x_component_id="x-component-id",
        ) as response:
