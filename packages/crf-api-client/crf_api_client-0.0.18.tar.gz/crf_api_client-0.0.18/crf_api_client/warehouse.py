# ruff: noqa: ANN003, D105, PLW2901, RET504, PLR2004, EM102, G004
...
class Warehouse(BaseAPIClient):
    ...
    def retrieve_with_graph_search(
        ...
        if not indexes:
            indexes = ["chunks"]
        response = requests.post(
            f"{self.base_url}/api/v1/projects/{self.warehouse_id}/retrieve-with-graph/",
            headers=self._get_headers_without_content_type(),
    ...
    def retrieve_with_full_text_search(
        ...
        if excluded_tags is None:
            excluded_tags = []
        response = requests.post(
            f"{self.base_url}/api/v1/projects/{self.warehouse_id}/retrieve-with-full-text-search/",
            headers=self._get_headers(),
            json={
                "query": query,
                "indexes": indexes,
    ...
    def retrieve_with_hybrid_search(
        ...
        if excluded_tags is None:
            excluded_tags = []
        response = requests.post(
            f"{self.base_url}/api/v1/projects/{self.warehouse_id}/retrieve-with-hybrid-search/",
            headers=self._get_headers(),
            json={
                "query": query,
                "indexes": indexes,
