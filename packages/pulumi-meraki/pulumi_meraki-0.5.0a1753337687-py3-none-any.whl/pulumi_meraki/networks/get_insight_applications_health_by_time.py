...
def get_insight_applications_health_by_time(application_id: Optional[builtins.str] = None,
    ...
    :param builtins.str application_id: applicationId path parameter. Application ID
    :param builtins.str network_id: networkId path parameter. Network ID
    :param builtins.int resolution: resolution query parameter. The time resolution in seconds for returned data. The valid resolutions are: 60, 300, 3600, 86400. The default is 300.
    :param builtins.str t0: t0 query parameter. The beginning of the timespan for the data. The maximum lookback period is 7 days from today.
...
def get_insight_applications_health_by_time_output(application_id: Optional[pulumi.Input[builtins.str]] = None,
