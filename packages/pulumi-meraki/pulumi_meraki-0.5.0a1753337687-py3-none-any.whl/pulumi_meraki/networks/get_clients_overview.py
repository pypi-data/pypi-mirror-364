...
def get_clients_overview(network_id: Optional[builtins.str] = None,
    ...
    :param builtins.int resolution: resolution query parameter. The time resolution in seconds for returned data. The valid resolutions are: 7200, 86400, 604800, 2592000. The default is 604800.
...
def get_clients_overview_output(network_id: Optional[pulumi.Input[builtins.str]] = None,
