...
class SecurityValidator:
    ...
    def _check_branch_validation(self, file_path: str) -> Optional[dict]:
    ...
    async def validate(self, tool_name: str, tool_input: dict, context: str) -> dict:
        """
    ...
    async def perform_quick_validation(self, tool_name: str, tool_input: dict) -> dict:
    ...
    async def validate_file_operation(self, tool_input: dict) -> dict:
    ...
    async def _validate_production_secrets(self, content: str) -> dict:
    ...
    async def _validate_test_secrets(self, content: str, file_path: str) -> dict:
    ...
    def _validate_minimal_secrets(self, content: str) -> dict:
    ...
    def _validate_template_files(self, content: str, file_path: str) -> dict:
    ...
    def _extract_potential_secrets(self, content: str) -> list:
    ...
    async def _llm_validate_secrets(
        self, secrets: list, file_path: str, is_test_file: bool = False
    ) -> dict:
