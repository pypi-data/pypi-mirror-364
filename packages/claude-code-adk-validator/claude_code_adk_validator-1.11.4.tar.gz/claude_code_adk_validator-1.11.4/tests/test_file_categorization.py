...
class FileCategorizationTests:
    ...
    async def assert_category(self, file_path, content, expected_category, expected_requires_tdd):
        """Assert that file is categorized correctly"""
        self.total += 1
        
        try:
            result = await self.validator.categorize_file(file_path, content)
    ...
    async def test_implementation_files(self):
        ...
        for file_path, content, expected_category, expected_requires_tdd in test_cases:
            result = await self.assert_category(file_path, content, expected_category, expected_requires_tdd)
            results.append(result)
        
        return all(results)

    async def test_test_files(self):
    ...
    async def test_structural_files(self):
    ...
    async def test_documentation_files(self):
        ...
        test_cases = [
            ...
            # Issue #55: docs/ directory files
            ("docs/GCP-SETUP-PLAN.md", "# GCP Setup Plan\n\n## Steps", "docs", False),
            ("docs/architecture.md", "# System Architecture", "docs", False),
            ("docs/deployment/guide.md", "# Deployment Guide", "docs", False),
            
            # Various README patterns
            ("README", "Project documentation", "docs", False),
            ("README.rst", "Project Title\n============", "docs", False),
            ("readme.txt", "Installation instructions", "docs", False),
            ("ReadMe.md", "# Project Info", "docs", False),
            
            # Other documentation patterns
            ("LICENSE", "MIT License", "docs", False),
            ("LICENSE.md", "# License Information", "docs", False),
            ("CONTRIBUTING.md", "# How to Contribute", "docs", False),
            ("AUTHORS", "Project Authors", "docs", False),
            ("NOTICE", "Copyright Notice", "docs", False),
            ("TODO.md", "# Project TODOs", "docs", False),
            ("INSTALL.md", "# Installation Guide", "docs", False),
            
            # Documentation in various directories
            ("documentation/api.md", "# API Reference", "docs", False),
            ("doc/user-guide.rst", "User Guide", "docs", False),
            ("notes/design.txt", "Design notes", "docs", False),
            ("wiki/page.md", "Wiki content", "docs", False),
        ]
    ...
    async def test_fallback_behavior(self):
        ...
        result = await validator_no_api.categorize_file("calculator.py", "def add(a, b):\n    return a + b")
