...
def run_validation(tool_data, timeout=60):
...
class TDDEnforcementTests:
    ...
    def assert_blocked(self, test_name, tool_data, expected_reason_fragment=""):
        ...
        if code == 2:
            ...
            if expected_reason_fragment and expected_reason_fragment.lower() not in stderr.lower():
                print(f"⚠️  WARNING: Expected '{expected_reason_fragment}' in error message")
    ...
    def test_write_implementation_without_test(self):
    ...
    def test_update_implementation_without_test(self):
    ...
    def test_update_test_file(self):
    ...
    def test_update_add_one_test_to_existing(self):
    ...
    def test_update_add_multiple_tests_to_existing(self):
    ...
    def test_edit_adds_multiple_tests(self):
    ...
    def test_edit_single_test(self):
    ...
    def test_multiedit_multiple_tests(self):
    ...
    def test_multiedit_single_test(self):
    ...
    def test_write_no_comments(self):
    ...
    def test_update_rename_test_function(self):
