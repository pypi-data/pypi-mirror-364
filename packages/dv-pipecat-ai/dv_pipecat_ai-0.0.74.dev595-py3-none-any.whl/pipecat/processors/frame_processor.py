...
class FrameProcessor(BaseObject):
    ...
    async def __input_frame_task_handler(self):
        while True:
            frame_tuple = None  # Initialize to None
            try:
                ...
                frame_tuple = await self.__input_queue.get()
                (frame, direction, callback) = frame_tuple
                ...
                # Only call task_done() if an item was successfully dequeued.
