...
class AmplifyApp(
    ...
    def __init__(
        ...
        *,
        ...
        github_app: typing.Optional[typing.Union["GitHubAppConfig", typing.Dict[builtins.str, typing.Any]]] = None,
        ...
        :param access_token: GitHub authentication configuration. Can be either a personal access token (legacy) or GitHub App configuration (recommended). If not provided, will attempt to use GitHub CLI token or MUFIN_PUSH_TOKEN environment variable.
        ...
        :param github_app: GitHub App configuration (recommended over personal access tokens). Provides better security, organization support, and higher rate limits.
...
class AmplifyAppProps:
    def __init__(
        ...
        *,
        ...
        if isinstance(github_app, dict):
            github_app = GitHubAppConfig(**github_app)
        if __debug__:
        ...
        if github_app is not None:
            self._values["github_app"] = github_app
    ...
    def access_token(self) -> typing.Optional[builtins.str]:
        ...
        Can be either a personal access token (legacy) or GitHub App configuration (recommended).
    ...
    @builtins.property
    def github_app(self) -> typing.Optional["GitHubAppConfig"]:
        '''GitHub App configuration (recommended over personal access tokens).

        Provides better security, organization support, and higher rate limits.
        '''
        result = self._values.get("github_app")
        return typing.cast(typing.Optional["GitHubAppConfig"], result)
...
@jsii.data_type(
    jsii_type="must-cdk.GitHubAppConfig",
    jsii_struct_bases=[],
    name_mapping={
        "app_id": "appId",
...
class GitHubAppConfig:
    def __init__(
        ...
        *,
        ...
        '''GitHub App configuration for Amplify authentication.

        This is the recommended approach over personal access tokens.

        :param app_id: GitHub App ID. You can find this in your GitHub App settings.
        :param installation_id: GitHub App installation ID. This is specific to the repository/organization where the app is installed.
        :param private_key: GitHub App private key. This should be stored securely (e.g., in AWS Secrets Manager). Can be the raw private key string or a reference to a secret.
        :param client_id: Optional: GitHub App client ID. Required for some advanced GitHub App features.
        :param client_secret: Optional: GitHub App client secret. Required for some advanced GitHub App features. Should be stored securely (e.g., in AWS Secrets Manager).
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__b895ebc10eeee3dbcb1f994e4ebeebe47fcc64ed63e8fba2cbffefbcf2010ba4)
    ...
    def installation_id(self) -> builtins.str:
        ...
        This is specific to the repository/organization where the app is installed.
        '''
    ...
    def private_key(self) -> builtins.str:
        ...
        Can be the raw private key string or a reference to a secret.
        '''
    ...
    def client_id(self) -> typing.Optional[builtins.str]:
        ...
        Required for some advanced GitHub App features.
        '''
    ...
    def client_secret(self) -> typing.Optional[builtins.str]:
        ...
        Required for some advanced GitHub App features.
        Should be stored securely (e.g., in AWS Secrets Manager).
        '''
...
def _typecheckingstub__b895ebc10eeee3dbcb1f994e4ebeebe47fcc64ed63e8fba2cbffefbcf2010ba4(
    *,
    app_id: builtins.str,
    installation_id: builtins.str,
    private_key: builtins.str,
