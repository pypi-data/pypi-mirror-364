...
class BranchOptions:
    def __init__(
        ...
        *,
        ...
        :param branch_name: 
        :param build_spec: 
        :param enable_auto_build: 
        :param environment_variables: 
        :param framework: 
        :param pull_request_preview: 
        :param stage: 
        '''
        if __debug__:
...
class BuildSettings:
    def __init__(
        ...
        *,
        ...
        :param cache_type: 
        :param compute_type: 
        :param enable_auto_branch_creation: 
        :param enable_auto_branch_deletion: 
        :param enable_branch_auto_build: 
        '''
        if __debug__:
...
class CustomDomainOptions:
    def __init__(
        ...
        *,
        ...
        '''
        :param domain_name: 
        :param auto_subdomain_creation_patterns: 
        :param enable_auto_subdomain: 
        :param sub_domains: 
        '''
        if __debug__:
