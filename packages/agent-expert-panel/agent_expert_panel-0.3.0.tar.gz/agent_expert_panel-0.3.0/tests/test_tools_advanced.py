...
'''
    ...
    @patch("agent_expert_panel.tools.importlib.util.spec_from_file_location")
...
'''
    ...
    @patch("agent_expert_panel.tools.importlib.util.module_from_spec")
    def test_load_tools_from_file_exec_module_error(self, mock_module_from_spec):
        ...
        try:
            ...
            with patch(
                "agent_expert_panel.tools.importlib.util.spec_from_file_location"
            ) as mock_spec:
                mock_spec_obj = Mock()
