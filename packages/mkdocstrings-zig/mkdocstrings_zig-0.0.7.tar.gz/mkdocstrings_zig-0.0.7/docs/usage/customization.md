...
basedir = "src/mkdocstrings_handlers/zig/templates/material"
print("theme/")
...
See them [in the repository](https://github.com/mkdocstrings/mkdocstrings-zig/tree/main/src/mkdocstrings_handlers/zig/templates/).
