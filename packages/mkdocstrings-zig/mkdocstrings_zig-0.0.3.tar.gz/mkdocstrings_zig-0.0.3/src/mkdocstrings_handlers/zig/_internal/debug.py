...
def _get_version(dist: str = "mkdocstrings-zig") -> str:
...
def _get_debug_info() -> _Environment:
    ...
    packages = ["mkdocstrings-zig"]
    variables = ["PYTHONPATH", *[var for var in os.environ if var.startswith("MKDOCSTRINGS_ZIG")]]
    return _Environment(
