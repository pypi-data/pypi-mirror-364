...
extras_require = \
{':python_version == "2.7" or python_version >= "3.5" and python_version < "3.7"': ['pyx-core>=1.22'],
 ':python_version >= "3.7" and python_version < "4.0"': ['pyx-core',
                                                         'pyx-webservice>=1.22'],
 'all:python_version == "2.7" or python_version >= "3.5" and python_version < "4.0"': ['pyx-poetry>=1.22',
                                                                                       'pyc-core>=1.11'],
 'all:python_version >= "3.8" and python_version < "4.0"': ['pyx-client>=1.22'],
 'client:python_version >= "3.8" and python_version < "4.0"': ['pyx-client>=1.22'],
 'confluence:python_version >= "3.7"': ['atlassian-python-api>=3.14'],
 'core:python_version == "2.7" or python_version >= "3.5" and python_version < "4.0"': ['pyx-poetry>=1.22',
                                                                                        'poetry-core>=1.0'],
 'core:python_version >= "3.8"': ['poetry-dynamic-versioning>=1.8'],
 'devel:python_version == "2.7" or python_version >= "3.5" and python_version < "4.0"': ['pyx-poetry>=1.22',
                                                                                         'pyc-core>=1.11'],
 ...
 'poetry:python_version == "2.7" or python_version >= "3.5" and python_version < "4.0"': ['pyx-poetry>=1.22']}
