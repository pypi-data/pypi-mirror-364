...
class QueueTestCase(TestCase):
    ...
    def test_queue_dict(self):
        ...
        expect_data = {'queuename': 'Queue_1088', 'total_calls': 5, 'strategy': 'rrmemory', 'wait_mean': 348, 'duration_mean': 304, 'total_wait_calls': 10, 'total_completed_calls': 43, 'total_abandoned_calls': 11, 'members': [{'name': 'SIP/IP1489', 'has_paused': False, 'reason_paused': None, 'dynamic': None, 'in_call': False, 'paused_time': 0, 'logged_time': 0, 'total_calls': 3, 'last_call_time': 1912, 'penalty': 0,'type': 'member'}], 'type': 'queue', 'waiting_calls':[]}
        queue = Queue(**received_data)
