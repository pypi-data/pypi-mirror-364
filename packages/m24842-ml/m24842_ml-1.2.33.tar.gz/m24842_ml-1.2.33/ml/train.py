    ...
    **Config file options:**
        ...
        `experiments`:
            **List item format:**
                `general`:
                    ...
                    `compile_backend` (optional): Backend to use for compiling the model. If unspecified, "inductor", "aot_eager", and "eager" will be tried in that order.
    ...
    for i, experiment in enumerate(experiments):
        ...
        try:
            ...
            # Initialize model
            compile_backend = general_config.get("compile_backend", None)
