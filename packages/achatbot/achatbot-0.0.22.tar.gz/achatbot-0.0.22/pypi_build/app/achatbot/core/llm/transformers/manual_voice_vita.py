...
try:
    ...
    from achatbot.VITAAudio.vita_audio.tokenizer import get_audio_tokenizer
    from achatbot.VITAAudio.vita_audio.data.processor.audio_processor import add_audio_input_contiguous
    from achatbot.VITAAudio.evaluation.get_chat_template import qwen2_chat_template as chat_template
...
from achatbot.types.omni.vita_voice import VitaAudioTransformersVoiceLMArgs
