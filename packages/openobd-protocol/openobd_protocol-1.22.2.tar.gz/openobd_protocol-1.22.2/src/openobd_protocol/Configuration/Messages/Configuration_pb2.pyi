...
class ConfiguredChannel(_message.Message):
    __slots__ = ("raw_channel", "isotp_channel", "kline_channel", "tp20_channel")
    ...
    def __init__(self, raw_channel: _Optional[_Union[_Raw_pb2.RawChannel, _Mapping]] = ..., isotp_channel: _Optional[_Union[_Isotp_pb2.IsotpChannel, _Mapping]] = ..., kline_channel: _Optional[_Union[_Kline_pb2.KlineChannel, _Mapping]] = ..., tp20_channel: _Optional[_Union[_Tp20_pb2.Tp20Channel, _Mapping]] = ...) -> None: ...
