...
class BusConfiguration(_message.Message):
    __slots__ = ("bus_name", "can_bus", "kline_bus", "terminal15_bus")
    ...
    def __init__(self, bus_name: _Optional[str] = ..., can_bus: _Optional[_Union[_CanBus_pb2.CanBus, _Mapping]] = ..., kline_bus: _Optional[_Union[_KlineBus_pb2.KlineBus, _Mapping]] = ..., terminal15_bus: _Optional[_Union[_Terminal15Bus_pb2.Terminal15Bus, _Mapping]] = ...) -> None: ...
