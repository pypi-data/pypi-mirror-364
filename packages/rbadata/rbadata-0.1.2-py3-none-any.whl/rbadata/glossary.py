    ...
    def search(self, query: str) -> pd.DataFrame:
        ...
        for term, info in self._terms.items():
            ...
            if (
                ...
                or query_lower in info.get("full_name", "").lower()
                or query_lower in info.get("definition", "").lower()
            ):
    ...
    def _load_default_glossary(self) -> Dict[str, Dict[str, str]]:
        ...
        glossary = {
            "CPI": {
                ...
                "definition": (
                    "A measure of inflation that tracks the average change over time "
            ...
            "OCR": {
                ...
                "definition": (
                    "The interest rate set by the Reserve Bank of Australia for "
            ...
            "TWI": {
                ...
                "definition": (
                    "An index that measures the value of Australia's currency against "
                    "a basket of foreign currencies of major trading partners."
                ),
            ...
            "M3": {
                ...
                "definition": (
                    "A measure of the money supply that includes cash, checking "
            ...
            "BBSW": {
                ...
                "definition": (
                    "The interest rate used as a benchmark for pricing Australian "
                    "dollar derivatives and securities."
                ),
            ...
            "SMP": {
                ...
                "definition": (
                    "The Reserve Bank's quarterly report on economic and financial "
                    "conditions and the outlook for inflation and economic growth."
                ),
            ...
            "ESA": {
                ...
                "definition": (
                    "Accounts held at the Reserve Bank by financial institutions to "
            ...
            "ADI": {
                ...
                "definition": (
                    "Financial institutions authorized by APRA to accept deposits "
                    "from the public."
                ),
                "category": "Banking",
            ...
            "RITS": {
                ...
                "definition": (
                    "The Reserve Bank's system for settling high-value payments "
            ...
            "REPO": {
                ...
                "definition": (
                    "A form of short-term borrowing where securities are sold with an "
