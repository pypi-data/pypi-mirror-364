...
def main():
    ...
    readable_tables = tables[tables["readable"]]
    non_readable_tables = tables[~tables["readable"]]
    ...
    relevant_tables = pd.concat(
        [rbadata.browse_rba_tables("inflation"), rbadata.browse_rba_tables("interest")]
    ).drop_duplicates()
