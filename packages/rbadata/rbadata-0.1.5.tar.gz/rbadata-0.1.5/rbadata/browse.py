...
def browse_rba_tables(
    search: Optional[str] = None, refresh: bool = False
) -> pd.DataFrame:
    """
...
def browse_rba_series(
    search: Optional[str] = None, table_no: Optional[str] = None, refresh: bool = False
) -> pd.DataFrame:
    """
    ...
    if search:
        ...
        mask = series["series"].str.contains(search, case=False, na=False) | series[
            "description"
