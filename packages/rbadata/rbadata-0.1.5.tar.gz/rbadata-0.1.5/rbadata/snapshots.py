...
class Snapshots:
    ...
    def download_snapshot(
        ...
        snapshot_type: Literal[
            "economic-indicators", "economy-composition", "payments"
        ],
    ...
    def get_comparison_tool_data(
        self, snapshot_type: str, comparison_items: List[str]
    ) -> pd.DataFrame:
        """
        ...
        raise NotImplementedError(
            "Interactive comparison tool data extraction requires JavaScript "
            "execution. Consider using the downloaded PDFs or related statistical "
            "tables instead."
        )
