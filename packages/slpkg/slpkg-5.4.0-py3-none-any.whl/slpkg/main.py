...
class Run:  # pylint: disable=[R0902]
    ...
    def remove(self, packages: list[str]) -> NoReturn:
        ...
        if self.options.get('option_select'):
            ...
            remove_packages = self.choose.packages({}, remove_packages, command)  # No data needed for remove choose.
...
def main() -> None:  # pylint: disable=[R0912,R0914,R0915]
    ...
    repository_group.add_argument('-o', '--repository', metavar='<NAME>', dest='option_repository', help='Change repository you want to work.')
