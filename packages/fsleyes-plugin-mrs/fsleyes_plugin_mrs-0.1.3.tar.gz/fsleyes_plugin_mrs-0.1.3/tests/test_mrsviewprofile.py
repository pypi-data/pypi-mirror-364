...
def test_MRSViewProfile_phasingMode():
    run_with_viewpanel(_test_MRSViewProfile_phasingMode, MRSView)

def _test_MRSViewProfile_phasingMode(view, overlayList, displayCtx):
