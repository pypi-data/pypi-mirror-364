...
def test_MRSControlPanel_title():
...
def test_MRSControlPanel_supportedViews():
...
def test_MRSControlPanel():
    run_with_viewpanel(_test_MRSControlPanel, MRSView)

def _test_MRSControlPanel(view, overlayList, displayCtx):
...
def test_MRSControlPanel_customPlotSettings():
    run_with_viewpanel(_test_MRSControlPanel_customPlotSettings, MRSView)

def _test_MRSControlPanel_customPlotSettings(view, overlayList, displayCtx):
    img = fslimage.Image(op.join(datadir, 'metab'))
    overlayList.append(img)
    realYield(25)
...
def test_MRSControlPanel_plotSettings():
    run_with_viewpanel(_test_MRSControlPanel_plotSettings, MRSView)

def _test_MRSControlPanel_plotSettings(view, overlayList, displayCtx):
    img = fslimage.Image(op.join(datadir, 'metab'))
    overlayList.append(img)
    realYield(25)
...
def test_MRSControlPanel_currentDSSettings():
    run_with_viewpanel(_test_MRSControlPanel_currentDSSettings, MRSView)

def _test_MRSControlPanel_currentDSSettings(view, overlayList, displayCtx):
    img = fslimage.Image(op.join(datadir, 'metab'))
    overlayList.append(img)
    realYield(25)
...
def test_MRSControlPanel_customDSSettings():
    run_with_viewpanel(_test_MRSControlPanel_customDSSettings, MRSView)

def _test_MRSControlPanel_customDSSettings(view, overlayList, displayCtx):
    img = fslimage.Image(op.join(datadir, 'metab'))
    overlayList.append(img)
    realYield(25)
