...
def test_MRSToolBar_supportedViews():
...
def test_MRSToolBarPanel():
    run_with_viewpanel(_test_MRSToolBarPanel, MRSView)

def _test_MRSToolBarPanel(view, overlayList, displayCtx):
