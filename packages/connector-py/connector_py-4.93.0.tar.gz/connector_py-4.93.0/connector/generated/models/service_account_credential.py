...
from connector.generated.models.service_account_type import ServiceAccountType
...
class ServiceAccountCredential(BaseModel):
    ...
    service_type: Optional[ServiceAccountType] = HiddenField(
        default=None, description="The type of service. Currently only Google is supported."
    )
