...
def list_secrets(namespace: str, name_pattern: str = None):
    secrets_names = []

    v1 = client.CoreV1Api()
    try:
        name_pattern = name_pattern.replace('{namespace}', namespace)
...
def create_pod(namespace: str, pod_name: str, image: str, secret: str, env: dict[str, any], volume_name: str, pvc_name:str, mount_path:str, command: list[str]=None, sa_name=None):
    v1 = client.CoreV1Api()
    envs = []
