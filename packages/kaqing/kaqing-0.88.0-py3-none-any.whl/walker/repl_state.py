...
from walker.k8s_utils import cassandra_nodes_exec, cassandra_pod_exec, get_user_pass, in_cluster_namespace, is_pg_name, is_pod_name, is_sts_name
...
class ReplState:
    def __init__(self, sts: str = None, pod: str = None, namespace: str = None, ns_sts: str = None, pg: str = None, in_repl = False, bash_session: BashSession = None, remote_dir = None):
