...
from walker.k8s_utils import create_job, create_pvc
...
class RepairRun(Command):
    ...
    def run(self, cmd: str, state: ReplState):
        ...
        create_pvc(pvc_name, 30, ns)
        create_job('cassrepair-'+state.sts, ns, image, secret, env, env_from, 'cassrepair', pvc_name, log_path)
