...
class Populator:
    ...
    def add_popsyn_regions(self, model_area: gpd.GeoDataFrame, census_type: str, year: int = 2021):
        ...
        self._state_counties = get_state_counties(model_area, year=year)
        add_popsyn_regions(model_area, self.state_counties(year), census_type, self.supply_path, year)
