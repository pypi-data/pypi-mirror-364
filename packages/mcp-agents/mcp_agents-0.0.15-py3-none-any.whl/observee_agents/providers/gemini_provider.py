        ...
        for key, value in schema.items():
            ...
            if isinstance(value, dict):
                ...
                if key == "required":
                    ...
                    valid_required = []
                    properties = cleaned.get("properties", {}) if "properties" in cleaned else schema.get("properties", {})
                    
                    for req_field in value:
                        if properties and req_field in properties:
                            valid_required.append(req_field)
                        else:
                            logger.warning(f"Required field '{req_field}' not found in properties, removing from required list")
