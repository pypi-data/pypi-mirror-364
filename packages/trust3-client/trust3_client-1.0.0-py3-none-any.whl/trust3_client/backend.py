...
class ShieldRestHttpClient:
    ...
    def __init__(self, **kwargs):
        ...
        self.snowflake_token_generator = kwargs.get('snowflake_token_generator', None)
    ...
    def get_default_headers(self):
        ...
        if self.snowflake_token_generator:
            headers.update(self.snowflake_token_generator.authorization_header())
