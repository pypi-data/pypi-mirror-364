...
from .snowflake_token_generator import SnowflakeTokenGenerator

from . import interceptor_setup, util
from .trust3_common.audit_spooler import AuditLogger
...
class PAIGApplication:
    ...
    def __init__(self, **kwargs):
        ...
        self.snowflake_token_generator = None
        snowflake_pat_token = kwargs.get("snowflake_pat_token", os.environ.get('SNOWFLAKE_PAT_TOKEN'))
        if snowflake_pat_token:
            snowflake_app_endpoint = kwargs.get("endpoint", os.getenv("PAIG_API_SERVER_URL"))
            self.snowflake_token_generator = SnowflakeTokenGenerator(snowflake_app_endpoint, snowflake_pat_token)
            kwargs['snowflake_token_generator'] = self.snowflake_token_generator
        ...
        self.shield_client = ShieldRestHttpClient(base_url=self.shield_base_url, tenant_id=self.tenant_id,
                                                  ...
                                                  snowflake_token_generator=self.snowflake_token_generator)
    ...
    def fetch_application_config_from_server(self, api_key, kwargs):
        ...
        try:
            ...
            snowflake_token_generator = kwargs.get("snowflake_token_generator", None)
            if snowflake_token_generator:
                headers.update(snowflake_token_generator.authorization_header())
