...
class CurationAPIClient:
    ...
    def create_property(self, property_data: Dict) -> Dict:
        ...
        - type: Property type (use PropertyType constants)
        
        Optional fields:
        - description: Description of the property
        - property_options: List of options (required for controlled_vocabulary type)
        - is_identifier: Whether this property serves as an identifier
        
        Note: Properties are now global and not tied to specific sources.
        """
...
class PropertyType:
    """
    Property type constants for creating global properties.
    
    Properties are now global entities shared across all sources, not tied to specific sources.
