...
# =========================
TEMPLATE_FILE_PATH = os.path.join(os.path.dirname(__file__), 'decoy_templates.json')
...
def generate_decoy_message():
    templates_dict = load_templates_from_package()
    all_templates = [tpl for group in templates_dict.values() for tpl in group]
