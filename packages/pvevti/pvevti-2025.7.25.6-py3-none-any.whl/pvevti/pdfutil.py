    ...
    def render(self):
        ...
        match self.type:
            ...
            case "dual" | "dualline":
                ...
                ax1.set_ylabel(self.columns[1], color=getCol(0), labelcolor=getCol(0))
                ax2.set_ylabel(self.columns[2], color=getCol(1), labelcolor=getCol(0))
                ax1.tick_params(axis="y", colors=getCol(0), labelcolor=getCol(0))
                ax2.tick_params(axis="y", colors=getCol(1), labelcolor=getCol(0))
