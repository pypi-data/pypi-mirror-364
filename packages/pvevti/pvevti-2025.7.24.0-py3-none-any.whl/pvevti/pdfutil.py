...
default_config = {
    "docTitle": "Document Title", "docSubTitle": "E9Serial",
    "pages": [
        {"pageName": "Page One!","plots": [
                {
        ...
        {"pageName": "Page Two!","plots": [
                {
                    "plotTitle": "Example Plot (2)",
                    "plotType" : "line",
                    "xData"    : "t",
                    "yData"    : ["ati", "iCTI", "IcTo", "AIR_HOOD_L_AIR_TI", "AIR_HOOD_R_AIR_TI"],
                    "filterLength": 300
                },{
                    "plotTitle": "Example Plot (2) [Filtered]",
                    "plotType" : "line",
                    "xData"    : "t",
                    "yData"    : ["can_trq_dem", "EngTrq_Cval_PT"],
                    "filterLength": 600
                }]}
    ]
}
