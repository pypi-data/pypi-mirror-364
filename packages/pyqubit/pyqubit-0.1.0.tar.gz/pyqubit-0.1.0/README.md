...
PyQubit is a lightweight, educational library for simulating a single quantum bit (qubit). It provides a clean interface for initializing a qubit's state, applying common quantum gates, performing measurements, and exploring the fundamental principles of quantum computing. It is designed to be a foundational building block for a future quantum computing library.
