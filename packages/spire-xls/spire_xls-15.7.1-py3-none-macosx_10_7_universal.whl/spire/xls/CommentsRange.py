...
class CommentsRange (  XlsObject, IComment, ITextBoxShape, ITextBox, IShape) :
    ...
    and positioning. The class implements multiple interfaces to support various aspects of
    comment functionality, including text box and shape behaviors.
    """
    @property
    ...
    def IsMoveWithCell(self)->bool:
        ...
        Returns:
            bool: True if the comment moves with the cell; otherwise, False.
        """
    ...
    def Rotation(self)->int:
        ...
        Returns:
            int: The rotation angle of the comment shape in degrees.
        """
