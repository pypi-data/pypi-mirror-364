...
class CellRange (  XlsRange) :
    ...
    This class extends XlsRange and provides properties and methods for manipulating
    ranges of cells in Excel worksheets, including operations such as copying, moving,
    merging, and formatting. It also provides access to cell comments, borders, styles,
    and other range-specific functionality.
    """
...
class ListCellRanges (IList[CellRange]):
    ...
    This class implements IList<CellRange> and provides functionality for working with
    collections of cell ranges, such as those returned by search operations or
    range selections. It allows for iterating through multiple cell ranges and
    accessing individual ranges within the collection.
    """
