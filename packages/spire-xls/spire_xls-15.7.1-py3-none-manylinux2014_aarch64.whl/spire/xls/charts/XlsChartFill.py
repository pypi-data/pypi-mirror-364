...
class XlsChartFill (  XlsShapeFill, IShapeFill) :
    """
    Represents the fill formatting for a chart element, providing access to gradient, pattern, texture, color, and transparency options.
    """
    @property
    def GradientStops(self)->'GradientStops':
        """
        Gets the collection of gradient stops for the fill.

        Returns:
            GradientStops: The collection of gradient stops.
        """
    ...
    def FillType(self)->'ShapeFillType':
        """
        Gets or sets the fill type for the chart element.

        Returns:
            ShapeFillType: The fill type.
        """
    ...
    def GradientStyle(self)->'GradientStyleType':
        """
        Gets or sets the gradient style for the fill.

        Returns:
            GradientStyleType: The gradient style.
        """
    ...
    def GradientVariant(self)->'GradientVariantsType':
        """
        Gets or sets the gradient variant for the fill.

        Returns:
            GradientVariantsType: The gradient variant.
        """
    ...
    def TransparencyTo(self)->float:
        """
        Gets or sets the ending transparency value for the fill.

        Returns:
            float: The ending transparency value.
        """
    ...
    def TransparencyFrom(self)->float:
        """
        Gets or sets the starting transparency value for the fill.

        Returns:
            float: The starting transparency value.
        """
    ...
    def GradientColorType(self)->'GradientColorType':
        """
        Gets or sets the gradient color type for the fill.
    ...
    def Pattern(self)->'GradientPatternType':
        """
        Gets or sets the gradient pattern type for the fill.

        Returns:
            GradientPatternType: The gradient pattern type.
        """
    ...
    def Texture(self)->'GradientTextureType':
        """
        Gets or sets the gradient texture type for the fill.

        Returns:
            GradientTextureType: The gradient texture type.
        """
    ...
    def BackColorObject(self)->'OColor':
        """
        Gets the background color object for the fill.
    ...
    def ForeColorObject(self)->'OColor':
        """
        Gets the foreground color object for the fill.
    ...
    def BackKnownColor(self)->'ExcelColors':
        """
        Gets or sets the known background color for the fill.
    ...
    def ForeKnownColor(self)->'ExcelColors':
        """
        Gets or sets the known foreground color for the fill.
    ...
    def BackColor(self)->'Color':
        """
        Gets or sets the background color for the fill.
    ...
    def ForeColor(self)->'Color':
        """
        Gets or sets the foreground color for the fill.
    ...
    def PresetGradientType(self)->'GradientPresetType':
        """
        Gets or sets the preset gradient type for the fill.

        Returns:
            GradientPresetType: The preset gradient type.
        """
    ...
    def Picture(self)->'Stream':
        """
        Gets the picture stream used for the fill.
    ...
    def PictureName(self)->str:
        """
        Gets the name of the picture used for the fill.

        Returns:
            str: The picture name.
        """
    ...
    def GradientDegree(self)->float:
        """
        Gets or sets the gradient degree for the fill.

        Returns:
            float: The gradient degree.
        """
    ...
    def Transparency(self)->float:
        """
        Gets or sets the transparency for the fill.
    ...
    def CustomPicture(self ,path:str):
        """
        Sets a custom picture as the fill using the specified file path.

        Args:
            path (str): The file path to the picture.
        """
    ...
    def CustomPicture(self ,im:Stream,name:str):
        """
        Sets a custom picture as the fill using a stream and a name.

        Args:
            im (Stream): The image stream.
    ...
    def CustomTexture(self ,path:str):
        """
        Sets a custom texture as the fill using the specified file path.
    ...
    def CustomTexture(self ,im:Stream,name:str):
        """
        Sets a custom texture as the fill using a stream and a name.
    ...
    def Patterned(self ,pattern:'GradientPatternType'):
        """
        Applies a patterned fill using the specified gradient pattern type.

        Args:
            pattern (GradientPatternType): The gradient pattern type to apply.
        """
    ...
    def PresetGradient(self ,grad:GradientPresetType):
        """
        Applies a preset gradient fill using the specified gradient preset type.

        Args:
            grad (GradientPresetType): The gradient preset type to apply.
        """
    ...
    def PresetGradient(self ,grad:GradientPresetType,shadStyle:GradientStyleType):
        """
        Applies a preset gradient fill using the specified gradient preset type and gradient style.

        Args:
            grad (GradientPresetType): The gradient preset type to apply.
            shadStyle (GradientStyleType): The gradient style to apply.
        """
        enumgrad:c_int = grad.value
    ...
    def PresetGradient(self ,grad:GradientPresetType,shadStyle:GradientStyleType,shadVar:GradientVariantsType):
        """
        Applies a preset gradient fill using the specified gradient preset type, gradient style, and gradient variant.

        Args:
            grad (GradientPresetType): The gradient preset type to apply.
            shadStyle (GradientStyleType): The gradient style to apply.
            shadVar (GradientVariantsType): The gradient variant to apply.
        """
        enumgrad:c_int = grad.value
        enumshadStyle:c_int = shadStyle.value
    ...
    def PresetTextured(self ,texture:'GradientTextureType'):
        """
        Applies a preset textured fill using the specified gradient texture type.

        Args:
            texture (GradientTextureType): The gradient texture type to apply.
        """
    ...
    def TwoColorGradient(self):
        """
        Applies a two-color gradient fill with default style and variant.
        """
    ...
    def TwoColorGradient(self ,style:GradientStyleType):
        """
        Applies a two-color gradient fill with the specified gradient style.

        Args:
            style (GradientStyleType): The gradient style to apply.
        """
    ...
    def TwoColorGradient(self ,style:GradientStyleType,variant:GradientVariantsType):
        """
        Applies a two-color gradient fill with the specified gradient style and variant.

        Args:
            style (GradientStyleType): The gradient style to apply.
            variant (GradientVariantsType): The gradient variant to apply.
        """
        enumstyle:c_int = style.value
    ...
    def OneColorGradient(self):
        """
        Applies a one-color gradient fill with default style and variant.
        """
    ...
    def OneColorGradient(self ,style:GradientStyleType):
        """
        Applies a one-color gradient fill with the specified gradient style.
    ...
    def OneColorGradient(self ,style:GradientStyleType,variant:GradientVariantsType):
        """
        Applies a one-color gradient fill with the specified gradient style and variant.
    ...
    def Solid(self):
        """
        Applies a solid fill to the chart element.
        """
...
#
    ...
    def PicStretch(self)->'PicStretch':
        """
        Gets or sets the picture stretch options for the fill.

        Returns:
            PicStretch: The picture stretch options.
        """
    ...
    def Tile(self)->bool:
        """
        Gets or sets a value indicating whether the picture fill is tiled.
