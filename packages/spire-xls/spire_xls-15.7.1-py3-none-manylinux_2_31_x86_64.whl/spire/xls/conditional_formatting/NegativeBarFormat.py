...
class NegativeBarFormat (SpireObject) :
    """
    Represents the format for negative data bars in conditional formatting.
    """
    @property
    def BorderColor(self)->'Color':
        """
        Gets or sets the border color for the negative data bar.
    ...
    def BorderColorType(self)->'DataBarNegativeColorType':
        """
        Gets or sets the border color type for the negative data bar.

        Returns:
            DataBarNegativeColorType: The border color type.
        """
    ...
    def Color(self)->'Color':
        """
        Gets or sets the fill color for the negative data bar.
    ...
    def ColorType(self)->'DataBarNegativeColorType':
        """
        Gets or sets the fill color type for the negative data bar.

        Returns:
            DataBarNegativeColorType: The fill color type.
        """
