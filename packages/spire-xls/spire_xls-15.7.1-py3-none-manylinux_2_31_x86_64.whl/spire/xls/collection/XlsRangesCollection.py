...
class XlsRangesCollection (  CollectionBase[XlsRange], IXLSRanges, ICombinedRange) :
    """
    Represents a collection of ranges in a worksheet, supporting various operations such as merging, formatting, and group management.
    """

    def Intersect(self ,range:'IXLSRange')->'IXLSRange':
        """
        Gets the intersection of the current range collection with the specified range.

        Args:
            range (IXLSRange): The range to intersect with.

        Returns:
            IXLSRange: The intersection range.
        """
    ...
    def Merge(self ,range:IXLSRange)->IXLSRange:
        """
        Merges the current range collection with the specified range.
    ...
    def AutoFitRows(self):
        """
        Autofits all rows in the range collection.
        """
    ...
    def AutoFitColumns(self):
        """
        Autofits all columns in the range collection.
        """
    ...
    def AddComment(self)->'ICommentShape':
        """
        Adds a comment to the range collection.
    ...
    def BorderAround(self):
        """
        Sets a border around the current range collection.
        """
    ...
    def BorderAround(self ,borderLine:LineStyleType):
        """
        Sets a border around the current range collection with the specified line style.
    ...
    def BorderAround(self ,borderLine:LineStyleType,borderColor:Color):
        """
        Sets a border around the current range collection with the specified line style and color.
    ...
    def BorderAround(self ,borderLine:LineStyleType,borderColor:ExcelColors):
        """
        Sets a border around the current range collection with the specified line style and Excel color.
    ...
    def BorderInside(self):
        """
        Sets an inside border for the current range collection.
        """
    ...
    def BorderInside(self ,borderLine:LineStyleType):
        """
        Sets an inside border for the current range collection with the specified line style.
    ...
    def BorderInside(self ,borderLine:LineStyleType,borderColor:Color):
        """
        Sets an inside border for the current range collection with the specified line style and color.
    ...
    def BorderInside(self ,borderLine:LineStyleType,borderColor:ExcelColors):
        """
        Sets an inside border for the current range collection with the specified line style and Excel color.
    ...
    def BorderNone(self):
        """
        Removes all borders from the current range collection.
        """
    ...
    def CollapseGroup(self ,groupBy:'GroupByType'):
        """
        Collapses the group in the range by the specified grouping type.

        Args:
            groupBy (GroupByType): The type of grouping to collapse.
        """
    ...
    def ExpandGroup(self ,groupBy:GroupByType):
        """
        Expands the group in the range by the specified grouping type.

        Args:
            groupBy (GroupByType): The type of grouping to expand.
        """
        enumgroupBy:c_int = groupBy.value
    ...
    def ExpandGroup(self ,groupBy:GroupByType,flags:ExpandCollapseFlags):
        """
        Expands the group in the range by the specified grouping type and flags.

        Args:
            groupBy (GroupByType): The type of grouping to expand.
            flags (ExpandCollapseFlags): Additional flags for expanding.
        """
        enumgroupBy:c_int = groupBy.value
...
#
    ...
    def get_Item(self ,row:int,column:int)->IXLSRange:
        """
        Gets the range specified by the start and end row and column indices.

        Args:
            row (int): The starting row index.
            column (int): The starting column index.
        Returns:
            IXLSRange: The specified range.
        """
    ...
    def set_Item(self ,row:int,column:int,value:IXLSRange):
        """
        Sets the range at the specified row and column.
    ...
    def get_Item(self ,row:int,column:int,lastRow:int,lastColumn:int)->IXLSRange:
        ...
        Args:
            row (int): The starting row index.
            column (int): The starting column index.
            lastRow (int): The ending row index.
            lastColumn (int): The ending column index.
        Returns:
            IXLSRange: The specified range.
        """
    ...
    def get_Item(self ,name:str,IsR1C1Notation:bool)->IXLSRange:
        """
        Gets the range by its name, with an option for R1C1 notation.

        Args:
            name (str): The name of the range.
            IsR1C1Notation (bool): Whether to use R1C1 notation.
        Returns:
            IXLSRange: The specified range.
        """
    ...
    def Activate(self ,scroll:bool)->'IXLSRange':
        """
        Activates a single cell, scrolls to it, and activates the respective sheet. To select a range of cells, use the Select method.

        Args:
            scroll (bool): True to scroll to the cell.
        Returns:
...
#
    ...
    def Merge(self ,clearCells:bool):
        """
        Merges the cells in the range, with an option to clear the cells.

        Args:
            clearCells (bool): Whether to clear the cells after merging.
        """
    ...
    def UnMerge(self):
        """
        Unmerges the merged cells in the range.
        """
    ...
    def FreezePanes(self):
        """
        Freezes panes at the current range.
        """
