...
class XlsChartFrameFormat (  XlsObject, IChartFrameFormat, IChartFillBorder) :
    """
    Represents the frame formatting for a chart element, providing access to border, fill, shadow, 3D format, and layout options.
    """
    @property
    ...
    def HasManualLayout(self)->bool:
        """
        Gets a value indicating whether the frame has a manual layout.

        Returns:
            bool: True if the frame has a manual layout; otherwise, False.
        """
    ...
    def InnerLayoutTarget(self)->bool:
        """
        Gets or sets a value indicating whether the layout target is the inner plot area.

        Returns:
            bool: True if the layout target is the inner plot area; otherwise, False.
        """
    ...
    def Interior(self)->'IChartInterior':
        """
        Gets the interior formatting for the chart frame.
    ...
    def HasShadow(self)->bool:
        """
        Gets a value indicating whether the frame has a shadow.

        Returns:
            bool: True if the frame has a shadow; otherwise, False.
        """
    ...
    def HasFormat3D(self)->bool:
        """
        Gets a value indicating whether the frame has 3D formatting.

        Returns:
            bool: True if the frame has 3D formatting; otherwise, False.
        """
    ...
    def IsAutomaticFormat(self)->bool:
        """
        Gets or sets a value indicating whether the frame uses automatic formatting.

        Returns:
            bool: True if automatic formatting is used; otherwise, False.
        """
    ...
    def Visible(self)->bool:
        ...
        Returns:
            bool: True if the frame is visible; otherwise, False.
        """
    ...
    def Clear(self):
        """
        Clears all formatting from the chart frame.
        """
    ...
    def Clone(self ,parent:'SpireObject')->'XlsChartFrameFormat':
        """
        Creates a copy of the current chart frame format object with the specified parent.

        Args:
            parent (SpireObject): The parent object for the cloned format.
        Returns:
            XlsChartFrameFormat: The cloned chart frame format object.
        """
    ...
    def SetDefaultValues(self ,bAutoSize:bool,bIsInteriorGray:bool):
        """
        Sets the default values for the chart frame format.

        Args:
            bAutoSize (bool): Whether to use automatic sizing.
            bIsInteriorGray (bool): Whether the interior should be gray.
        """
