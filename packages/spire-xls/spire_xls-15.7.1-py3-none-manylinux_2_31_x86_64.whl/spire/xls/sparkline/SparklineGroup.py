...
class SparklineGroup (  SpireObject, ISparklineGroup) :
    """Represents a group of sparklines with the same formatting options.
    
    A sparkline group contains one or more sparklines that share the same formatting options,
    such as style, color, markers, and axis settings.
    """
    @property

    def SparklineList(self)->'SparklineCollection':
        """Gets the collection of sparklines in this group.
        
        Returns:
            SparklineCollection: A collection of sparklines belonging to this group.
        """
    ...
    def ShowHorizontalAxis(self)->bool:
        ...
        Returns:
            bool: True if the horizontal axis is shown; otherwise, False.
        """
    ...
    def ShowHorizontalAxis(self, value:bool):
        ...
        Args:
            value (bool): True to show the horizontal axis; otherwise, False.
        """
    ...
    def IsDisplayHidden(self)->bool:
        ...
        Returns:
            bool: True if data in hidden rows and columns is shown; otherwise, False.
        """
    ...
    def IsDisplayHidden(self, value:bool):
        ...
        Args:
            value (bool): True to show data in hidden rows and columns; otherwise, False.
        """
    ...
    def PlotRightToLeft(self)->bool:
        """Gets whether to plot data points from right to left.
        
        Returns:
            bool: True if data points are plotted from right to left; otherwise, False.
        """
    ...
    def PlotRightToLeft(self, value:bool):
        """Sets whether to plot data points from right to left.
        
        Args:
            value (bool): True to plot data points from right to left; otherwise, False.
        """
    ...
    def ShowFirstPoint(self)->bool:
        ...
        Returns:
            bool: True if the first point is highlighted; otherwise, False.
        """
    ...
    def ShowFirstPoint(self, value:bool):
        ...
        Args:
            value (bool): True to highlight the first point; otherwise, False.
        """
    ...
    def ShowLastPoint(self)->bool:
        ...
        Returns:
            bool: True if the last point is highlighted; otherwise, False.
        """
    ...
    def ShowLastPoint(self, value:bool):
        ...
        Args:
            value (bool): True to highlight the last point; otherwise, False.
        """
    ...
    def ShowLowPoint(self)->bool:
        ...
        Returns:
            bool: True if the lowest points are highlighted; otherwise, False.
        """
    ...
    def ShowLowPoint(self, value:bool):
        ...
        Args:
            value (bool): True to highlight the lowest points; otherwise, False.
        """
    ...
    def ShowHighPoint(self)->bool:
        ...
        Returns:
            bool: True if the highest points are highlighted; otherwise, False.
        """
    ...
    def ShowHighPoint(self, value:bool):
        ...
        Args:
            value (bool): True to highlight the highest points; otherwise, False.
        """
    ...
    def ShowNegativePoint(self)->bool:
        """Gets whether to highlight the negative values on the sparkline group.
        
        Negative values can be highlighted with a different color or marker.
        
        Returns:
            bool: True if negative values are highlighted; otherwise, False.
        """
    ...
    def ShowNegativePoint(self, value:bool):
        """Sets whether to highlight the negative values on the sparkline group.
        
        Args:
            value (bool): True to highlight negative values; otherwise, False.
        """
    ...
    def ShowMarkers(self)->bool:
        """Gets whether to highlight each point in each line sparkline in the group.
        
        Returns:
            bool: True if markers are shown for each point; otherwise, False.
        """
    ...
    def ShowMarkers(self, value:bool):
        """Sets whether to highlight each point in each line sparkline in the group.
        
        Args:
            value (bool): True to show markers for each point; otherwise, False.
        """
    ...
    def VerticalAxisMaxValue(self)->float:
        ...
        Returns:
            float: The maximum value for the vertical axis.
        """
    ...
    def VerticalAxisMaxValue(self, value:float):
        ...
        Args:
            value (float): The maximum value to set for the vertical axis.
        """
    ...
    def VerticalAxisMaxType(self)->'SpartlineVerticalAxisType':
        ...
        Returns:
            SpartlineVerticalAxisType: An enumeration value representing the vertical axis maximum value type.
        """
    ...
    def VerticalAxisMaxType(self, value:'SpartlineVerticalAxisType'):
        ...
        Args:
            value (SpartlineVerticalAxisType): An enumeration value representing the vertical axis maximum value type.
        """
    ...
    def VerticalAxisMinValue(self)->float:
        ...
        Returns:
            float: The minimum value for the vertical axis.
        """
    ...
    def VerticalAxisMinValue(self, value:float):
        ...
        Args:
            value (float): The minimum value to set for the vertical axis.
        """
    ...
    def VerticalAxisMinValueType(self)->'SpartlineVerticalAxisType':
        ...
        Returns:
            SpartlineVerticalAxisType: An enumeration value representing the vertical axis minimum value type.
        """
    ...
    def VerticalAxisMinValueType(self, value:'SpartlineVerticalAxisType'):
        ...
        Args:
            value (SpartlineVerticalAxisType): An enumeration value representing the vertical axis minimum value type.
        """
    ...
    def SparklineType(self)->'SparklineType':
        ...
        Returns:
            SparklineType: An enumeration value representing the sparkline type (Line, Column, or Win/Loss).
        """
    ...
    def SparklineType(self, value:'SparklineType'):
        ...
        Args:
            value (SparklineType): An enumeration value representing the sparkline type (Line, Column, or Win/Loss).
        """
