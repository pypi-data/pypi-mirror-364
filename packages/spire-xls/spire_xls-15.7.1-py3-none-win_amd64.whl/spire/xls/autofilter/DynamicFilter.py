...
class DynamicFilter (SpireObject) :
    ...
    def DynamicFilterType(self)->'DynamicFilterType':
        ...
        Returns:
            DynamicFilterType: The type of dynamic filter.
        """
    ...
    def DynamicFilterType(self, value:'DynamicFilterType'):
        ...
        Args:
            value (DynamicFilterType): The type of dynamic filter to set.
        """
    ...
    def Value(self)->'SpireObject':
        """
        Gets or sets the dynamic filter value.

        Returns:
            SpireObject: The value for the dynamic filter.
        """
    ...
    def Value(self, value:'SpireObject'):
        ...
        Args:
            value (SpireObject): The value to set for the dynamic filter.
        """
    ...
    def MaxValue(self)->'SpireObject':
        """
        Gets or sets the dynamic filter max value.

        Returns:
            SpireObject: The max value for the dynamic filter.
        """
    ...
    def MaxValue(self, value:'SpireObject'):
        ...
        Args:
            value (SpireObject): The max value to set for the dynamic filter.
        """
