...
impl_mul_relation_with_other!(ForcePerVolume, Area, MassPerTimeSquare);
impl_mul_relation_with_other!(ForcePerVolume, Distance, MassPerDistanceTimeSquare);
...
impl_mul_relation_with_other!(MassPerDistanceTimeSquare, Distance, MassPerTimeSquare);
