# SaladCloud Transcription SDK for Python<a id="saladcloud-transcription-sdk-for-python"></a>
...
### Start a Transcription Job and poll for status<a id="start-a-transcription-job-and-poll-for-status"></a>
