...
#            write_page_index=True, 
            ...
            sorting_columns=[pq.SortingColumn(0), pq.SortingColumn(1), pq.SortingColumn(2)] if not sort_by_field_code else [pq.SortingColumn(0), pq.SortingColumn(1), pq.SortingColumn(2)],
        ) 
