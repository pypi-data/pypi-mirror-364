...
def yield_from_marcxml_file(inf: OpenFile) -> Iterator[Iterator[tuple[int, int, int, str, str, str]]]:
...
def yield_from_picaxml_file(inf: OpenFile) -> Iterator[Iterator[tuple[int, int, int, str, str, str]]]:
