...
@click.option("-s", "--sort", flag_value=True, default=False, help="Sort output by field_code, subfield_code, value")
@click.option("-p", "--partition-cols", help="Partition parquet files by these columns", type=str, multiple=True, default=None)
@click.argument('input', nargs=-1)
def convert(input: list[str], format: Literal['marc','pica'], output: str, parquet_compression: str, parquet_compression_level: int, parquet_row_group_size: int, max_rows: int, partition_cols: Iterable[str]) -> None:
