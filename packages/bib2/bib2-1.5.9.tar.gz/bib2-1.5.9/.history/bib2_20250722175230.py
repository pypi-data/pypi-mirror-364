...
def parquet_writer(output: str, parquet_compression: str, parquet_compression_level: int, partition_by: str) -> pq.ParquetWriter:
...
def convert(input: list[str], format: Literal['marc','pica'], output: str, parquet_compression: str, parquet_compression_level: int, parquet_batch_size: int, max_rows: int, partition_by: str) -> None:
