...
from mockfirestore.aggregation import AggregationResult


class AsyncAggregationQuery:
    """Asynchronous mock implementation of Firestore AggregationQuery.

    This class implements aggregation operations over an asynchronous Firestore query.
    """

    def __init__(self, parent_query, alias=None):
        """Initialize the AsyncAggregationQuery.
    ...
    async def get(self, transaction=None, retry=None, timeout=None):
        ...
        docs = []
        async for doc in self._parent_query.stream(transaction=transaction):
            docs.append(doc)
