...
class UserGenerator:
    ...
    def encrypt(self, secret_key: str="", algorithm: str = "HS256", seconds_to_expire: int = 3600) -> str:
        """
    ...
    def decode_token(self, token: str, secret_key: str=None) -> str:
        ...
        if self.algorithm not in self.supported_algorithms:
            raise ValueError(f"Unsupported schema: {self.algorithm}. Supported: {self.supported_algorithms}")
    ...
    def verify_password(self, hashed_password: str, password: str = "") -> bool:
        ...
        return bcrypt.checkpw(actual_password.encode('utf-8'), hashed_password.encode('utf-8'))
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="User authentication with JWT and bcrypt")
    parser.add_argument("--save_path", default="authen/secret.json", help="Path to save the authorization JSON file")
