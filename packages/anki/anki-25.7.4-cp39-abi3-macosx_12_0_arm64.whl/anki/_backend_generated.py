...
class RustBackendGenerated:
 ...
 if the backup encountered an error."""
    ...
    def get_retention_workload(self, *, w: Iterable[float], search: str, before: float, after: float) -> float:
        message = anki.deck_config_pb2.GetRetentionWorkloadRequest(w=w, search=search, before=before, after=after)
