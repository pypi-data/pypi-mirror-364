...
class GetRetentionWorkloadRequest(google.protobuf.message.Message):
    ...
    search: builtins.str
    before: builtins.float
    after: builtins.float
    @property
    ...
    def ClearField(self, field_name: typing.Literal["after", b"after", "before", b"before", "search", b"search", "w", b"w"]) -> None: ...
...
class GetRetentionWorkloadResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["factor", b"factor"]) -> None: ...
