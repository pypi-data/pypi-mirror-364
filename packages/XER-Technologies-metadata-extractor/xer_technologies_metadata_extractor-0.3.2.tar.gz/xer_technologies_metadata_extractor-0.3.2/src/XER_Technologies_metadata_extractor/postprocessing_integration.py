...
# Add the postprocessing directory to the path
current_dir = Path(__file__).parent
postprocessing_dir = current_dir.parent.parent / "postprocessing"
...
try:
    ...
    from consolidated_processor import ConsolidatedProcessor
