...
def rnaspc_plot_embedding_spatial(adata, sample, sp_sample, image = 'hires', **kwargs):
    ...
    ymax, xmax, _ = adata.uns['spatial'][sp_sample]['images'][image].shape
    
    _yfrom = int(yfrom); _yto = int(yto)
    _xfrom = int(xfrom); _xto = int(xto)
    ...
    ax.imshow(
        adata.uns['spatial'][sp_sample]['images'][image][_yfrom:_yto, _xfrom:_xto, :],
        aspect = 'auto', extent = (_xfrom, _xto, _yfrom, _yto), interpolation = 'nearest',
        origin = 'lower'
    )
