...
#
# class Order(TradingVoucher, UserAuthored, UploadController, RecurrenceSet, EventGenerator, Duplicable):
# class Order(TradingVoucher, Voucher, RecurrenceSet, EventGenerator, Duplicable):
