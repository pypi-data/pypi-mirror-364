...
class Topic(BabelNamed, Publishable, Duplicable):
...
class Line(Referrable, Duplicable, ExcerptTitle, ContactRelated, Publishable):
...
class Course(Reservation, Duplicable, Publishable, MemoReferrable):
