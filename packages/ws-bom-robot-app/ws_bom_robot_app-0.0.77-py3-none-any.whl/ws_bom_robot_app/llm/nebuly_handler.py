...
class NebulyHandler(AsyncCallbackHandler):
    def __init__(self, llm_model: str | None, threadId: str = None, chat_history: list = [],  url: str = None, api_key: str = None, user_id: str | None = None):
        super().__init__()
    ...
    async def on_agent_finish(self, finish, *, run_id, parent_run_id = None, tags = None, **kwargs):
        ...
        message_history =  self._convert_to_json_format(self.chat_history)[:-1]
