...
from ..base import ProviderBase, OASIS_PROXY_URL
...
class OasisAzureOpenAI(ProviderBase, _AzureOpenAI):
    """
...
class OasisAsyncAzureOpenAI(ProviderBase, _AsyncAzureOpenAI):
    """
    ...
    def __init__(
        ...
        **azure_kw: Any,
        ...
        azure_kw.setdefault("api_key", "proxy_handle")
        azure_kw.setdefault("api_version", "proxy-handled")
        azure_kw.setdefault("azure_endpoint", self._resolve_base_url(proxy_url))
