...
class Site(object):
    ...
    def __init__(self, id='local', api_url='https://localhost/api', central_url='https://sdmc.scitran.io/api', deid_log_url=None, dimse_host=None, dimse_port=None, mfa_code_length=6, inactivity_timeout=None, name='Local', redirect_url='https://local.flywheel.io', registered=False, ssl_cert=None, upload_maximum_bytes='10737418240', proxy_cdn=False, gravatar_address='https://gravatar.com', pagination_limit=100):  # noqa: E501
