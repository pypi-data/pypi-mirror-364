...
This file contains tests for the EC2 MCP Server main module, including:
...
with patch("mcp.server.fastmcp.FastMCP", MockFastMCP):
    from awslabs.ec2_mcp_server.main import main, mcp
...
@patch("awslabs.ec2_mcp_server.main.sys.exit")
@patch("awslabs.ec2_mcp_server.main.logger")
@patch("awslabs.ec2_mcp_server.main.mcp")
@patch("awslabs.ec2_mcp_server.main.config")
...
@patch("awslabs.ec2_mcp_server.main.main")
def test_entry_point(mock_main):
    """Test the module's entry point."""
    # Save the current value of __name__
    original_name = sys.modules.get("awslabs.ec2_mcp_server.main", None)

    try:
        # Mock __name__ to trigger the entry point code
        sys.modules["awslabs.ec2_mcp_server.main"].__name__ = "__main__"
        ...
        if original_name:
            sys.modules["awslabs.ec2_mcp_server.main"].__name__ = original_name.__name__