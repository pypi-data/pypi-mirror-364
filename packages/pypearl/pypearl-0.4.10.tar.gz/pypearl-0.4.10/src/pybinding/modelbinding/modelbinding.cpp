...
PyTypeObject PyModelType = {
    ...
    .tp_name      = "pypearl.Model",
    .tp_basicsize = sizeof(PyModelObject),
    .tp_dealloc   = (destructor)PyModel_dealloc,
    .tp_flags     = Py_TPFLAGS_DEFAULT,
    .tp_doc       = "Neural Network Model",
    .tp_methods   = PyModel_methods,
    .tp_getset    = PyModel_getset,
    .tp_new       = PyModel_new,
    .tp_init      = (initproc)PyModel_init,
};
