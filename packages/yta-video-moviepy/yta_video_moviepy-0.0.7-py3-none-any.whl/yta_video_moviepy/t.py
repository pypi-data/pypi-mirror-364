...
class T:
    ...
    # Audio below
    def get_audio_frame_time_moments_from_frame_time(
        video_t: float,
        video_fps: float,
        audio_fps: float,
        do_invert_order: bool = False
    ...
    def get_frame_time_from_audio_frame_time(
        audio_t: float,
        video_fps: float
    ):
        """
    ...
    def get_frame_index_from_audio_frame_index(
        audio_index: int,
        video_fps: float,
        audio_fps: float
    ):
        ...
        ParameterValidator.validate_mandatory_positive_float('video_fps', video_fps, do_include_zero = False)
        ParameterValidator.validate_mandatory_positive_float('audio_fps', audio_fps, do_include_zero = False)

        return round(audio_index * (video_fps / audio_fps))
    
    def get_frame_time_from_audio_frame_index(
        audio_index: int,
        video_fps: float,
        audio_fps: float
    ):
        ...
        return T.frame_index_to_frame_time(
            T.get_frame_index_from_audio_frame_index(
                audio_index,
                video_fps,
                audio_fps
            ),
    ...
    def get_frame_index_from_audio_frame_time(
        audio_t: float,
        video_fps: float,
        audio_fps: float
    ):
        ...
        return T.get_frame_index_from_audio_frame_index(
            T.frame_time_to_frame_index(
                audio_t,
                audio_fps
            ),
            video_fps,
...
# 'audio_frame_index_to_video_frame_index'
# instead of 'get_frame_index_from_audio_frame_index'