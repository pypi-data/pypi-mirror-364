...
from yta_video_base.frame.utils import frame_time_to_frame_index, get_video_frame_index_from_video_audio_frame_t
from yta_video_base.video import VideoWrapped as BaseVideoWrapped
...
class VideoWrapped:
    ...
    def final_video(
        ...
        def modify_video_frame_by_frame(
            ...
            """
            frame = get_frame(t)
            frame_index = frame_time_to_frame_index(t, moviepy_video.fps)
        ...
        def modify_audio_frame_by_frame(
            ...
            frame = get_frame(t)
            frame_index = get_video_frame_index_from_video_audio_frame_t(t[len(t) // 2], moviepy_video.fps)
