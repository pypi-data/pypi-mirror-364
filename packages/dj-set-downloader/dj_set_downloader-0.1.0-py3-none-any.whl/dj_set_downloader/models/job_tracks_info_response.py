...
class JobTracksInfoResponse(BaseModel):
    """
    JobTracksInfoResponse
    """ # noqa: E501
    download_all_url: Optional[StrictStr] = None
    job_id: Optional[StrictStr] = None
    total_tracks: Optional[StrictInt] = None
    tracks: Optional[List[DomainTrack]] = None
    __properties: ClassVar[List[str]] = ["download_all_url", "job_id", "total_tracks", "tracks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tracks": [DomainTrack.from_dict(_item) for _item in obj["tracks"]] if obj.get("tracks") is not None else None
        })
        return _obj
