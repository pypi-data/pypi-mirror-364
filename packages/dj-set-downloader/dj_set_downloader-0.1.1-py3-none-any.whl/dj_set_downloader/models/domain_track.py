...
class DomainTrack(BaseModel):
    ...
    track_number: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["artist", "available", "download_url", "end_time", "name", "size_bytes", "start_time", "track_number"]
