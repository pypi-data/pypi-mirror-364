...
class MagiqueServer:
    ...
    def _setup_routes(self):
        ...
        async def root():
            ...
            return {"message": "Magique Server is running", "test_page": "/test"}
    ...
    async def handle_reverse_invoke_result(self, request: dict) -> None:
