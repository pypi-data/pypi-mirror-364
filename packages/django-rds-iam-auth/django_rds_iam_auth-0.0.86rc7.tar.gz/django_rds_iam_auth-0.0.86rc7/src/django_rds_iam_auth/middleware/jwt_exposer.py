...
class JWTExposerMiddleware:
    ...
    def __call__(self, request: WSGIRequest, *args, **kwargs):
        ...
        self.expose_additional_headers(request)
    ...
    def expose_additional_headers(self, request: WSGIRequest) -> None:
        """
        Placeholder for exposing additional headers from the request.
