...
class DateRangeFilter(BaseRangeFilter):
    ...
    def get_template(self):
        ...
        if django.VERSION[:2] <= (4, 0):
            return "rangefilter2/date_filter_4_0.html"
...
class NumericRangeFilter(BaseRangeFilter):
    ...
    def get_template(self):
        if django.VERSION[:2] <= (4, 0):
            return "rangefilter2/numeric_filter_4_0.html"

        return "rangefilter2/numeric_filter.html"
...
class DateRangeQuickSelectListFilter(admin.DateFieldListFilter, DateRangeFilter):
    ...
    def get_template(self):
        return "rangefilter2/date_range_quick_select_list_filter.html"
