...
def calculate_group_index(
    ...
    peaks = find_data_peaks(my_data, data_key=data_key, prominence=prominence, distance=5)
...
def calculate_waveguide_losses(
    ...
    dips = find_data_peaks(
        my_data, data_key=data_key, reverse=True, prominence=prominence, distance=5
    ).get_data("peaks")
