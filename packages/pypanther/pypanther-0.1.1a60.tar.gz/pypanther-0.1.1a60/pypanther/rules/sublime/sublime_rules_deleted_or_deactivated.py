...
@panther_managed
class SublimeRulesDeletedOrDeactivated(Rule):
    default_description = "A Sublime User disabled or deleted some rule(s)."
    display_name = "Sublime Rules Deleted Or Deactivated"
    default_runbook = "Assess if this was done by the user for a valid business reason. Be vigilant to re-enable the rules if it's in the best security interest for your organization's security posture."
    default_reference = "https://docs.sublime.security/docs/rules-overview"
    default_severity = Severity.MEDIUM
    alert_title = "Sublime rules were deleted or deactivated"
    log_types = [LogType.SUBLIME_AUDIT]
    id = "Sublime.Rules.Deleted.Or.Deactivated-prototype"
    reports = {"MITRE ATT&CK": ["TA0005:T1562.001"]}
    SUSPICIOUS_EVENTS = ["rules.delete", "rules.deactivate"]
