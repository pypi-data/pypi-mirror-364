...
class CTCLabelDecode:
    ...
    def get_character(
        ...
        character_list = self.insert_special_char(character_list, " ", len(character_list))
    ...
    @staticmethod
    def insert_special_char(character_list: List[str], special_char: str, loc: int = -1) -> List[str]:
    ...
    def decode(
        ...
        for batch_idx in range(batch_size):
            ...
            char_list = [self.character[text_id] for text_id in token_indices[selection]]
            text = "".join(char_list)
            ...
            if return_word_box:
                ...
                rec_word_info.line_txt_len = len(token_indices) * wh_ratio_list[batch_idx] / max_wh_ratio
