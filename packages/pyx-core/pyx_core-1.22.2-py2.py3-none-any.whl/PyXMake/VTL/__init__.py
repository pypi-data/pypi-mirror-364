...
class Command(object):
    ...
    def typer(cls, **kwargs):
        ...
        try:
            ...
            def common(
                ctx: Context,
                version: Optional[bool] = Option(None, "--version", "-v", help=cls.__help__["info"], callback=__version_callback, is_eager=True)):
            ...
            def run( namespace: Enum("MethodObjectKind", {x:x for x in options["choices"]}) = Argument(None, metavar="command",case_sensitive=False, help = cls.__help__["method"]) ):
                """
