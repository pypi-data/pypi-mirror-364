...
# --- Logging Configuration for suppressing informational messages ---
# These lines suppress the Flask CLI startup messages and Werkzeug access logs.
# They DO NOT prevent error tracebacks from showing up when debug=True.
logging.getLogger('flask.cli').disabled = True
logging.getLogger('werkzeug').disabled = True
# ------------------------------------------------------------------

print("Created By Raven Studio") # This will still print unless you explicitly suppress stdout
