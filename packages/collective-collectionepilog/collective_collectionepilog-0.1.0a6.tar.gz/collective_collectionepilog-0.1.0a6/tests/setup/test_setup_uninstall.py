from collective.collectionepilog import PACKAGE_NAME
...
class TestSetupUninstall:
    ...
    def test_addon_uninstalled(self, installer):
        """Test if collective.collectionepilog is uninstalled."""
        assert installer.is_product_installed(PACKAGE_NAME) is False

    def test_browserlayer_not_registered(self, browser_layers):
        """Test that IBrowserLayer is not registered."""
        from collective.collectionepilog.interfaces import IBrowserLayer
