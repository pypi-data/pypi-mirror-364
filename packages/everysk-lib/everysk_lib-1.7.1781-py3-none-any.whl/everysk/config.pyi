...
class Settings:
    ...
    USER_CACHE_LOCK_EXPIRATION_TIME: float
    USER_CACHE_LOCK_MAX_EXPIRATION_TIME: float
    USER_CACHE_LOCK_MIN_EXPIRATION_TIME: float
