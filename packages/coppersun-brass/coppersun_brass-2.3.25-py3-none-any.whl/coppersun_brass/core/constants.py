...
# Resolvable observation types for issue resolution detection
RESOLVABLE_TYPES = [
    ObservationTypes.TODO,
    ObservationTypes.SECURITY_ISSUE,
    ObservationTypes.CODE_ISSUE,
    ObservationTypes.CODE_SMELL,
    ObservationTypes.PERSISTENT_ISSUE,
    ObservationTypes.PERFORMANCE_ISSUE
]
