...
def check_prime(inp) : 
    ...
    if temp % 2 == 0 :
        return 0    # there is no even number that is prime except '2', that is check before.
...
def help() : 
    """
    Provides details about all functions in this module, their usage,
    and information about the module author.

    Returns:
        A multi-line string containing the help information.
    """
    help_text = """
                 *** Welcome to adcustom Python Module! ***

    This module provides a collection of useful mathematical and string
    ...
    1.  Function: check_prime(num)
        ...
        Output: 1 (if prime), 0 (if not prime), None (for invalid/negative input).

    -------------------------------------------------------------------
    2.  Function: factorial(num)
        Description: Calculates the factorial of a non-negative integer.
        Input: num (non-negative integer)
        Output: Factorial value (integer), None (for negative or invalid input).

    -------------------------------------------------------------------
    3.  Function: permutation(total, chosen)
        Description: Calculates the number of permutations P(n, k).
        Input: total (n, integer), chosen (k, integer)
        Output: Number of permutations (integer), None (if k > n or invalid input).

    -------------------------------------------------------------------
    4.  Function: combination(total, chosen)
        Description: Calculates the number of combinations C(n, k).
        Input: total (n, integer), chosen (k, integer)
        Output: Number of combinations (integer), 0 (if k > n),
                None (for invalid/negative input).

    -------------------------------------------------------------------
    5.  Function: string_reverse(text)
        Description: Reverses the given string.
        Input: text (string)
        Output: Reversed string, None (for empty or non-string input).

    -------------------------------------------------------------------
    6.  Function: matrix_addition(mat1, mat2)
        Description: Adds two matrices.
        Input: mat1 (list of lists of numbers), mat2 (list of lists of numbers)
        Output: String representation of the resultant matrix,
                None (for incompatible dimensions or invalid format).

    -------------------------------------------------------------------
    7.  Function: matrix_multiplication(mat1, mat2)
    ...
    -------------------------------------------------------------------
    8.  Function: matrix_transpose(mat)
        Description: Transposes a matrix.
        Input: mat (list of lists of numbers)
        Output: String representation of the transposed matrix,
                None (for invalid matrix format).

    -------------------------------------------------------------------
    9. Function: determinant_value(mat)
        Description: Calculates the determinant of a square matrix (1x1, 2x2, 3x3).
        Input: mat (list of lists of numbers, representing a square matrix)
        Output: Determinant value (number), None (for non-square or unsupported dimensions).

    -------------------------------------------------------------------
    10. Function: mean(data_list)
        Description: Calculates the arithmetic mean (average) of a list of numbers.
        Input: data_list (list of numbers)
        Output: Mean value (float), None (for empty list or non-numeric values).

    -------------------------------------------------------------------
    11. Function: median(data_list)
        Description: Calculates the median of a list of numbers.
        Input: data_list (list of numbers)
        Output: Median value (float), None (for empty list or non-numeric values).

    -------------------------------------------------------------------
    12. Function: mode(data_list)
        Description: Calculates the mode(s) and their frequency from a list of data.
        Input: data_list (list of any data type)
        Output: A tuple (list_of_modes, highest_count), None (for empty or invalid input).

    -------------------------------------------------------------------
    Module Author: Amit Dutta
    Contact: amitdutta4255@gmail.com
