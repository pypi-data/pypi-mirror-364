...
class ManagedProviderExecutor(ToolExecutor):
    ...
    async def execute(self, tool_calls: List[Dict[str, Any]], context: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            # Create response object for provider
...
class ToolRegistry:
    ...
    def categorize_tool_call(self, tool_call: Dict[str, Any]) -> ToolCategory:
        """
    ...
    async def execute_tool_calls(self, tool_calls: List[Dict[str, Any]], context: Dict[str, Any]) -> List[Dict[str, Any]]:
        """
        ...
        sorted_results = []
        for call in tool_calls:
            if call["id"] in tool_call_id_to_result:
                sorted_results.append(tool_call_id_to_result[call["id"]])
