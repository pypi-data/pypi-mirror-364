...
Example: vol_cs_dept """
    ...
    s3_bucket = marshmallow_fields.Nested("netapp_ontap.models.container_volume_s3_bucket.ContainerVolumeS3BucketSchema", unknown=EXCLUDE, data_key="s3_bucket", allow_none=True)
    r""" The S3 bucket """
