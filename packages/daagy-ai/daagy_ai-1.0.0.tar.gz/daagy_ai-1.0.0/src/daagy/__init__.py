...
# Gemini Setup
#client = genai.Client(api_key="AIzaSyD_VrWqvy24nIDOtgkJZlr6aF9pxXIENJ0")  # Replace with your real API key
...
"""
#5. If asked to go to any folder then first go to the root folder and from there go to the specified folder and then perform the given task.
