...
def test_equal():
    ...
    assert (TimeOfHour("10:00", "12:00") & TimeOfHour("11:00", "13:00")) == (
        TimeOfHour("10:00", "12:00") & TimeOfHour("11:00", "13:00")
    )
    assert (TimeOfHour("10:00", "12:00") | TimeOfHour("11:00", "13:00")) == (
        TimeOfHour("10:00", "12:00") | TimeOfHour("11:00", "13:00")
    )
...
def test_str():
    assert (
        str(TimeOfDay("10:00", "12:00") & TimeOfDay("16:00", "17:00"))
        == "10 hours - 12 hours & 16 hours - 17 hours"
    )
    assert (
        str(TimeOfDay("10:00", "12:00") | TimeOfDay("16:00", "17:00"))
        == "10 hours - 12 hours | 16 hours - 17 hours"
...
def test_repr():
    assert (
        repr(TimeOfDay("10:00", "12:00") & TimeOfDay("16:00", "17:00"))
        == "All(TimeOfDay(_start=36000000000, _end=43200000000), TimeOfDay(_start=57600000000, _end=61200000000))"
    )
    assert (
        repr(TimeOfDay("10:00", "12:00") | TimeOfDay("16:00", "17:00"))
        == "Any(TimeOfDay(_start=36000000000, _end=43200000000), TimeOfDay(_start=57600000000, _end=61200000000))"
    )
