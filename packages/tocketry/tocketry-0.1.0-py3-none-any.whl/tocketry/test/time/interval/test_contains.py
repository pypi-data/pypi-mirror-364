...
@pytest.mark.parametrize(
    ...
    [
        # Regular
        pytest.param(
            datetime(2020, 1, 1, 11, 00), "10:00", "12:00", id="Middle of interval"
        ),
        # Left is closed
        pytest.param(
            datetime(2020, 1, 1, 10, 00), "10:00", "12:00", id="Left of interval"
        ),
        pytest.param(
        ...
        # Full Cycle
        pytest.param(datetime(2020, 1, 1, 10, 00), None, None, id="Full interval"),
        pytest.param(
            datetime(2020, 1, 1, 10, 00), "10:00", "10:00", id="Joint of full interval"
        ),
        pytest.param(
            datetime(2020, 1, 1, 12, 00), "10:00", "10:00", id="Right of full interval"
        ),
        pytest.param(
            datetime(2020, 1, 1, 8, 00), "10:00", "10:00", id="Left of full interval"
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Right is opened
        pytest.param(
            datetime(2020, 1, 1, 12, 00), "10:00", "12:00", id="Right of interval"
        ),
        pytest.param(
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Full Cycle
        pytest.param(datetime(2024, 1, 1, 00, 00), None, None, id="Full interval"),
        pytest.param(
            datetime(2024, 1, 2, 00, 00), "Tue", "Tue", id="Joint of full interval"
        ),
        pytest.param(
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Left is closed
        pytest.param(
            datetime(2020, 1, 2, 0, 00), TimeOfMonth("2.", "3."), id="Left of interval"
        ),
        pytest.param(
        ...
        # Full Cycle
        pytest.param(
            datetime(2020, 1, 31), TimeOfMonth(None, None), id="Full interval"
        ),
        pytest.param(
            datetime(2020, 1, 5),
        ...
        pytest.param(
            datetime(2020, 1, 6), TimeOfMonth.starting("5."), id="Left of full interval"
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            datetime(2020, 1, 4), TimeOfMonth("2.", "3."), id="Right from interval"
        ),
        # Right is opened
        pytest.param(
            datetime(2020, 1, 21), TimeOfMonth("22.", "2."), id="Right of over month"
        ),
        pytest.param(
            datetime(2020, 1, 3), TimeOfMonth("22.", "2."), id="Left of over month"
        ),
    ],
)
