...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("always false", AlwaysFalse(), id="AlwaysFalse"),
        pytest.param(
            "always true & always true", AlwaysTrue() & AlwaysTrue(), id="All"
        ),
        pytest.param(
            "always true | always true", AlwaysTrue() | AlwaysTrue(), id="Any"
        ),
        pytest.param("~always true", Not(AlwaysTrue()), id="Not"),
        pytest.param("~~always true", ~~AlwaysTrue(), id="Nested Not"),
        pytest.param("~(always true)", ~AlwaysTrue(), id="Closured Not"),
        pytest.param(
        ...
        pytest.param("", AlwaysFalse(), id="Empty", marks=pytest.mark.xfail),
    ],
)
...
@pytest.mark.parametrize(
    "cond_str",
    [
        pytest.param("daily between 20:00 and 23:59", id="daily between"),
    ],
)
