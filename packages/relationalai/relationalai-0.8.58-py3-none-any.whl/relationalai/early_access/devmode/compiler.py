        ...
        if updates and not lookups and not nots and not aggs and not logicals:
            ...
            if updates:
                    ...
                    if not self._is_value_type_population_relation(r):
                        ...
                        if aggs:
                            ...
                            select = self._make_match_select(lookups, aliases, unions, nots, constructs, True) \
                                if unions and lookups else self._make_select(lookups, aliases, nots, unions, constructs, True)
                ...
                select = self._make_match_select(lookups, aliases, unions, nots, constructs, distinct) \
                    if unions and lookups else self._make_select(lookups, aliases, nots, unions, constructs, distinct)
