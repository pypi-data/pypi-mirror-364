...
__all__ = ['BaseFaceEnhancer', 'BaseModelLoader', 'OnnxFaceEnhancer', 'TrtFaceEnhancer', 'cp', 'onnxruntime', 'os', 'px', 'trt']
class BaseFaceEnhancer(visagene.base.BaseModelLoader):
    """
