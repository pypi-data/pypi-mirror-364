...
class DisplayEmbryo():
    ...
    def two_genes_tab(self):
        ...
        def adj_int():
            ...
            I = np.clip(I, 0, 1)
            low_threshold = np.percentile(I, low_int * 100,interpolation='higher')
            high_threshold = np.percentile(I, high_int * 100,interpolation='lower')
            low_mask = I < low_threshold
            high_mask = I > high_threshold
            ...
            scale =(high_threshold - low_threshold)
            r_mid = (r[mid_mask] - low_threshold) / scale
            g_mid = (g[mid_mask] - low_threshold) / scale
            b_mid = (b[mid_mask] - low_threshold) / scale
        ...
        def container():
            ...
            type_gene1_name = widgets.Label(value="Gene 1 Name:")
            type_gene2_name = widgets.Label(value="Gene 2 Name:")
    ...
    def three_genes_tab(self):
        ...
        def container():
            ...
            type_gene1_name = widgets.Label(value="Gene 1 Name:")
            type_gene2_name = widgets.Label(value="Gene 2 Name:")
            type_gene3_name = widgets.Label(value="Gene 3 Name:")
