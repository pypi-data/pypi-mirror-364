...
class CSwitchCase(CItem):

    def __init__(self, case: str, body: CBody):
...
class CSwitchDefault(CItem):

    def __init__(self, body: CBody):
...
class CSwitch(CItem):
    ...
    def __init__(self, variable: str, body: CBody):
