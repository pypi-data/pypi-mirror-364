...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'tensorflow_serving.config.ssl_config_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'\370\001\001'
  _globals['_SSLCONFIG']._serialized_start=66
  _globals['_SSLCONFIG']._serialized_end=160
