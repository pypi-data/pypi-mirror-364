#!/usr/bin/env python3
"""
Deduplication Manager - Handles CLAUDE.md file deduplication in parent directory hierarchy
================================================================================

This module manages the deduplication of CLAUDE.md files to prevent duplicate
context loading in Claude Code.

Business Logic:
- Walk up the directory tree to find all CLAUDE.md files
- Identify framework deployment templates vs project files
- Keep only the rootmost framework template
- Preserve all project-specific CLAUDE.md files
"""
...
class DeduplicationManager:
    """Manages deduplication of CLAUDE.md files in parent directories."""
