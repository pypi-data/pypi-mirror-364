...
framework files like framework/CLAUDE.md are protected from accidental
deletion and maintain proper permissions.
"""
...
class FrameworkProtector:
    ...
    def protect_framework_template(self, framework_template_path: Path) -> None:
        ...
        try:
            ...
            # Check that the filename is CLAUDE.md and path contains "framework"
            if (framework_template_path.name != "CLAUDE.md" or 
