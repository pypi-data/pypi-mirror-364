...
class WorkcellManager:
  ...
  _ergo_parameters = constants.default_ergo_parameters
  ...
  def __init__(
    ...
    if is_test:
      self._ergo_parameters = constants.test_ergo_parameters
  ...
  def update_ergo_status(
    ...
    if (
      ...
      self.ui.remove_element(constants.ERGO_REMINDER_POPUP_ID)
    elif (
  ...
  def _update_ergo_period_display(self) -> None:
    ...
    while True:
      ...
      color = constants.ERGO_REQUIREMENT_MET_COLOR
      if minutes >= int(
          self._ergo_parameters.alert_delay_seconds / 60
      ):  # Needs input
        color = constants.ERGO_RECOMMENDED_COLOR
      self.ui.create_or_update_text(
          text_id="ergo_period",
          text=text,
          spec=robotics_ui_pb2.UISpec(
  ...
  def _check_ergo_duration(self) -> None:
    ...
    while True:
      ...
      print(f"login_duration_minutes: {non_ergo_login_duration_minutes}")
      ...
      print(
          "self._total_ergo_break_duration:"
          f" {total_ergo_break_duration_minutes}"
      )
      print(f"required_ergo_duration: {required_ergo_duration_minutes}")

      print(
          f"self._ergo_reminder_popup_shown: {self._ergo_reminder_popup_shown}"
      )
      ...
      if total_ergo_break_duration_minutes < required_ergo_duration_minutes:
        ...
        if (
          ...
          self.ui.create_dialog(
              dialog_id=constants.ERGO_REMINDER_POPUP_ID,
              title="Ergo Reminder",
              msg=constants.ERGO_BREAK_REQUIRED_MESSAGE.format(
