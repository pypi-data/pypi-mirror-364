...
def import_existing_history():
	...
	if Config.LIMINAL_INSTALLER_ATUIN_HISTORY_SEED_FILE:
		...
		run_command(['sqlite3', Paths.SQLITE_DB, f'.import --csv --skip 1 {seed_file} history'])
		run_command(['sqlite3', Paths.SQLITE_DB, "UPDATE history SET deleted_at = NULL WHERE deleted_at = '';"])
		return
