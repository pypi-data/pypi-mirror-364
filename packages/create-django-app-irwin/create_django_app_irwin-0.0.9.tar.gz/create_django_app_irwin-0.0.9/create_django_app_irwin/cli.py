...
'''
    write_file(app_name, 'urls.py', urls_content)
...
"""
    ...
    # 6. models/__init__.py (CORRIGÉ)
    write_file(os.path.join(app_name, 'models'), '__init__.py', '')
    
    # 7. views/__init__.py (CORRIGÉ)
    write_file(os.path.join(app_name, 'views'), '__init__.py', '')
    
    # 8. tests.py (CORRIGÉ - était défini mais jamais créé)
