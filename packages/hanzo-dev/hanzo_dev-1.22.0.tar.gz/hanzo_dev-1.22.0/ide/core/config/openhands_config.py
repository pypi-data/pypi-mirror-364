...
class IDEConfig(BaseModel):
    ...
    Attributes:
        ...
        run_as_ide: Whether to run as ide.
        ...
        mcp_host: Host for IDE' default MCP server
    ...
    file_store_path: str = Field(default='~/.ide')
    ...
    run_as_ide: bool = Field(default=True)
    ...
    mcp_host: str = Field(default=f'localhost:{os.getenv("port", 8888)}')
    ...
    def model_post_init(self, __context: Any) -> None:
        ...
        if not IDEConfig.defaults_dict:  # Only set defaults_dict if it's empty
            IDEConfig.defaults_dict = model_defaults_to_dict(self)
