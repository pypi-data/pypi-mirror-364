...
class SandboxConfig(BaseModel):
    ...
    Attributes:
        ...
        trusted_dirs: List of directories that can be trusted to run the IDE CLI.
        vscode_port: The port to use for VSCode. If None, a random port will be chosen.
            This is useful when deploying IDE in a remote machine where you need to expose a specific port.
    """
    ...
    enable_auto_lint: bool = Field(
        default=False
    )  # once enabled, IDE would lint files after editing
