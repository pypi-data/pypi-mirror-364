...
This directory contains the core components of IDE.

This diagram provides an overview of the roles of each component and how they communicate and collaborate.
![IDE System Architecture Diagram (July 4, 2024)](../docs/static/img/system_architecture_overview.png)

## Classes

The key classes in IDE are:
...
* Server: brokers IDE sessions over HTTP, e.g. to drive the frontend
...
The EventStream serves as the backbone for all communication in IDE.
...
Please refer to the [documentation](https://docs.hanzo.ai/usage/architecture/runtime) to learn more about `Runtime`.
