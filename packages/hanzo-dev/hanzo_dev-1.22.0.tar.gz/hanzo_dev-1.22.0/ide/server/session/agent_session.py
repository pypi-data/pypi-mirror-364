...
from ide.controller.replay import ReplayManager
from ide.controller.state.state import State
from ide.core.config import AgentConfig, LLMConfig, IDEConfig
from ide.core.exceptions import AgentRuntimeUnavailableError
from ide.core.logger import IDELoggerAdapter
...
from ide.mcp import add_mcp_tools_to_agent
...
from ide.security import SecurityAnalyzer, options
from ide.storage.data_models.user_secrets import UserSecrets
from ide.storage.files import FileStore
from ide.utils.async_utils import EXECUTOR, call_sync_from_async
...
class AgentSession:
    ...
    async def _create_memory(
        ...
        if self.runtime:
            ...
            # loads microagents from repo/.ide/microagents
