...
from ide.server.settings import Settings
from ide.server.shared import server_config
...
class UserAuth(ABC):
    ...
    This is an extension point in IDE that allows applications to provide their own
