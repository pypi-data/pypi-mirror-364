...
class ConversationManager(ABC):
    """Abstract base class for managing conversations in IDE.
    ...
    This is an extension point in IDE, that applications built on it can use to modify behavior via server configuration, without modifying its code.
    ...
    The implementation class is instantiated via get_impl() in ide.server.shared.py.
    """
