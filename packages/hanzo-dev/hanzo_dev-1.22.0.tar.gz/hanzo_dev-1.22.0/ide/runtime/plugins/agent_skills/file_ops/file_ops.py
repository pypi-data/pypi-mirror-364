"""File operations module for IDE agent.

This module provides a collection of file manipulation skills that enable the IDE
...
from ide.linter import DefaultLinter, LintResult
