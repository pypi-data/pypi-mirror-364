...
function activate(context) {
    ...
    let startMonitorCommand = vscode.commands.registerCommand('ide-memory-monitor.startMemoryMonitor', function () {
        memoryMonitor.start();
    });

    // Register memory monitor stop command
    let stopMonitorCommand = vscode.commands.registerCommand('ide-memory-monitor.stopMemoryMonitor', function () {
        memoryMonitor.stop();
    });

    // Register memory details command
    let showMemoryDetailsCommand = vscode.commands.registerCommand('ide-memory-monitor.showMemoryDetails', function () {
