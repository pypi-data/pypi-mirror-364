...
from ide.events.action.agent import AgentFinishAction
...
from ide.storage.locations import get_conversation_agent_state_filename
...
class State:
    """
    Represents the running state of an agent in the IDE system, saving data of its operation and memory.
    ...
    def to_llm_metadata(self, agent_name: str) -> dict:
        return {
            ...
            'trace_version': ide.__version__,
            'tags': [
                f'agent:{agent_name}',
                f'web_host:{os.environ.get("WEB_HOST", "unspecified")}',
                f'ide_version:{ide.__version__}',
            ],
        }
