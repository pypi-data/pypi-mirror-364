...
from ide.events.serialization.event import truncate_content
...
class ConversationMemory:
    ...
    def _process_action(
        ...
        Args:
            action: The action to convert. Can be one of:
                ...
                - FileReadAction: For reading files using ide-aci commands
    ...
    def _process_observation(
        ...
        - FileReadObservation: Formats file reading results from ide-aci
        ...
        if isinstance(obs, CmdOutputObservation):
            ...
            )  # Content is already truncated by ide-aci
