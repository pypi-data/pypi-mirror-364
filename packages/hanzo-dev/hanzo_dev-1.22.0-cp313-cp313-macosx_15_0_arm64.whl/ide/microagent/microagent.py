...
from ide.microagent.types import InputMetadata, MicroagentMetadata, MicroagentType
...
class BaseMicroagent(BaseModel):
    ...
    def load(
        ...
        # Legacy repo instructions are stored in .ide_instructions
        if path.name == '.ide_instructions':
...
class RepoMicroagent(BaseMicroagent):
    ...
    RepoMicroagents are loaded from `.ide/microagents/repo.md` files within repositories
...
def load_microagents_from_dir(
    ...
    Args:
        microagent_dir: Path to the microagents directory (e.g. .ide/microagents)
