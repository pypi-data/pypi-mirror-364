...
from ide.core.exceptions import LLMResponseError
from ide.events.event import Event
from ide.events.observation import CmdOutputMetadata
from ide.events.serialization import event_to_dict
from ide.llm.metrics import Metrics


class IDEJSONEncoder(json.JSONEncoder):
...
def dumps(obj, **kwargs):
    ...
    if 'cls' not in encoder_kwargs:
        encoder_kwargs['cls'] = IDEJSONEncoder
