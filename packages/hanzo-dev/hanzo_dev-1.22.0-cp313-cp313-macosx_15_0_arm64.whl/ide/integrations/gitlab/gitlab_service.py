...
class GitLabService(BaseGitService, GitService):
    ...
    This is an extension point in IDE that allows applications to customize GitLab
...
gitlab_service_cls = os.environ.get(
    'IDE_GITLAB_SERVICE_CLS',
    'ide.integrations.gitlab.gitlab_service.GitLabService',
)
