...
from ide.integrations.github.queries import (
...
class GitHubService(BaseGitService, GitService):
    ...
    This is an extension point in IDE that allows applications to customize GitHub
...
github_service_cls = os.environ.get(
    'IDE_GITHUB_SERVICE_CLS',
    'ide.integrations.github.github_service.GitHubService',
)
