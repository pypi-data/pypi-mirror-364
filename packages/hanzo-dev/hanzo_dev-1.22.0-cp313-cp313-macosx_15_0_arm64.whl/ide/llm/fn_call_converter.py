...
from ide.llm.tool_names import (
    BROWSER_TOOL_NAME,
...
# NOTE: we need to make sure these examples are always in-sync with the tool interface designed in ide/agenthub/codeact_agent/function_calling.py
...
Requirement already satisfied: Jinja2>=3.1.2 in /home/ide/.local/lib/python3.10/site-packages (from flask) (3.1.3)
Requirement already satisfied: MarkupSafe>=2.0 in /home/ide/.local/lib/python3.10/site-packages (from Jinja2>=3.1.2->flask) (2.1.5)
