...
from ide.core.logger import LOG_DIR
...
class LLMConfig(BaseModel):
    ...
    Attributes:
        ...
        custom_llm_provider: The custom LLM provider to use. This is undocumented in ide, and normally not used. It is documented on the litellm side.
    ...
    openrouter_app_name: str = Field(default='IDE')
    ...
    def model_post_init(self, __context: Any) -> None:
        ...
        # Azure issue: https://github.com/hanzoai/ide/issues/7755
