...
from ide.core.config.condenser_config import CondenserConfig, NoOpCondenserConfig
...
class AgentConfig(BaseModel):
    ...
    """The classpath of the agent to use. To be used for custom agents that are not defined in the ide.agenthub package."""
