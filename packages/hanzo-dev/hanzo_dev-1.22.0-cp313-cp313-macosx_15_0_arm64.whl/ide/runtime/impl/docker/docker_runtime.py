...
from ide.core.logger import DEBUG, DEBUG_RUNTIME
...
from ide.runtime.builder import DockerRuntimeBuilder
from ide.runtime.impl.action_execution.action_execution_client import (
    ActionExecutionClient,
)
from ide.runtime.impl.docker.containers import stop_all_containers
...
from ide.runtime.utils.command import (
    DEFAULT_MAIN_MODULE,
    get_action_execution_server_startup_command,
)
from ide.runtime.utils.log_streamer import LogStreamer
from ide.runtime.utils.runtime_build import build_runtime_image
from ide.utils.async_utils import call_sync_from_async
from ide.utils.shutdown_listener import add_shutdown_listener
from ide.utils.tenacity_stop import stop_if_should_exit

CONTAINER_NAME_PREFIX = 'ide-runtime-'
...
class DockerRuntime(ActionExecutionClient):
    ...
    def _process_volumes(self) -> dict[str, dict[str, str]]:
        ...
        # Legacy mounting with workspace_* parameters
            ...
            # e.g. result would be: {"/home/user/ide/workspace": {'bind': "/workspace", 'mode': 'rw'}}
    ...
    def init_container(self) -> None:
        ...
        try:
            ...
            self.container = self.docker_client.containers.run(
                ...
                ports=port_mapping,
                working_dir='/ide/code/',  # do not change this!
    ...
    def close(self, rm_all_containers: bool | None = None) -> None:
        ...
        Parameters:
        - rm_all_containers (bool): Whether to remove all containers with the 'ide-sandbox-' prefix
        """
        super().close()
