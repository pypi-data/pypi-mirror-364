...
class ConversationValidator:
    ...
    3. Setting IDE_CONVERSATION_VALIDATOR_CLS environment variable to the fully qualified name of the class
...
def create_conversation_validator() -> ConversationValidator:
    conversation_validator_cls = os.environ.get(
        'IDE_CONVERSATION_VALIDATOR_CLS',
        'ide.storage.conversation.conversation_validator.ConversationValidator',
    )
