...
from ide.server.utils import get_conversation as get_conversation_object
from ide.server.utils import get_conversation_store
...
from ide.utils.async_utils import wait_all
from ide.utils.conversation_summary import get_default_conversation_title
...
def generate_prompt_template(events: str) -> str:
    env = Environment(loader=FileSystemLoader('ide/microagent/prompts'))
