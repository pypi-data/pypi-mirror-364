...
from ide.microagent.types import InputMetadata
...
from ide.server.shared import conversation_manager, file_store
from ide.server.user_auth import get_user_id
from ide.server.utils import get_conversation, get_conversation_metadata
