...
from ide.agenthub.codeact_agent.function_calling import combine_thought
from ide.agenthub.codeact_agent.tools import FinishTool
from ide.agenthub.loc_agent.tools import (
    SearchEntityTool,
    SearchRepoTool,
...
def response_to_actions(
    ...
    if hasattr(assistant_msg, 'tool_calls') and assistant_msg.tool_calls:
        ...
        # Process each tool call to IDE action
