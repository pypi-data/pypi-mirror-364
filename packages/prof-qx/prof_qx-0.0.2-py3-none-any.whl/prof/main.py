...
class TelegramSignalListener:
	def __init__(A):A.config={};A.telegram_client=_A;A.running=_C;A.print_lock=asyncio.Lock();A.signals_lock=asyncio.Lock();A.pending_signals=[];A.TIMEZONE=ZoneInfo('Etc/GMT-4');A.reconnect_event=asyncio.Event();A.monitoring_task=_A
