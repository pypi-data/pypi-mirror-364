...
import os
import logging
from sensetable.query import query_bp
from sensetable.local_file_system import fs_bp
from sensetable.pages import pages_bp
from sensetable.s3 import s3_bp
from sensetable.settings import SenseTableSettings
...
class SenseTableApp:
    ...
    def dev(self):
        self.create_app().run(debug=True, host='0.0.0.0', port=8000)

    def prod(self, host: str = '0.0.0.0', port: int = 8000):
