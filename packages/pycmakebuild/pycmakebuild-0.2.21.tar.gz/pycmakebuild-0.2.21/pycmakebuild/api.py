...
class Source(object):
    ...
    def __init__(
        ...
        self.cmake_prefix_path: list = [
            self.replace_string_by_vars(p, vars) for p in cmake_prefix_path
        ]
        self.other_build_params: list = other_build_params
