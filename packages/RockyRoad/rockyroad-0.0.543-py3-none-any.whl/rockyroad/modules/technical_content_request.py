...
class Technical_Content_Request(Consumer):
    """Interface to Technical Content Request resource for the RockyRoad API."""
    ...
    class __Requests(Consumer):
        """Interface to Technical Content Requests resource for the RockyRoad API."""
        ...
        @returns.json
        @http_get("technical-content/requests")
        def list(
            self,
            status: Query = None,
            priority: Query = None,
        ...
        @returns.json
        @http_get("technical-content/requests/{uid}")
        def get(
            self,
            uid: str,
        ):
    ...
    class __Logs(Consumer):
        """Interface to Technical Content Logs resource for the RockyRoad API."""
        ...
        @returns.json
        @json
        @post("technical-content/requests/entries/{entry_uid}/logs")
    ...
    class __Emails(Consumer):
        """Interface to Technical Content Emails resource for the RockyRoad API."""
    ...
    class __Product_Groups(Consumer):
        """Interface to Technical Content Product Groups resource for the RockyRoad API."""
    ...
    class __Product_Lines(Consumer):
        """Interface to Technical Content Product Lines resource for the RockyRoad API."""
    ...
    class __Content_Types(Consumer):
        """Interface to Technical Content Content Types resource for the RockyRoad API."""
    ...
    class __Documents(Consumer):
        """Interface to Technical Content Documents resource for the RockyRoad API."""
        ...
        @returns.json
        @http_get("technical-content/requests/documents")
        def list(
            self,
            category: Query = None,
        ...
        class __Aliases(Consumer):
            """Interface to Technical Content Document Aliases resource for the RockyRoad API."""
            ...
            @returns.json
            @http_get("technical-content/requests/documents/aliases")
            def list(
                self,
                category: Query = None,
                sub_category: Query = None,
            ...
            @returns.json
            @http_get("technical-content/requests/documents/{document_uid}/aliases")
            ...
            @returns.json
            @http_get("technical-content/requests/documents/aliases/{uid}")
            def get(self, uid: str):
                """This call will return a document alias for the specified uid."""
            
            @returns.json
            @json
            @post("technical-content/requests/documents/{document_uid}/aliases")
    ...
    class __Users(Consumer):
        """Interface to Technical Content Users resource for the RockyRoad API."""
    ...
    class __Assignments(Consumer):
        """Interface to Technical Content Assignments resource for the RockyRoad API."""
