...
from huibiao_framework.config.limit_resource import LimitResourceName
...
def _limit_resource_license_annotation(
    resource_type: LimitResourceName,
...
def _predefined_license(resource_type: LimitResourceName):
