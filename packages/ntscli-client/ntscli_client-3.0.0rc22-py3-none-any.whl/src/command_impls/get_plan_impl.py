...
def get_plan_impl(esn: str, plan_type: str, playlist_id: str, dynamic_filter_id: str, sdk_or_apk: str, out_file, net_key: str, use_netflix_access: bool):
    device_test_client = DeviceTestClient(net_key, use_netflix_access)

    match plan_type:
        case "FULL":
            plan = device_test_client.get_test_plan(esn)
        case "PLAYLIST":
