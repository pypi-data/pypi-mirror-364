...
class RequestOptions(_message.Message):
    __slots__ = ["aggregation_leading_edge", "coerce_null_counts_to_zero", "high_watermark_override", "ignore_extra_request_context_fields", "latency_budget_ms", "read_from_cache", "write_to_cache"]
    ...
    write_to_cache: bool
    def __init__(self, read_from_cache: bool = ..., write_to_cache: bool = ..., ignore_extra_request_context_fields: bool = ..., latency_budget_ms: _Optional[int] = ..., coerce_null_counts_to_zero: bool = ..., aggregation_leading_edge: _Optional[_Union[_feature_view__client_pb2.AggregationLeadingEdge, str]] = ..., high_watermark_override: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
