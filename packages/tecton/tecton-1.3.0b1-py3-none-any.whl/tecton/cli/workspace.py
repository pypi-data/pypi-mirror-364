...
def create(workspace, live, skip_server_groups):
    ...
    printer.safe_print(
        """
You have created a new workspace. Workspaces let you create and manage an isolated feature repository.
Running "tecton plan" will compare your local repository against the remote repository, which is initially empty.
    """
    )
