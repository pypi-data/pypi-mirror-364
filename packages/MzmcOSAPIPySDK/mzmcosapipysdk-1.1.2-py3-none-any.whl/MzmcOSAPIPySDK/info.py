...
class Version:
    ...
    def add_client(self, client_name: str, description: str, access_token: str):
        return self._post(endpoint=f"/info/version", payloads={"client_name": client_name, "description": description},
                          access_token=access_token)

    def delete_client(self, client_id: str, access_token: str):
        return self._delete(endpoint=f"/info/version/{client_id}", access_token=access_token)

    def update_client(self, client_id: str, client_name: str, description: str, access_token: str):
        return self._patch(endpoint=f"/info/version/{client_id}",
                           payloads={"id": client_id, "client_name": client_name, "description": description},
                           access_token=access_token)

    def set_version(self, client_id: str, x: int, y: int, z: int, access_token: str):
        return self._post(endpoint=f"/info/version/set/{client_id}", payloads={"x": x, "y": y, "z": z},
                          access_token=access_token)

    def increase_version(self, client_id: str, part: str, access_token: str):
        return self._post(endpoint=f"/info/version/increase/{client_id}", payloads={"part": part},
                          access_token=access_token)
