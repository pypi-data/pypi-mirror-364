...
class Player:
    ...
    def add_whitelist(self, realname: str, access_token: str = None):
        ...
        return self._post(f"/player/whitelist", payload, access_token)

    def get_whitelist(self, keyword: str, access_token: str = None):
        payload = {
            "keyword": keyword
        }
        return self._get(f"/player/whitelist", access_token, payload)

    def delete_whitelist(self, uid: str, access_token: str = None):
        payload = {
            "id": uid
        }
        return self._delete(f"/player/whitelist", payload, access_token)
