...
`accdist() -> float`
    """
    return _lib.Incr_fn_accdist_fb3326(ctx=ctx, ).collect()
...
`accdist() -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_accdist_fb3326(ctx, )
...
`cum(series<float> src) -> float`
    """
    return _lib.Incr_fn_cum_027cda(ctx=ctx, ).collect(_5182_src=src)
...
`cum(series<float> src) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_cum_027cda(ctx, )
        self.locals = CumLocals(self.inner)

    def next(self, src: float) -> Optional[float]:
        return self.inner.next(_5182_src=src)
...
`change(series<float> src) -> series<float>`
    """
    return _lib.Incr_fn_change_5881dc(ctx=ctx, ).collect(_5184_src=src)
...
`change(series<float> src) -> series<float>`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_change_5881dc(ctx, )
        self.locals = ChangeLocals(self.inner)

    def next(self, src: float) -> Optional[float]:
        return self.inner.next(_5184_src=src)
...
`barssince(series<bool> condition) -> int`
    """
    return _lib.Incr_fn_barssince_974a30(ctx=ctx, ).collect(_5186_condition=condition)
...
`barssince(series<bool> condition) -> int`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_barssince_974a30(ctx, )
        self.locals = BarssinceLocals(self.inner)

    def next(self, condition: bool) -> Optional[int]:
        return self.inner.next(_5186_condition=condition)
...
`roc(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_roc_495c10(ctx=ctx, ).collect(_5188_src=src, _5189_length=length)
...
`crossover(series<float> source1, series<float> source2) -> bool`
    """
    return _lib.Incr_fn_crossover_9811a1(ctx=ctx, ).collect(_5191_source1=source1, _5192_source2=source2)
...
`crossover(series<float> source1, series<float> source2) -> bool`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_crossover_9811a1(ctx, )
        self.locals = CrossoverLocals(self.inner)

    def next(self, source1: float, source2: float) -> Optional[bool]:
        return self.inner.next(_5191_source1=source1, _5192_source2=source2)
...
`crossunder(series<float> source1, series<float> source2) -> bool`
    """
    return _lib.Incr_fn_crossunder_c99921(ctx=ctx, ).collect(_5194_source1=source1, _5195_source2=source2)
...
`crossunder(series<float> source1, series<float> source2) -> bool`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_crossunder_c99921(ctx, )
        self.locals = CrossunderLocals(self.inner)

    def next(self, source1: float, source2: float) -> Optional[bool]:
        return self.inner.next(_5194_source1=source1, _5195_source2=source2)
...
`cross(series<float> source1, series<float> source2) -> bool`
    """
    return _lib.Incr_fn_cross_11173c(ctx=ctx, ).collect(_5197_source1=source1, _5198_source2=source2)
...
`cross(series<float> source1, series<float> source2) -> bool`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_cross_11173c(ctx, )
        self.locals = CrossLocals(self.inner)

    def next(self, source1: float, source2: float) -> Optional[bool]:
        return self.inner.next(_5197_source1=source1, _5198_source2=source2)
...
`highestbars(series<float> src, int length = 14) -> int`
    """
    return _lib.Incr_fn_highestbars_89a1cf(ctx=ctx, ).collect(_5200_src=src, _5201_length=length)
...
`highestbars(series<float> src, int length = 14) -> int`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_highestbars_89a1cf(ctx, )
        self.locals = HighestbarsLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[int]:
        return self.inner.next(_5200_src=src, _5201_length=length)
...
`lowestbars(series<float> src, int length = 14) -> int`
    """
    return _lib.Incr_fn_lowestbars_be3b3a(ctx=ctx, ).collect(_5203_src=src, _5204_length=length)
...
`lowestbars(series<float> src, int length = 14) -> int`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_lowestbars_be3b3a(ctx, )
        self.locals = LowestbarsLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[int]:
        return self.inner.next(_5203_src=src, _5204_length=length)
...
`highest(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_highest_5ccd51(ctx=ctx, ).collect(_5206_src=src, _5207_length=length)
...
`highest(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_highest_5ccd51(ctx, )
        self.locals = HighestLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5206_src=src, _5207_length=length)
...
`lowest(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_lowest_6da8b0(ctx=ctx, ).collect(_5209_src=src, _5210_length=length)
...
`lowest(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_lowest_6da8b0(ctx, )
        self.locals = LowestLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5209_src=src, _5210_length=length)
...
`swma(series<float> src) -> float`
    """
    return _lib.Incr_fn_swma_5ddbf0(ctx=ctx, ).collect(_5212_src=src)
...
`swma(series<float> src) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_swma_5ddbf0(ctx, )
        self.locals = SwmaLocals(self.inner)

    def next(self, src: float) -> Optional[float]:
        return self.inner.next(_5212_src=src)
...
`sma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_sma_77d7f3(ctx=ctx, ).collect(_5214_src=src, _5215_length=length)
...
`sma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_sma_77d7f3(ctx, )
        self.locals = SmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5214_src=src, _5215_length=length)
...
`ema(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_ema_18263a(ctx=ctx, ).collect(_5217_src=src, _5218_length=length)
...
`ema(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_ema_18263a(ctx, )
        self.locals = EmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5217_src=src, _5218_length=length)
...
`rma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_rma_9a0119(ctx=ctx, ).collect(_5220_src=src, _5221_length=length)
...
`rma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_rma_9a0119(ctx, )
        self.locals = RmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5220_src=src, _5221_length=length)
...
`wma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_wma_2ba308(ctx=ctx, ).collect(_5223_src=src, _5224_length=length)
...
`wma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_wma_2ba308(ctx, )
        self.locals = WmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5223_src=src, _5224_length=length)
...
`lwma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_lwma_3c74a6(ctx=ctx, ).collect(_5226_src=src, _5227_length=length)
...
`lwma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_lwma_3c74a6(ctx, )
        self.locals = LwmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5226_src=src, _5227_length=length)
...
`hma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_hma_593bfb(ctx=ctx, ).collect(_5229_src=src, _5230_length=length)
...
`hma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_hma_593bfb(ctx, )
        self.locals = HmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5229_src=src, _5230_length=length)
...
`vwma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_vwma_76367b(ctx=ctx, ).collect(_5232_src=src, _5233_length=length)
...
`vwma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_vwma_76367b(ctx, )
        self.locals = VwmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5232_src=src, _5233_length=length)
...
`dev(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_dev_d580cc(ctx=ctx, ).collect(_5235_src=src, _5236_length=length)
...
`dev(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_dev_d580cc(ctx, )
        self.locals = DevLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5235_src=src, _5236_length=length)
...
`tr(bool handle_na = true) -> series<float>`
    """
    return _lib.Incr_fn_tr_ac68ab(ctx=ctx, ).collect(_5238_handle_na=handle_na)
...
`atr(int length = 14) -> float`
    """
    return _lib.Incr_fn_atr_67e3a1(ctx=ctx, ).collect(_5240_length=length)
...
`rsi(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_rsi_d001d9(ctx=ctx, ).collect(_5242_src=src, _5243_length=length)
...
`rsi(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_rsi_d001d9(ctx, )
        self.locals = RsiLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5242_src=src, _5243_length=length)
...
`cci(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_cci_ddbb4a(ctx=ctx, ).collect(_5245_src=src, _5246_length=length)
...
`cci(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_cci_ddbb4a(ctx, )
        self.locals = CciLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5245_src=src, _5246_length=length)
...
`stdev(series<float> src, int length, bool biased = true) -> float`
    """
    return _lib.Incr_fn_stdev_1b4895(ctx=ctx, ).collect(_5248_src=src, _5249_length=length, _5250_biased=biased)
...
`stdev(series<float> src, int length, bool biased = true) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_stdev_1b4895(ctx, )
        self.locals = StdevLocals(self.inner)

    def next(self, src: float, length: int, biased: Optional[bool] = None) -> Optional[float]:
        return self.inner.next(_5248_src=src, _5249_length=length, _5250_biased=biased)
...
`aroon(int length = 14) -> [float, float]`
    """
    return _lib.Incr_fn_aroon_22ce61(ctx=ctx, ).collect(_5252_length=length)
...
`supertrend(series<float> src, float factor, int atr_period) -> [float, int]`
    """
    return _lib.Incr_fn_supertrend_2ad6fb(ctx=ctx, ).collect(_5254_src=src, _5255_factor=factor, _5256_atr_period=atr_period)
...
`supertrend(series<float> src, float factor, int atr_period) -> [float, int]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_supertrend_2ad6fb(ctx, )
        self.locals = SupertrendLocals(self.inner)

    def next(self, src: float, factor: float, atr_period: int) -> Optional[Tuple[float, int]]:
        return self.inner.next(_5254_src=src, _5255_factor=factor, _5256_atr_period=atr_period)
...
`awesome_oscillator(series<float> src, int slow_length = 5, int fast_length = 34) -> float`
    """
    return _lib.Incr_fn_awesome_oscillator_ba1b65(ctx=ctx, ).collect(_5258_src=src, _5259_slow_length=slow_length, _5260_fast_length=fast_length)
...
`awesome_oscillator(series<float> src, int slow_length = 5, int fast_length = 34) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_awesome_oscillator_ba1b65(ctx, )
    ...
    def next(self, src: float, slow_length: Optional[int] = None, fast_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5258_src=src, _5259_slow_length=slow_length, _5260_fast_length=fast_length)
...
`balance_of_power() -> float`
    """
    return _lib.Incr_fn_balance_of_power_023012(ctx=ctx, ).collect()
...
`balance_of_power() -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_balance_of_power_023012(ctx, )
...
`bollinger_bands_pct_b(series<float> src, int length = 20, float mult = 2.0) -> float`
    """
    return _lib.Incr_fn_bollinger_bands_pct_b_cf0304(ctx=ctx, ).collect(_5265_src=src, _5266_length=length, _5267_mult=mult)
...
`bollinger_bands_pct_b(series<float> src, int length = 20, float mult = 2.0) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_bollinger_bands_pct_b_cf0304(ctx, )
    ...
    def next(self, src: float, length: Optional[int] = None, mult: Optional[float] = None) -> Optional[float]:
        return self.inner.next(_5265_src=src, _5266_length=length, _5267_mult=mult)
...
`bollinger_bands_width(series<float> src, int length = 20, float mult = 2.0) -> float`
    """
    return _lib.Incr_fn_bollinger_bands_width_ac04a0(ctx=ctx, ).collect(_5274_src=src, _5275_length=length, _5276_mult=mult)
...
`bollinger_bands_width(series<float> src, int length = 20, float mult = 2.0) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_bollinger_bands_width_ac04a0(ctx, )
        self.locals = BollingerBandsWidthLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None, mult: Optional[float] = None) -> Optional[float]:
        return self.inner.next(_5274_src=src, _5275_length=length, _5276_mult=mult)
...
`bollinger_bands(series<float> src, int length = 20, float mult = 2.0) -> [float, float]`
    """
    return _lib.Incr_fn_bollinger_bands_23066d(ctx=ctx, ).collect(_5283_src=src, _5284_length=length, _5285_mult=mult)
...
`bollinger_bands(series<float> src, int length = 20, float mult = 2.0) -> [float, float]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_bollinger_bands_23066d(ctx, )
    ...
    def next(self, src: float, length: Optional[int] = None, mult: Optional[float] = None) -> Optional[Tuple[float, float]]:
        return self.inner.next(_5283_src=src, _5284_length=length, _5285_mult=mult)
...
`chaikin_money_flow(int length = 20) -> float`
    """
    return _lib.Incr_fn_chaikin_money_flow_f135d4(ctx=ctx, ).collect(_5291_length=length)
...
class ChaikinMoneyFlowLocals:
    ...
    def cumVol(self) -> float:
        return self.__inner._5292_cumVol()
...
`chaikin_money_flow(int length = 20) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_chaikin_money_flow_f135d4(ctx, )
        self.locals = ChaikinMoneyFlowLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5291_length=length)
...
`chande_kroll_stop(int atr_length = 10, float atr_coeff = 1.0, int stop_length = 9) -> [float, float]`
    """
    return _lib.Incr_fn_chande_kroll_stop_3679ab(ctx=ctx, ).collect(_5296_atr_length=atr_length, _5297_atr_coeff=atr_coeff, _5298_stop_length=stop_length)
...
`chande_kroll_stop(int atr_length = 10, float atr_coeff = 1.0, int stop_length = 9) -> [float, float]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_chande_kroll_stop_3679ab(ctx, )
    ...
    def next(self, atr_length: Optional[int] = None, atr_coeff: Optional[float] = None, stop_length: Optional[int] = None) -> Optional[Tuple[float, float]]:
        return self.inner.next(_5296_atr_length=atr_length, _5297_atr_coeff=atr_coeff, _5298_stop_length=stop_length)
...
`choppiness_index(int length = 14) -> float`
    """
    return _lib.Incr_fn_choppiness_index_391e92(ctx=ctx, ).collect(_5307_length=length)
...
`choppiness_index(int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_choppiness_index_391e92(ctx, )
        self.locals = ChoppinessIndexLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5307_length=length)
...
`connors_rsi(series<float> src, int rsi_length = 3, int up_down_length = 2, int roc_length = 100) -> float`
    """
    return _lib.Incr_fn_connors_rsi_1a6769(ctx=ctx, ).collect(_5314_src=src, _5315_rsi_length=rsi_length, _5316_up_down_length=up_down_length, _5317_roc_length=roc_length)
...
`connors_rsi(series<float> src, int rsi_length = 3, int up_down_length = 2, int roc_length = 100) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_connors_rsi_1a6769(ctx, )
    ...
    def next(self, src: float, rsi_length: Optional[int] = None, up_down_length: Optional[int] = None, roc_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5314_src=src, _5315_rsi_length=rsi_length, _5316_up_down_length=up_down_length, _5317_roc_length=roc_length)
...
`coppock_curve(series<float> src, int wma_length = 10, int long_roc_length = 14, int short_roc_length = 11) -> float`
    """
    return _lib.Incr_fn_coppock_curve_e7ae8a(ctx=ctx, ).collect(_5323_src=src, _5324_wma_length=wma_length, _5325_long_roc_length=long_roc_length, _5326_short_roc_length=short_roc_length)
...
`coppock_curve(series<float> src, int wma_length = 10, int long_roc_length = 14, int short_roc_length = 11) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_coppock_curve_e7ae8a(ctx, )
    ...
    def next(self, src: float, wma_length: Optional[int] = None, long_roc_length: Optional[int] = None, short_roc_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5323_src=src, _5324_wma_length=wma_length, _5325_long_roc_length=long_roc_length, _5326_short_roc_length=short_roc_length)
...
`donchian_channel(series<float> src, int length = 20) -> [float, float, float]`
    """
    return _lib.Incr_fn_donchian_channel_cabb4e(ctx=ctx, ).collect(_5328_src=src, _5329_length=length)
...
`donchian_channel(series<float> src, int length = 20) -> [float, float, float]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_donchian_channel_cabb4e(ctx, )
    ...
    def next(self, src: float, length: Optional[int] = None) -> Optional[Tuple[float, float, float]]:
        return self.inner.next(_5328_src=src, _5329_length=length)
...
`macd(series<float> src, int short_length = 12, int long_length = 26) -> float`
    """
    return _lib.Incr_fn_macd_38717b(ctx=ctx, ).collect(_5334_src=src, _5335_short_length=short_length, _5336_long_length=long_length)
...
`macd(series<float> src, int short_length = 12, int long_length = 26) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_macd_38717b(ctx, )
    ...
    def next(self, src: float, short_length: Optional[int] = None, long_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5334_src=src, _5335_short_length=short_length, _5336_long_length=long_length)
...
`price_oscillator(series<float> src, int short_length = 12, int long_length = 26) -> float`
    """
    return _lib.Incr_fn_price_oscillator_6b9ef6(ctx=ctx, ).collect(_5339_src=src, _5340_short_length=short_length, _5341_long_length=long_length)
...
`price_oscillator(series<float> src, int short_length = 12, int long_length = 26) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_price_oscillator_6b9ef6(ctx, )
        self.locals = PriceOscillatorLocals(self.inner)

    def next(self, src: float, short_length: Optional[int] = None, long_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5339_src=src, _5340_short_length=short_length, _5341_long_length=long_length)
...
`relative_vigor_index(int length = 14) -> float`
    """
    return _lib.Incr_fn_relative_vigor_index_f63992(ctx=ctx, ).collect(_5346_length=length)
...
`relative_vigor_index(int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_relative_vigor_index_f63992(ctx, )
        self.locals = RelativeVigorIndexLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5346_length=length)
...
`relative_volatility_index(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_relative_volatility_index_591d29(ctx=ctx, ).collect(_5348_src=src, _5349_length=length)
...
`relative_volatility_index(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_relative_volatility_index_591d29(ctx, )
        self.locals = RelativeVolatilityIndexLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5348_src=src, _5349_length=length)
...
`stochastic_rsi(series<float> src, int stoch_length = 14, int rsi_length = 14, int k = 3, int d = 3) -> [float, float]`
    """
    return _lib.Incr_fn_stochastic_rsi_eee533(ctx=ctx, ).collect(_5355_src=src, _5356_stoch_length=stoch_length, _5357_rsi_length=rsi_length, _5358_k=k, _5359_d=d)
...
`stochastic_rsi(series<float> src, int stoch_length = 14, int rsi_length = 14, int k = 3, int d = 3) -> [float, float]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_stochastic_rsi_eee533(ctx, )
    ...
    def next(self, src: float, stoch_length: Optional[int] = None, rsi_length: Optional[int] = None, k: Optional[int] = None, d: Optional[int] = None) -> Optional[Tuple[float, float]]:
        return self.inner.next(_5355_src=src, _5356_stoch_length=stoch_length, _5357_rsi_length=rsi_length, _5358_k=k, _5359_d=d)
...
`ultimate_oscillator(int fast_length = 7, int medium_length = 14, int slow_length = 28) -> float`
    """
    return _lib.Incr_fn_ultimate_oscillator_e6e17e(ctx=ctx, ).collect(_5368_fast_length=fast_length, _5369_medium_length=medium_length, _5370_slow_length=slow_length)
...
`ultimate_oscillator(int fast_length = 7, int medium_length = 14, int slow_length = 28) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_ultimate_oscillator_e6e17e(ctx, )
    ...
    def next(self, fast_length: Optional[int] = None, medium_length: Optional[int] = None, slow_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5368_fast_length=fast_length, _5369_medium_length=medium_length, _5370_slow_length=slow_length)
...
`volume_oscillator(int short_length = 5, int long_length = 10) -> float`
    """
    return _lib.Incr_fn_volume_oscillator_bdf1f0(ctx=ctx, ).collect(_5380_short_length=short_length, _5381_long_length=long_length)
...
`volume_oscillator(int short_length = 5, int long_length = 10) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_volume_oscillator_bdf1f0(ctx, )
    ...
    def next(self, short_length: Optional[int] = None, long_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5380_short_length=short_length, _5381_long_length=long_length)
...
`vortex_indicator(int length = 14) -> [float, float]`
    """
    return _lib.Incr_fn_vortex_indicator_d41806(ctx=ctx, ).collect(_5386_length=length)
...
`vortex_indicator(int length = 14) -> [float, float]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_vortex_indicator_d41806(ctx, )
        self.locals = VortexIndicatorLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[Tuple[float, float]]:
        return self.inner.next(_5386_length=length)
...
`williams_pct_r(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_williams_pct_r_bc5172(ctx=ctx, ).collect(_5393_src=src, _5394_length=length)
...
`williams_pct_r(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_williams_pct_r_bc5172(ctx, )
        self.locals = WilliamsPctRLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5393_src=src, _5394_length=length)
...
`advance_decline_ratio(int length = 9) -> float`
    """
    return _lib.Incr_fn_advance_decline_ratio_a2905b(ctx=ctx, ).collect(_5399_length=length)
...
`advance_decline_ratio(int length = 9) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_advance_decline_ratio_a2905b(ctx, )
        self.locals = AdvanceDeclineRatioLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5399_length=length)
...
`detrended_price_oscillator(int length = 21, bool centered = false) -> series<float>`
    """
    return _lib.Incr_fn_detrended_price_oscillator_f83f1f(ctx=ctx, ).collect(_5405_length=length, _5406_centered=centered)
...
`detrended_price_oscillator(int length = 21, bool centered = false) -> series<float>`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_detrended_price_oscillator_f83f1f(ctx, )
    ...
    def next(self, length: Optional[int] = None, centered: Optional[bool] = None) -> Optional[float]:
        return self.inner.next(_5405_length=length, _5406_centered=centered)
...
`bull_bear_power(int length = 13) -> series<float>`
    """
    return _lib.Incr_fn_bull_bear_power_e8c4c1(ctx=ctx, ).collect(_5411_length=length)
...
`bull_bear_power(int length = 13) -> series<float>`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_bull_bear_power_e8c4c1(ctx, )
        self.locals = BullBearPowerLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5411_length=length)
...
`absolute_price_oscillator(series<float> src, int fast_length = 12, int slow_length = 26) -> float`
    """
    return _lib.Incr_fn_absolute_price_oscillator_50693a(ctx=ctx, ).collect(_5417_src=src, _5418_fast_length=fast_length, _5419_slow_length=slow_length)
...
`absolute_price_oscillator(series<float> src, int fast_length = 12, int slow_length = 26) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_absolute_price_oscillator_50693a(ctx, )
    ...
    def next(self, src: float, fast_length: Optional[int] = None, slow_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5417_src=src, _5418_fast_length=fast_length, _5419_slow_length=slow_length)
...
`know_sure_thing(series<float> src, int roc_length1 = 10, int roc_length2 = 15, int roc_length3 = 20, int roc_length4 = 30, int sma_length1 = 10, int sma_length2 = 10, int sma_length3 = 10, int sma_length4 = 15, int sig_length = 9) -> [float, float]`
    """
    return _lib.Incr_fn_know_sure_thing_e997b4(ctx=ctx, ).collect(_5423_src=src, _5424_roc_length1=roc_length1, _5425_roc_length2=roc_length2, _5426_roc_length3=roc_length3, _5427_roc_length4=roc_length4, _5428_sma_length1=sma_length1, _5429_sma_length2=sma_length2, _5430_sma_length3=sma_length3, _5431_sma_length4=sma_length4, _5432_sig_length=sig_length)
...
`know_sure_thing(series<float> src, int roc_length1 = 10, int roc_length2 = 15, int roc_length3 = 20, int roc_length4 = 30, int sma_length1 = 10, int sma_length2 = 10, int sma_length3 = 10, int sma_length4 = 15, int sig_length = 9) -> [float, float]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_know_sure_thing_e997b4(ctx, )
    ...
    def next(self, src: float, roc_length1: Optional[int] = None, roc_length2: Optional[int] = None, roc_length3: Optional[int] = None, roc_length4: Optional[int] = None, sma_length1: Optional[int] = None, sma_length2: Optional[int] = None, sma_length3: Optional[int] = None, sma_length4: Optional[int] = None, sig_length: Optional[int] = None) -> Optional[Tuple[float, float]]:
        return self.inner.next(_5423_src=src, _5424_roc_length1=roc_length1, _5425_roc_length2=roc_length2, _5426_roc_length3=roc_length3, _5427_roc_length4=roc_length4, _5428_sma_length1=sma_length1, _5429_sma_length2=sma_length2, _5430_sma_length3=sma_length3, _5431_sma_length4=sma_length4, _5432_sig_length=sig_length)
...
`momentum(series<float> src, int length = 10) -> series<float>`
    """
    return _lib.Incr_fn_momentum_8330c2(ctx=ctx, ).collect(_5440_src=src, _5441_length=length)
...
`momentum(series<float> src, int length = 10) -> series<float>`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_momentum_8330c2(ctx, )
        self.locals = MomentumLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5440_src=src, _5441_length=length)
...
`trix(series<float> src, int length = 18) -> series<float>`
    """
    return _lib.Incr_fn_trix_81c7bc(ctx=ctx, ).collect(_5443_src=src, _5444_length=length)
...
`trix(series<float> src, int length = 18) -> series<float>`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_trix_81c7bc(ctx, )
        self.locals = TrixLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5443_src=src, _5444_length=length)
...
`true_strength_index(series<float> src, int long_length = 25, int short_length = 13) -> float`
    """
    return _lib.Incr_fn_true_strength_index_e605fb(ctx=ctx, ).collect(_5446_src=src, _5447_long_length=long_length, _5448_short_length=short_length)
...
`true_strength_index(series<float> src, int long_length = 25, int short_length = 13) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_true_strength_index_e605fb(ctx, )
    ...
    def next(self, src: float, long_length: Optional[int] = None, short_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5446_src=src, _5447_long_length=long_length, _5448_short_length=short_length)
...
`dema(series<float> src, int length = 9) -> float`
    """
    return _lib.Incr_fn_dema_0012f2(ctx=ctx, ).collect(_5454_src=src, _5455_length=length)
...
`dema(series<float> src, int length = 9) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_dema_0012f2(ctx, )
        self.locals = DemaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5454_src=src, _5455_length=length)
...
`fwma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_fwma_e03a24(ctx=ctx, ).collect(_5464_src=src, _5465_length=length)
...
`fwma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_fwma_e03a24(ctx, )
        self.locals = FwmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5464_src=src, _5465_length=length)
...
`money_flow_index(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_money_flow_index_2d072b(ctx=ctx, ).collect(_5471_src=src, _5472_length=length)
...
`money_flow_index(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_money_flow_index_2d072b(ctx, )
        self.locals = MoneyFlowIndexLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5471_src=src, _5472_length=length)
...
`ease_of_movement(int length = 14, int divisor = 10000) -> float`
    """
    return _lib.Incr_fn_ease_of_movement_a5488a(ctx=ctx, ).collect(_5474_length=length, _5475_divisor=divisor)
...
`ease_of_movement(int length = 14, int divisor = 10000) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_ease_of_movement_a5488a(ctx, )
    ...
    def next(self, length: Optional[int] = None, divisor: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5474_length=length, _5475_divisor=divisor)
...
`elder_force_index(int length = 13) -> float`
    """
    return _lib.Incr_fn_elder_force_index_82ddbc(ctx=ctx, ).collect(_5477_length=length)
...
`elder_force_index(int length = 13) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_elder_force_index_82ddbc(ctx, )
        self.locals = ElderForceIndexLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5477_length=length)
...
`tema(series<float> src, int length = 9) -> float`
    """
    return _lib.Incr_fn_tema_bb7275(ctx=ctx, ).collect(_5479_src=src, _5480_length=length)
...
`tema(series<float> src, int length = 9) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_tema_bb7275(ctx, )
        self.locals = TemaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_5479_src=src, _5480_length=length)
...
`main() -> void`
    """
    return _lib.Incr_fn_main_682558(ctx=ctx, ).collect()
...
`main() -> void`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_main_682558(ctx, )
