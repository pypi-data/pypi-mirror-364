...
`accdist() -> float`
    """
    return _lib.Incr_fn_accdist_160060(ctx=ctx, ).collect()
...
`accdist() -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_accdist_160060(ctx, )
...
`cum(series<float> src) -> float`
    """
    return _lib.Incr_fn_cum_106d1e(ctx=ctx, ).collect(_21297_src=src)
...
`cum(series<float> src) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_cum_106d1e(ctx, )
        self.locals = CumLocals(self.inner)

    def next(self, src: float) -> Optional[float]:
        return self.inner.next(_21297_src=src)
...
`change(series<float> src) -> series<float>`
    """
    return _lib.Incr_fn_change_95f4fb(ctx=ctx, ).collect(_21299_src=src)
...
`change(series<float> src) -> series<float>`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_change_95f4fb(ctx, )
        self.locals = ChangeLocals(self.inner)

    def next(self, src: float) -> Optional[float]:
        return self.inner.next(_21299_src=src)
...
`barssince(series<bool> condition) -> int`
    """
    return _lib.Incr_fn_barssince_e16e1a(ctx=ctx, ).collect(_21301_condition=condition)
...
`barssince(series<bool> condition) -> int`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_barssince_e16e1a(ctx, )
        self.locals = BarssinceLocals(self.inner)

    def next(self, condition: bool) -> Optional[int]:
        return self.inner.next(_21301_condition=condition)
...
`roc(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_roc_fc01b2(ctx=ctx, ).collect(_21303_src=src, _21304_length=length)
...
`roc(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_roc_fc01b2(ctx, )
        self.locals = RocLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21303_src=src, _21304_length=length)
...
`crossover(series<float> source1, series<float> source2) -> bool`
    """
    return _lib.Incr_fn_crossover_77b2aa(ctx=ctx, ).collect(_21306_source1=source1, _21307_source2=source2)
...
`crossover(series<float> source1, series<float> source2) -> bool`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_crossover_77b2aa(ctx, )
        self.locals = CrossoverLocals(self.inner)

    def next(self, source1: float, source2: float) -> Optional[bool]:
        return self.inner.next(_21306_source1=source1, _21307_source2=source2)
...
`crossunder(series<float> source1, series<float> source2) -> bool`
    """
    return _lib.Incr_fn_crossunder_347785(ctx=ctx, ).collect(_21309_source1=source1, _21310_source2=source2)
...
`crossunder(series<float> source1, series<float> source2) -> bool`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_crossunder_347785(ctx, )
        self.locals = CrossunderLocals(self.inner)

    def next(self, source1: float, source2: float) -> Optional[bool]:
        return self.inner.next(_21309_source1=source1, _21310_source2=source2)
...
`cross(series<float> source1, series<float> source2) -> bool`
    """
    return _lib.Incr_fn_cross_f76cf5(ctx=ctx, ).collect(_21312_source1=source1, _21313_source2=source2)
...
`cross(series<float> source1, series<float> source2) -> bool`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_cross_f76cf5(ctx, )
        self.locals = CrossLocals(self.inner)

    def next(self, source1: float, source2: float) -> Optional[bool]:
        return self.inner.next(_21312_source1=source1, _21313_source2=source2)
...
`highestbars(series<float> src, int length = 14) -> int`
    """
    return _lib.Incr_fn_highestbars_69b949(ctx=ctx, ).collect(_21315_src=src, _21316_length=length)
...
`highestbars(series<float> src, int length = 14) -> int`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_highestbars_69b949(ctx, )
        self.locals = HighestbarsLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[int]:
        return self.inner.next(_21315_src=src, _21316_length=length)
...
`lowestbars(series<float> src, int length = 14) -> int`
    """
    return _lib.Incr_fn_lowestbars_fea60f(ctx=ctx, ).collect(_21318_src=src, _21319_length=length)
...
`lowestbars(series<float> src, int length = 14) -> int`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_lowestbars_fea60f(ctx, )
        self.locals = LowestbarsLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[int]:
        return self.inner.next(_21318_src=src, _21319_length=length)
...
`highest(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_highest_30f238(ctx=ctx, ).collect(_21321_src=src, _21322_length=length)
...
`highest(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_highest_30f238(ctx, )
        self.locals = HighestLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21321_src=src, _21322_length=length)
...
`lowest(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_lowest_2a01ea(ctx=ctx, ).collect(_21324_src=src, _21325_length=length)
...
`lowest(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_lowest_2a01ea(ctx, )
        self.locals = LowestLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21324_src=src, _21325_length=length)
...
`swma(series<float> src) -> float`
    """
    return _lib.Incr_fn_swma_16deb5(ctx=ctx, ).collect(_21327_src=src)
...
`swma(series<float> src) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_swma_16deb5(ctx, )
        self.locals = SwmaLocals(self.inner)

    def next(self, src: float) -> Optional[float]:
        return self.inner.next(_21327_src=src)
...
`sma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_sma_d5bc7f(ctx=ctx, ).collect(_21329_src=src, _21330_length=length)
...
`sma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_sma_d5bc7f(ctx, )
        self.locals = SmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21329_src=src, _21330_length=length)
...
`ema(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_ema_ea90ac(ctx=ctx, ).collect(_21332_src=src, _21333_length=length)
...
`ema(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_ema_ea90ac(ctx, )
        self.locals = EmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21332_src=src, _21333_length=length)
...
`rma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_rma_b57f82(ctx=ctx, ).collect(_21335_src=src, _21336_length=length)
...
`rma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_rma_b57f82(ctx, )
        self.locals = RmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21335_src=src, _21336_length=length)
...
`wma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_wma_f57a3e(ctx=ctx, ).collect(_21338_src=src, _21339_length=length)
...
`wma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_wma_f57a3e(ctx, )
        self.locals = WmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21338_src=src, _21339_length=length)
...
`lwma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_lwma_8acc87(ctx=ctx, ).collect(_21341_src=src, _21342_length=length)
...
`lwma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_lwma_8acc87(ctx, )
        self.locals = LwmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21341_src=src, _21342_length=length)
...
`hma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_hma_8c6d6b(ctx=ctx, ).collect(_21344_src=src, _21345_length=length)
...
`hma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_hma_8c6d6b(ctx, )
        self.locals = HmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21344_src=src, _21345_length=length)
...
`vwma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_vwma_ef1b43(ctx=ctx, ).collect(_21347_src=src, _21348_length=length)
...
`vwma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_vwma_ef1b43(ctx, )
        self.locals = VwmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21347_src=src, _21348_length=length)
...
`dev(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_dev_8110d5(ctx=ctx, ).collect(_21350_src=src, _21351_length=length)
...
`dev(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_dev_8110d5(ctx, )
        self.locals = DevLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21350_src=src, _21351_length=length)
...
`tr(bool handle_na = true) -> series<float>`
    """
    return _lib.Incr_fn_tr_b8e3af(ctx=ctx, ).collect(_21353_handle_na=handle_na)
...
`atr(int length = 14) -> float`
    """
    return _lib.Incr_fn_atr_6dbea5(ctx=ctx, ).collect(_21355_length=length)
...
`rsi(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_rsi_0c2be5(ctx=ctx, ).collect(_21357_src=src, _21358_length=length)
...
`rsi(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_rsi_0c2be5(ctx, )
        self.locals = RsiLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21357_src=src, _21358_length=length)
...
`cci(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_cci_f50091(ctx=ctx, ).collect(_21360_src=src, _21361_length=length)
...
`cci(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_cci_f50091(ctx, )
        self.locals = CciLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21360_src=src, _21361_length=length)
...
`stdev(series<float> src, int length, bool biased = true) -> float`
    """
    return _lib.Incr_fn_stdev_b2d5c8(ctx=ctx, ).collect(_21363_src=src, _21364_length=length, _21365_biased=biased)
...
`stdev(series<float> src, int length, bool biased = true) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_stdev_b2d5c8(ctx, )
        self.locals = StdevLocals(self.inner)

    def next(self, src: float, length: int, biased: Optional[bool] = None) -> Optional[float]:
        return self.inner.next(_21363_src=src, _21364_length=length, _21365_biased=biased)
...
`aroon(int length = 14) -> [float, float]`
    """
    return _lib.Incr_fn_aroon_40c313(ctx=ctx, ).collect(_21367_length=length)
...
`supertrend(series<float> src, float factor, int atr_period) -> [float, int]`
    """
    return _lib.Incr_fn_supertrend_999fa6(ctx=ctx, ).collect(_21369_src=src, _21370_factor=factor, _21371_atr_period=atr_period)
...
`supertrend(series<float> src, float factor, int atr_period) -> [float, int]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_supertrend_999fa6(ctx, )
        self.locals = SupertrendLocals(self.inner)

    def next(self, src: float, factor: float, atr_period: int) -> Optional[Tuple[float, int]]:
        return self.inner.next(_21369_src=src, _21370_factor=factor, _21371_atr_period=atr_period)
...
`awesome_oscillator(series<float> src, int slow_length = 5, int fast_length = 34) -> float`
    """
    return _lib.Incr_fn_awesome_oscillator_8e08ad(ctx=ctx, ).collect(_21373_src=src, _21374_slow_length=slow_length, _21375_fast_length=fast_length)
...
`awesome_oscillator(series<float> src, int slow_length = 5, int fast_length = 34) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_awesome_oscillator_8e08ad(ctx, )
    ...
    def next(self, src: float, slow_length: Optional[int] = None, fast_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21373_src=src, _21374_slow_length=slow_length, _21375_fast_length=fast_length)
...
`balance_of_power() -> float`
    """
    return _lib.Incr_fn_balance_of_power_0829fb(ctx=ctx, ).collect()
...
`balance_of_power() -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_balance_of_power_0829fb(ctx, )
...
`bollinger_bands_pct_b(series<float> src, int length = 20, float mult = 2.0) -> float`
    """
    return _lib.Incr_fn_bollinger_bands_pct_b_734b2d(ctx=ctx, ).collect(_21380_src=src, _21381_length=length, _21382_mult=mult)
...
`bollinger_bands_pct_b(series<float> src, int length = 20, float mult = 2.0) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_bollinger_bands_pct_b_734b2d(ctx, )
    ...
    def next(self, src: float, length: Optional[int] = None, mult: Optional[float] = None) -> Optional[float]:
        return self.inner.next(_21380_src=src, _21381_length=length, _21382_mult=mult)
...
`bollinger_bands_width(series<float> src, int length = 20, float mult = 2.0) -> float`
    """
    return _lib.Incr_fn_bollinger_bands_width_571c56(ctx=ctx, ).collect(_21389_src=src, _21390_length=length, _21391_mult=mult)
...
`bollinger_bands_width(series<float> src, int length = 20, float mult = 2.0) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_bollinger_bands_width_571c56(ctx, )
        self.locals = BollingerBandsWidthLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None, mult: Optional[float] = None) -> Optional[float]:
        return self.inner.next(_21389_src=src, _21390_length=length, _21391_mult=mult)
...
`bollinger_bands(series<float> src, int length = 20, float mult = 2.0) -> [float, float]`
    """
    return _lib.Incr_fn_bollinger_bands_4aa390(ctx=ctx, ).collect(_21398_src=src, _21399_length=length, _21400_mult=mult)
...
`bollinger_bands(series<float> src, int length = 20, float mult = 2.0) -> [float, float]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_bollinger_bands_4aa390(ctx, )
    ...
    def next(self, src: float, length: Optional[int] = None, mult: Optional[float] = None) -> Optional[Tuple[float, float]]:
        return self.inner.next(_21398_src=src, _21399_length=length, _21400_mult=mult)
...
`chaikin_money_flow(int length = 20) -> float`
    """
    return _lib.Incr_fn_chaikin_money_flow_84094e(ctx=ctx, ).collect(_21406_length=length)
...
class ChaikinMoneyFlowLocals:
    ...
    def cumVol(self) -> float:
        return self.__inner._21407_cumVol()
...
`chaikin_money_flow(int length = 20) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_chaikin_money_flow_84094e(ctx, )
        self.locals = ChaikinMoneyFlowLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21406_length=length)
...
`chande_kroll_stop(int atr_length = 10, float atr_coeff = 1.0, int stop_length = 9) -> [float, float]`
    """
    return _lib.Incr_fn_chande_kroll_stop_8c0293(ctx=ctx, ).collect(_21411_atr_length=atr_length, _21412_atr_coeff=atr_coeff, _21413_stop_length=stop_length)
...
`chande_kroll_stop(int atr_length = 10, float atr_coeff = 1.0, int stop_length = 9) -> [float, float]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_chande_kroll_stop_8c0293(ctx, )
    ...
    def next(self, atr_length: Optional[int] = None, atr_coeff: Optional[float] = None, stop_length: Optional[int] = None) -> Optional[Tuple[float, float]]:
        return self.inner.next(_21411_atr_length=atr_length, _21412_atr_coeff=atr_coeff, _21413_stop_length=stop_length)
...
`choppiness_index(int length = 14) -> float`
    """
    return _lib.Incr_fn_choppiness_index_b75baa(ctx=ctx, ).collect(_21422_length=length)
...
`choppiness_index(int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_choppiness_index_b75baa(ctx, )
        self.locals = ChoppinessIndexLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21422_length=length)
...
`connors_rsi(series<float> src, int rsi_length = 3, int up_down_length = 2, int roc_length = 100) -> float`
    """
    return _lib.Incr_fn_connors_rsi_57cbb5(ctx=ctx, ).collect(_21429_src=src, _21430_rsi_length=rsi_length, _21431_up_down_length=up_down_length, _21432_roc_length=roc_length)
...
`connors_rsi(series<float> src, int rsi_length = 3, int up_down_length = 2, int roc_length = 100) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_connors_rsi_57cbb5(ctx, )
    ...
    def next(self, src: float, rsi_length: Optional[int] = None, up_down_length: Optional[int] = None, roc_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21429_src=src, _21430_rsi_length=rsi_length, _21431_up_down_length=up_down_length, _21432_roc_length=roc_length)
...
`coppock_curve(series<float> src, int wma_length = 10, int long_roc_length = 14, int short_roc_length = 11) -> float`
    """
    return _lib.Incr_fn_coppock_curve_d14424(ctx=ctx, ).collect(_21438_src=src, _21439_wma_length=wma_length, _21440_long_roc_length=long_roc_length, _21441_short_roc_length=short_roc_length)
...
`coppock_curve(series<float> src, int wma_length = 10, int long_roc_length = 14, int short_roc_length = 11) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_coppock_curve_d14424(ctx, )
    ...
    def next(self, src: float, wma_length: Optional[int] = None, long_roc_length: Optional[int] = None, short_roc_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21438_src=src, _21439_wma_length=wma_length, _21440_long_roc_length=long_roc_length, _21441_short_roc_length=short_roc_length)
...
`donchian_channel(series<float> src, int length = 20) -> [float, float, float]`
    """
    return _lib.Incr_fn_donchian_channel_b974a2(ctx=ctx, ).collect(_21443_src=src, _21444_length=length)
...
`donchian_channel(series<float> src, int length = 20) -> [float, float, float]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_donchian_channel_b974a2(ctx, )
    ...
    def next(self, src: float, length: Optional[int] = None) -> Optional[Tuple[float, float, float]]:
        return self.inner.next(_21443_src=src, _21444_length=length)
...
`macd(series<float> src, int short_length = 12, int long_length = 26) -> float`
    """
    return _lib.Incr_fn_macd_3109be(ctx=ctx, ).collect(_21449_src=src, _21450_short_length=short_length, _21451_long_length=long_length)
...
`macd(series<float> src, int short_length = 12, int long_length = 26) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_macd_3109be(ctx, )
    ...
    def next(self, src: float, short_length: Optional[int] = None, long_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21449_src=src, _21450_short_length=short_length, _21451_long_length=long_length)
...
`price_oscillator(series<float> src, int short_length = 12, int long_length = 26) -> float`
    """
    return _lib.Incr_fn_price_oscillator_ef9a8f(ctx=ctx, ).collect(_21454_src=src, _21455_short_length=short_length, _21456_long_length=long_length)
...
`price_oscillator(series<float> src, int short_length = 12, int long_length = 26) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_price_oscillator_ef9a8f(ctx, )
        self.locals = PriceOscillatorLocals(self.inner)

    def next(self, src: float, short_length: Optional[int] = None, long_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21454_src=src, _21455_short_length=short_length, _21456_long_length=long_length)
...
`relative_vigor_index(int length = 14) -> float`
    """
    return _lib.Incr_fn_relative_vigor_index_154bda(ctx=ctx, ).collect(_21461_length=length)
...
`relative_vigor_index(int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_relative_vigor_index_154bda(ctx, )
        self.locals = RelativeVigorIndexLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21461_length=length)
...
`relative_volatility_index(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_relative_volatility_index_9fa4a2(ctx=ctx, ).collect(_21463_src=src, _21464_length=length)
...
`relative_volatility_index(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_relative_volatility_index_9fa4a2(ctx, )
        self.locals = RelativeVolatilityIndexLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21463_src=src, _21464_length=length)
...
`stochastic_rsi(series<float> src, int stoch_length = 14, int rsi_length = 14, int k = 3, int d = 3) -> [float, float]`
    """
    return _lib.Incr_fn_stochastic_rsi_4b38fe(ctx=ctx, ).collect(_21470_src=src, _21471_stoch_length=stoch_length, _21472_rsi_length=rsi_length, _21473_k=k, _21474_d=d)
...
`stochastic_rsi(series<float> src, int stoch_length = 14, int rsi_length = 14, int k = 3, int d = 3) -> [float, float]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_stochastic_rsi_4b38fe(ctx, )
    ...
    def next(self, src: float, stoch_length: Optional[int] = None, rsi_length: Optional[int] = None, k: Optional[int] = None, d: Optional[int] = None) -> Optional[Tuple[float, float]]:
        return self.inner.next(_21470_src=src, _21471_stoch_length=stoch_length, _21472_rsi_length=rsi_length, _21473_k=k, _21474_d=d)
...
`ultimate_oscillator(int fast_length = 7, int medium_length = 14, int slow_length = 28) -> float`
    """
    return _lib.Incr_fn_ultimate_oscillator_5c0e3e(ctx=ctx, ).collect(_21483_fast_length=fast_length, _21484_medium_length=medium_length, _21485_slow_length=slow_length)
...
`ultimate_oscillator(int fast_length = 7, int medium_length = 14, int slow_length = 28) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_ultimate_oscillator_5c0e3e(ctx, )
    ...
    def next(self, fast_length: Optional[int] = None, medium_length: Optional[int] = None, slow_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21483_fast_length=fast_length, _21484_medium_length=medium_length, _21485_slow_length=slow_length)
...
`volume_oscillator(int short_length = 5, int long_length = 10) -> float`
    """
    return _lib.Incr_fn_volume_oscillator_5344b3(ctx=ctx, ).collect(_21495_short_length=short_length, _21496_long_length=long_length)
...
`volume_oscillator(int short_length = 5, int long_length = 10) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_volume_oscillator_5344b3(ctx, )
    ...
    def next(self, short_length: Optional[int] = None, long_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21495_short_length=short_length, _21496_long_length=long_length)
...
`vortex_indicator(int length = 14) -> [float, float]`
    """
    return _lib.Incr_fn_vortex_indicator_cf6cc4(ctx=ctx, ).collect(_21501_length=length)
...
`vortex_indicator(int length = 14) -> [float, float]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_vortex_indicator_cf6cc4(ctx, )
        self.locals = VortexIndicatorLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[Tuple[float, float]]:
        return self.inner.next(_21501_length=length)
...
`williams_pct_r(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_williams_pct_r_77cab0(ctx=ctx, ).collect(_21508_src=src, _21509_length=length)
...
`williams_pct_r(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_williams_pct_r_77cab0(ctx, )
        self.locals = WilliamsPctRLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21508_src=src, _21509_length=length)
...
`advance_decline_ratio(int length = 9) -> float`
    """
    return _lib.Incr_fn_advance_decline_ratio_3ea280(ctx=ctx, ).collect(_21514_length=length)
...
`advance_decline_ratio(int length = 9) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_advance_decline_ratio_3ea280(ctx, )
        self.locals = AdvanceDeclineRatioLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21514_length=length)
...
`detrended_price_oscillator(int length = 21, bool centered = false) -> series<float>`
    """
    return _lib.Incr_fn_detrended_price_oscillator_a0bc67(ctx=ctx, ).collect(_21520_length=length, _21521_centered=centered)
...
`detrended_price_oscillator(int length = 21, bool centered = false) -> series<float>`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_detrended_price_oscillator_a0bc67(ctx, )
    ...
    def next(self, length: Optional[int] = None, centered: Optional[bool] = None) -> Optional[float]:
        return self.inner.next(_21520_length=length, _21521_centered=centered)
...
`bull_bear_power(int length = 13) -> series<float>`
    """
    return _lib.Incr_fn_bull_bear_power_fbca3c(ctx=ctx, ).collect(_21526_length=length)
...
`bull_bear_power(int length = 13) -> series<float>`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_bull_bear_power_fbca3c(ctx, )
        self.locals = BullBearPowerLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21526_length=length)
...
`absolute_price_oscillator(series<float> src, int fast_length = 12, int slow_length = 26) -> float`
    """
    return _lib.Incr_fn_absolute_price_oscillator_166a8a(ctx=ctx, ).collect(_21532_src=src, _21533_fast_length=fast_length, _21534_slow_length=slow_length)
...
`absolute_price_oscillator(series<float> src, int fast_length = 12, int slow_length = 26) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_absolute_price_oscillator_166a8a(ctx, )
    ...
    def next(self, src: float, fast_length: Optional[int] = None, slow_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21532_src=src, _21533_fast_length=fast_length, _21534_slow_length=slow_length)
...
`know_sure_thing(series<float> src, int roc_length1 = 10, int roc_length2 = 15, int roc_length3 = 20, int roc_length4 = 30, int sma_length1 = 10, int sma_length2 = 10, int sma_length3 = 10, int sma_length4 = 15, int sig_length = 9) -> [float, float]`
    """
    return _lib.Incr_fn_know_sure_thing_89a22c(ctx=ctx, ).collect(_21538_src=src, _21539_roc_length1=roc_length1, _21540_roc_length2=roc_length2, _21541_roc_length3=roc_length3, _21542_roc_length4=roc_length4, _21543_sma_length1=sma_length1, _21544_sma_length2=sma_length2, _21545_sma_length3=sma_length3, _21546_sma_length4=sma_length4, _21547_sig_length=sig_length)
...
`know_sure_thing(series<float> src, int roc_length1 = 10, int roc_length2 = 15, int roc_length3 = 20, int roc_length4 = 30, int sma_length1 = 10, int sma_length2 = 10, int sma_length3 = 10, int sma_length4 = 15, int sig_length = 9) -> [float, float]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_know_sure_thing_89a22c(ctx, )
    ...
    def next(self, src: float, roc_length1: Optional[int] = None, roc_length2: Optional[int] = None, roc_length3: Optional[int] = None, roc_length4: Optional[int] = None, sma_length1: Optional[int] = None, sma_length2: Optional[int] = None, sma_length3: Optional[int] = None, sma_length4: Optional[int] = None, sig_length: Optional[int] = None) -> Optional[Tuple[float, float]]:
        return self.inner.next(_21538_src=src, _21539_roc_length1=roc_length1, _21540_roc_length2=roc_length2, _21541_roc_length3=roc_length3, _21542_roc_length4=roc_length4, _21543_sma_length1=sma_length1, _21544_sma_length2=sma_length2, _21545_sma_length3=sma_length3, _21546_sma_length4=sma_length4, _21547_sig_length=sig_length)
...
`momentum(series<float> src, int length = 10) -> series<float>`
    """
    return _lib.Incr_fn_momentum_a38f6e(ctx=ctx, ).collect(_21555_src=src, _21556_length=length)
...
`momentum(series<float> src, int length = 10) -> series<float>`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_momentum_a38f6e(ctx, )
        self.locals = MomentumLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21555_src=src, _21556_length=length)
...
`trix(series<float> src, int length = 18) -> series<float>`
    """
    return _lib.Incr_fn_trix_b62a0f(ctx=ctx, ).collect(_21558_src=src, _21559_length=length)
...
`trix(series<float> src, int length = 18) -> series<float>`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_trix_b62a0f(ctx, )
        self.locals = TrixLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21558_src=src, _21559_length=length)
...
`true_strength_index(series<float> src, int long_length = 25, int short_length = 13) -> float`
    """
    return _lib.Incr_fn_true_strength_index_336275(ctx=ctx, ).collect(_21561_src=src, _21562_long_length=long_length, _21563_short_length=short_length)
...
`true_strength_index(series<float> src, int long_length = 25, int short_length = 13) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_true_strength_index_336275(ctx, )
    ...
    def next(self, src: float, long_length: Optional[int] = None, short_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21561_src=src, _21562_long_length=long_length, _21563_short_length=short_length)
...
`dema(series<float> src, int length = 9) -> float`
    """
    return _lib.Incr_fn_dema_19b649(ctx=ctx, ).collect(_21569_src=src, _21570_length=length)
...
`dema(series<float> src, int length = 9) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_dema_19b649(ctx, )
        self.locals = DemaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21569_src=src, _21570_length=length)
...
`fwma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_fwma_56ca7a(ctx=ctx, ).collect(_21579_src=src, _21580_length=length)
...
`fwma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_fwma_56ca7a(ctx, )
        self.locals = FwmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21579_src=src, _21580_length=length)
...
`money_flow_index(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_money_flow_index_91ea87(ctx=ctx, ).collect(_21586_src=src, _21587_length=length)
...
`money_flow_index(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_money_flow_index_91ea87(ctx, )
        self.locals = MoneyFlowIndexLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21586_src=src, _21587_length=length)
...
`ease_of_movement(int length = 14, int divisor = 10000) -> float`
    """
    return _lib.Incr_fn_ease_of_movement_3a3e00(ctx=ctx, ).collect(_21589_length=length, _21590_divisor=divisor)
...
`ease_of_movement(int length = 14, int divisor = 10000) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_ease_of_movement_3a3e00(ctx, )
    ...
    def next(self, length: Optional[int] = None, divisor: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21589_length=length, _21590_divisor=divisor)
...
`elder_force_index(int length = 13) -> float`
    """
    return _lib.Incr_fn_elder_force_index_5b4f6c(ctx=ctx, ).collect(_21592_length=length)
...
`elder_force_index(int length = 13) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_elder_force_index_5b4f6c(ctx, )
        self.locals = ElderForceIndexLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21592_length=length)
...
`tema(series<float> src, int length = 9) -> float`
    """
    return _lib.Incr_fn_tema_2bccdb(ctx=ctx, ).collect(_21594_src=src, _21595_length=length)
...
`tema(series<float> src, int length = 9) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_tema_2bccdb(ctx, )
        self.locals = TemaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_21594_src=src, _21595_length=length)
...
`main() -> void`
    """
    return _lib.Incr_fn_main_783a05(ctx=ctx, ).collect()
...
`main() -> void`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_main_783a05(ctx, )
