...
from .models import Assistant, KnowledgeDataSourceDefinition
...
class AssistantRegistry:
    ...
    def get_api_routes(self) -> list[type[Controller]]:
        """
        Get all API routes from registered assistants.

        Returns:
            List of Controller classes from all assistants
        """
        routes = []
