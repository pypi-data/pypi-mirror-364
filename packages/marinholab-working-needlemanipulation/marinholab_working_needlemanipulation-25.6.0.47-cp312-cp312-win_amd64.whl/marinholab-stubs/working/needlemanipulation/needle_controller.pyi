...
from marinholab.working.needlemanipulation._impl import needle_entry_error
...
import numpy as np
import numpy
__all__ = ['Ad', 'Adsharp', 'C4', 'C8', 'D', 'DQ', 'DQ_SerialManipulator', 'DQ_threshold', 'E_', 'ICRA19TaskSpaceController', 'Im', 'NeedleController', 'P', 'Q4', 'Q8', 'Re', 'conj', 'cross', 'crossmatrix4', 'dec_mult', 'dot', 'exp', 'generalized_jacobian', 'haminus4', 'haminus8', 'hamiplus4', 'hamiplus8', 'i_', 'inv', 'is_line', 'is_plane', 'is_pure', 'is_pure_quaternion', 'is_quaternion', 'is_real', 'is_real_number', 'is_unit', 'j_', 'k_', 'log', 'needle_entry_error', 'needle_jacobian', 'norm', 'normalize', 'np', 'pinv', 'pow', 'robot_modeling', 'rotation', 'rotation_angle', 'rotation_axis', 'sharp', 'solvers', 'tplus', 'translation', 'utils', 'vec3', 'vec4', 'vec6', 'vec8']
class NeedleController(marinholab.working.needlemanipulation.icra2019_controller.ICRA19TaskSpaceController):
    def __init__(self, kinematics: dqrobotics._dqrobotics._robot_modeling.DQ_SerialManipulator, gain: float, damping: float, alpha: float, rcm_constraints: list[tuple[dqrobotics._dqrobotics.DQ, float, int]], relative_needle_pose: dqrobotics._dqrobotics.DQ, vessel_position: dqrobotics._dqrobotics.DQ, needle_radius: float, vfi_again: float = 2.0):
        ...
