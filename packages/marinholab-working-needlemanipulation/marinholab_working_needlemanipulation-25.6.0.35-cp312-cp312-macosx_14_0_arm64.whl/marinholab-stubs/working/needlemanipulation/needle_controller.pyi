...
class NeedleController(marinholab.working.needlemanipulation.icra2019_controller.ICRA19TaskSpaceController):
    def __init__(self, kinematics: dqrobotics._dqrobotics._robot_modeling.DQ_SerialManipulator, gain: float, damping: float, alpha: float, rcm_constraints: list[tuple[dqrobotics._dqrobotics.DQ, float, int]], relative_needle_pose: dqrobotics._dqrobotics.DQ, vessel_position: dqrobotics._dqrobotics.DQ, needle_radius: float):
        ...
