...
import numpy as np
__all__ = ['Ad', 'Adsharp', 'C4', 'C8', 'D', 'DQ', 'DQ_Geometry', 'DQ_Kinematics', 'DQ_threshold', 'E_', 'Im', 'P', 'Q4', 'Q8', 'Re', 'conj', 'cross', 'crossmatrix4', 'dec_mult', 'dot', 'exp', 'generalized_jacobian', 'haminus4', 'haminus8', 'hamiplus4', 'hamiplus8', 'i_', 'inv', 'is_line', 'is_plane', 'is_pure', 'is_pure_quaternion', 'is_quaternion', 'is_real', 'is_real_number', 'is_unit', 'j_', 'k_', 'log', 'needle_jacobian', 'needle_w', 'norm', 'normalize', 'np', 'pinv', 'pow', 'robot_modeling', 'rotation', 'rotation_angle', 'rotation_axis', 'sharp', 'tplus', 'translation', 'vec3', 'vec4', 'vec6', 'vec8']
def needle_jacobian(Jx_needle, x_needle: dqrobotics._dqrobotics.DQ, p_vessel: dqrobotics._dqrobotics.DQ):
    ...
    """
def needle_w(x_needle: dqrobotics._dqrobotics.DQ, p_vessel: dqrobotics._dqrobotics.DQ, needle_radius: float, vfi_gain: float):
    """
