...
class Router:
    ...
    def register(
            ...
            request_deserializer: typing.Optional[typing.Callable] = None,
            response_serializer: typing.Optional[typing.Callable] = None
    ) -> typing.Callable:
    ...
    def unary_unary(
        ...
        @Utils.func_wraps(args[0])
        def _wrapper():
            return self.register(
                self._get_func_wraps(args[0]), UNARY_UNARY_MODE,
    ...
    def unary_stream(
        ...
        def _wrapper():
            return self.register(
                self._get_func_wraps(args[0]), UNARY_STREAM_MODE,
                alias, request_deserializer, response_serializer
            )
    ...
    def stream_unary(
        ...
        @Utils.func_wraps(alias[0])
        def _wrapper():
            return self.register(
                args[0], STREAM_UNARY_MODE,
                alias, request_deserializer, response_serializer
            )
        ...
        generic_handler = grpc.method_handlers_generic_handler(
            router.service,
            {
                _handler.alias: _handler.mode(
                    ...
                    request_deserializer = request_deserializer if _handler.request_deserializer is None else _handler.request_deserializer,
                    response_serializer = response_serializer if _handler.response_serializer is None else _handler.response_serializer,
                )
