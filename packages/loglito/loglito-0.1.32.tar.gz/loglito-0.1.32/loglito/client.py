...
class Loglito:
    ...
    Args:
        ...
        project (str, optional): Project name that will be added as __project_name to all logs. Defaults to None
    ...
    Example:
        ...
        >>> # Using project parameter - gets added as __project_name to all logs
        >>> loglito = Loglito(api_key="your-api-key", project="my_awesome_project")
        >>> loglito.log("Test message")  # Will include __project_name: "my_awesome_project"
    ...
    def log(self, *args, **kwargs) -> bool:
        ...
        try:
            ...
            if self.project is not None:
                log_data["__project_name"] = self.project
    ...
    def ping(self) -> bool:
        ...
        # Add project ID if set
        if self.project is not None:
            test_log_data["__project_name"] = self.project
